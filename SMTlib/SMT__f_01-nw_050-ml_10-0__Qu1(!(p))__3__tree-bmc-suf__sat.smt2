...
(assert
 ...
 (= z_1_9 $x5556)))
(assert
 (let (($x5561 (not z_2_10)))
 (= z_1_10 $x5561)))
(assert
 (let (($x5566 (not z_2_11)))
 (= z_1_11 $x5566)))
(assert
 (let (($x5571 (not z_2_12)))
 (= z_1_12 $x5571)))
(assert
 (let (($x5576 (not z_2_13)))
 (= z_1_13 $x5576)))
(assert
 (let (($x5581 (not z_2_14)))
 (= z_1_14 $x5581)))
(assert
 (let (($x5586 (not z_2_15)))
 (= z_1_15 $x5586)))
(assert
 (let (($x5591 (not z_2_16)))
 (= z_1_16 $x5591)))
(assert
 (let (($x5596 (not z_2_17)))
 (= z_1_17 $x5596)))
(assert
 (let (($x5601 (not z_2_18)))
 (= z_1_18 $x5601)))
(assert
 (let (($x5606 (not z_2_19)))
 (= z_1_19 $x5606)))
(assert
 (let (($x5611 (not z_2_20)))
 (= z_1_20 $x5611)))
(assert
 (let (($x5616 (not z_2_21)))
 (= z_1_21 $x5616)))
(assert
 (let (($x5621 (not z_2_22)))
 (= z_1_22 $x5621)))
(assert
 (let (($x5626 (not z_2_23)))
 (= z_1_23 $x5626)))
(assert
 (let (($x5631 (not z_2_24)))
 (= z_1_24 $x5631)))
(assert
 (let (($x5636 (not z_2_25)))
 (= z_1_25 $x5636)))
(assert
 (let (($x5641 (not z_2_26)))
 (= z_1_26 $x5641)))
(assert
 (let (($x5646 (not z_2_27)))
 (= z_1_27 $x5646)))
(assert
 (let (($x5651 (not z_2_28)))
 (= z_1_28 $x5651)))
(assert
 (let (($x5656 (not z_2_29)))
 (= z_1_29 $x5656)))
(assert
 (let (($x5661 (not z_2_30)))
 (= z_1_30 $x5661)))
(assert
 (let (($x5666 (not z_2_31)))
 (= z_1_31 $x5666)))
(assert
 (let (($x5671 (not z_2_32)))
 (= z_1_32 $x5671)))
(assert
 (let (($x5676 (not z_2_33)))
 (= z_1_33 $x5676)))
(assert
 (let (($x5681 (not z_2_34)))
 (= z_1_34 $x5681)))
(assert
 (let (($x5686 (not z_2_35)))
 (= z_1_35 $x5686)))
(assert
 (let (($x5691 (not z_2_36)))
 (= z_1_36 $x5691)))
(assert
 (let (($x5696 (not z_2_37)))
 (= z_1_37 $x5696)))
(assert
 (let (($x5701 (not z_2_38)))
 (= z_1_38 $x5701)))
(assert
 (let (($x5706 (not z_2_39)))
 (= z_1_39 $x5706)))
(assert
 (let (($x5711 (not z_2_40)))
 (= z_1_40 $x5711)))
(assert
 (let (($x5716 (not z_2_41)))
 (= z_1_41 $x5716)))
(assert
 (let (($x5721 (not z_2_42)))
 (= z_1_42 $x5721)))
(assert
 (let (($x5726 (not z_2_43)))
 (= z_1_43 $x5726)))
(assert
 (let (($x5731 (not z_2_44)))
 (= z_1_44 $x5731)))
(assert
 (let (($x5736 (not z_2_45)))
 (= z_1_45 $x5736)))
(assert
 (let (($x5741 (not z_2_46)))
 (= z_1_46 $x5741)))
(assert
 (let (($x5746 (not z_2_47)))
 (= z_1_47 $x5746)))
(assert
 (let (($x5751 (not z_2_48)))
 (= z_1_48 $x5751)))
(assert
 (let (($x5756 (not z_2_49)))
 (= z_1_49 $x5756)))
(assert
 (let (($x5761 (not z_2_50)))
 (= z_1_50 $x5761)))
(assert
 (let (($x5766 (not z_2_51)))
 (= z_1_51 $x5766)))
(assert
 (let (($x5771 (not z_2_52)))
 (= z_1_52 $x5771)))
(assert
 (let (($x5776 (not z_2_53)))
 (= z_1_53 $x5776)))
(assert
 (let (($x5781 (not z_2_54)))
 (= z_1_54 $x5781)))
(assert
 (let (($x5786 (not z_2_55)))
 (= z_1_55 $x5786)))
(assert
 (let (($x5791 (not z_2_56)))
 (= z_1_56 $x5791)))
(assert
 (let (($x5796 (not z_2_57)))
 (= z_1_57 $x5796)))
(assert
 (let (($x5801 (not z_2_58)))
 (= z_1_58 $x5801)))
(assert
 (let (($x5806 (not z_2_59)))
 (= z_1_59 $x5806)))
(assert
 (let (($x5811 (not z_2_60)))
 (= z_1_60 $x5811)))
(assert
 (let (($x5816 (not z_2_61)))
 (= z_1_61 $x5816)))
(assert
 (let (($x5821 (not z_2_62)))
 (= z_1_62 $x5821)))
(assert
 (let (($x5826 (not z_2_63)))
 (= z_1_63 $x5826)))
(assert
 (let (($x5831 (not z_2_64)))
 (= z_1_64 $x5831)))
(assert
 (let (($x5836 (not z_2_65)))
 (= z_1_65 $x5836)))
(assert
 (let (($x5841 (not z_2_66)))
 (= z_1_66 $x5841)))
(assert
 (let (($x5846 (not z_2_67)))
 (= z_1_67 $x5846)))
(assert
 (let (($x5851 (not z_2_68)))
 (= z_1_68 $x5851)))
(assert
 (let (($x5856 (not z_2_69)))
 (= z_1_69 $x5856)))
(assert
 (let (($x5861 (not z_2_70)))
 (= z_1_70 $x5861)))
(assert
 (let (($x5866 (not z_2_71)))
 (= z_1_71 $x5866)))
(assert
 (let (($x5871 (not z_2_72)))
 (= z_1_72 $x5871)))
(assert
 (let (($x5876 (not z_2_73)))
 (= z_1_73 $x5876)))
(assert
 (let (($x5881 (not z_2_74)))
 (= z_1_74 $x5881)))
(assert
 (let (($x5886 (not z_2_75)))
 (= z_1_75 $x5886)))
(assert
 (let (($x5891 (not z_2_76)))
 (= z_1_76 $x5891)))
(assert
 (let (($x5896 (not z_2_77)))
 (= z_1_77 $x5896)))
(assert
 (let (($x5901 (not z_2_78)))
 (= z_1_78 $x5901)))
(assert
 (let (($x5906 (not z_2_79)))
 (= z_1_79 $x5906)))
(assert
 (let (($x5911 (not z_2_80)))
 (= z_1_80 $x5911)))
(assert
 (let (($x5916 (not z_2_81)))
 (= z_1_81 $x5916)))
(assert
 (let (($x5921 (not z_2_82)))
 (= z_1_82 $x5921)))
(assert
 (let (($x5926 (not z_2_83)))
 (= z_1_83 $x5926)))
(assert
 (let (($x5931 (not z_2_84)))
 (= z_1_84 $x5931)))
(assert
 (let (($x5936 (not z_2_85)))
 (= z_1_85 $x5936)))
(assert
 (let (($x5941 (not z_2_86)))
 (= z_1_86 $x5941)))
(assert
 (let (($x5946 (not z_2_87)))
 (= z_1_87 $x5946)))
(assert
 (let (($x5951 (not z_2_88)))
 (= z_1_88 $x5951)))
(assert
 (let (($x5956 (not z_2_89)))
 (= z_1_89 $x5956)))
(assert
 (let (($x5961 (not z_2_90)))
 (= z_1_90 $x5961)))
(assert
 (let (($x5966 (not z_2_91)))
 (= z_1_91 $x5966)))
(assert
 (let (($x5971 (not z_2_92)))
 (= z_1_92 $x5971)))
(assert
 (let (($x5976 (not z_2_93)))
 (= z_1_93 $x5976)))
(assert
 (let (($x5981 (not z_2_94)))
 (= z_1_94 $x5981)))
(assert
 (let (($x5986 (not z_2_95)))
 (= z_1_95 $x5986)))
(assert
 (let (($x5991 (not z_2_96)))
 (= z_1_96 $x5991)))
(assert
 (let (($x5996 (not z_2_97)))
 (= z_1_97 $x5996)))
(assert
 (let (($x6001 (not z_2_98)))
 (= z_1_98 $x6001)))
(assert
 (let (($x6006 (not z_2_99)))
 (= z_1_99 $x6006)))
(assert
 (let (($x6011 (not z_2_100)))
 (= z_1_100 $x6011)))
(assert
 (let (($x6016 (not z_2_101)))
 (= z_1_101 $x6016)))
(assert
 (let (($x6021 (not z_2_102)))
 (= z_1_102 $x6021)))
(assert
 (let (($x6026 (not z_2_103)))
 (= z_1_103 $x6026)))
(assert
 (let (($x6031 (not z_2_104)))
 (= z_1_104 $x6031)))
(assert
 (let (($x6036 (not z_2_105)))
 (= z_1_105 $x6036)))
(assert
 (let (($x6041 (not z_2_106)))
 (= z_1_106 $x6041)))
(assert
 (let (($x6046 (not z_2_107)))
 (= z_1_107 $x6046)))
(assert
 (let (($x6051 (not z_2_108)))
 (= z_1_108 $x6051)))
(assert
 (let (($x6056 (not z_2_109)))
 (= z_1_109 $x6056)))
(assert
 (let (($x6061 (not z_2_110)))
 (= z_1_110 $x6061)))
(assert
 (let (($x6066 (not z_2_111)))
 (= z_1_111 $x6066)))
(assert
 (let (($x6071 (not z_2_112)))
 (= z_1_112 $x6071)))
(assert
 (let (($x6076 (not z_2_113)))
 (= z_1_113 $x6076)))
(assert
 (let (($x6081 (not z_2_114)))
 (= z_1_114 $x6081)))
(assert
 (let (($x6086 (not z_2_115)))
 (= z_1_115 $x6086)))
(assert
 (let (($x6091 (not z_2_116)))
 (= z_1_116 $x6091)))
(assert
 (let (($x6096 (not z_2_117)))
 (= z_1_117 $x6096)))
(assert
 (let (($x6101 (not z_2_118)))
 (= z_1_118 $x6101)))
(assert
 (let (($x6106 (not z_2_119)))
 (= z_1_119 $x6106)))
(assert
 (let (($x6111 (not z_2_120)))
 (= z_1_120 $x6111)))
(assert
 (let (($x6116 (not z_2_121)))
 (= z_1_121 $x6116)))
(assert
 (let (($x6121 (not z_2_122)))
 (= z_1_122 $x6121)))
(assert
 (let (($x6126 (not z_2_123)))
 (= z_1_123 $x6126)))
(assert
 (let (($x6131 (not z_2_124)))
 (= z_1_124 $x6131)))
(assert
 (let (($x6136 (not z_2_125)))
 (= z_1_125 $x6136)))
(assert
 (let (($x6141 (not z_2_126)))
 (= z_1_126 $x6141)))
(assert
 (let (($x6146 (not z_2_127)))
 (= z_1_127 $x6146)))
(assert
 (let (($x6151 (not z_2_128)))
 (= z_1_128 $x6151)))
(assert
 (let (($x6156 (not z_2_129)))
 (= z_1_129 $x6156)))
(assert
 (let (($x6161 (not z_2_130)))
 (= z_1_130 $x6161)))
(assert
 (let (($x6166 (not z_2_131)))
 (= z_1_131 $x6166)))
(assert
 (let (($x6171 (not z_2_132)))
 (= z_1_132 $x6171)))
(assert
 (let (($x6176 (not z_2_133)))
 (= z_1_133 $x6176)))
(assert
 (let (($x6181 (not z_2_134)))
 (= z_1_134 $x6181)))
(assert
 (let (($x6186 (not z_2_135)))
 (= z_1_135 $x6186)))
(assert
 (let (($x6191 (not z_2_136)))
 (= z_1_136 $x6191)))
(assert
 (let (($x6196 (not z_2_137)))
 (= z_1_137 $x6196)))
(assert
 (let (($x6201 (not z_2_138)))
 (= z_1_138 $x6201)))
(assert
 (let (($x6206 (not z_2_139)))
 (= z_1_139 $x6206)))
(assert
 (let (($x6211 (not z_2_140)))
 (= z_1_140 $x6211)))
(assert
 (let (($x6216 (not z_2_141)))
 (= z_1_141 $x6216)))
(assert
 (let (($x6221 (not z_2_142)))
 (= z_1_142 $x6221)))
(assert
 (let (($x6226 (not z_2_143)))
 (= z_1_143 $x6226)))
(assert
 (let (($x6231 (not z_2_144)))
 (= z_1_144 $x6231)))
(assert
 (let (($x6236 (not z_2_145)))
 (= z_1_145 $x6236)))
(assert
 (let (($x6241 (not z_2_146)))
 (= z_1_146 $x6241)))
(assert
 (let (($x6246 (not z_2_147)))
 (= z_1_147 $x6246)))
(assert
 (let (($x6251 (not z_2_148)))
 (= z_1_148 $x6251)))
(assert
 (let (($x6256 (not z_2_149)))
 (= z_1_149 $x6256)))
(assert
 (let (($x6261 (not z_2_150)))
 (= z_1_150 $x6261)))
(assert
 (let (($x6266 (not z_2_151)))
 (= z_1_151 $x6266)))
(assert
 (let (($x6271 (not z_2_152)))
 (= z_1_152 $x6271)))
(assert
 (let (($x6276 (not z_2_153)))
 (= z_1_153 $x6276)))
(assert
 (let (($x6281 (not z_2_154)))
 (= z_1_154 $x6281)))
(assert
 (let (($x6286 (not z_2_155)))
 (= z_1_155 $x6286)))
(assert
 (let (($x6291 (not z_2_156)))
 (= z_1_156 $x6291)))
(assert
 (let (($x6296 (not z_2_157)))
 (= z_1_157 $x6296)))
(assert
 (let (($x6301 (not z_2_158)))
 (= z_1_158 $x6301)))
(assert
 (let (($x6306 (not z_2_159)))
 (= z_1_159 $x6306)))
(assert
 (let (($x6311 (not z_2_160)))
 (= z_1_160 $x6311)))
(assert
 (let (($x6316 (not z_2_161)))
 (= z_1_161 $x6316)))
(assert
 (let (($x6321 (not z_2_162)))
 (= z_1_162 $x6321)))
(assert
 (let (($x6326 (not z_2_163)))
 (= z_1_163 $x6326)))
(assert
 (let (($x6331 (not z_2_164)))
 (= z_1_164 $x6331)))
(assert
 (let (($x6336 (not z_2_165)))
 (= z_1_165 $x6336)))
(assert
 (let (($x6341 (not z_2_166)))
 (= z_1_166 $x6341)))
(assert
 (let (($x6346 (not z_2_167)))
 (= z_1_167 $x6346)))
(assert
 (let (($x6351 (not z_2_168)))
 (= z_1_168 $x6351)))
(assert
 (let (($x6356 (not z_2_169)))
 (= z_1_169 $x6356)))
(assert
 (let (($x6361 (not z_2_170)))
 (= z_1_170 $x6361)))
(assert
 (let (($x6366 (not z_2_171)))
 (= z_1_171 $x6366)))
(assert
 (let (($x6371 (not z_2_172)))
 (= z_1_172 $x6371)))
(assert
 (let (($x6376 (not z_2_173)))
 (= z_1_173 $x6376)))
(assert
 (let (($x6381 (not z_2_174)))
 (= z_1_174 $x6381)))
(assert
 (let (($x6386 (not z_2_175)))
 (= z_1_175 $x6386)))
(assert
 (let (($x6391 (not z_2_176)))
 (= z_1_176 $x6391)))
(assert
 (let (($x6396 (not z_2_177)))
 (= z_1_177 $x6396)))
(assert
 (let (($x6401 (not z_2_178)))
 (= z_1_178 $x6401)))
(assert
 (let (($x6406 (not z_2_179)))
 (= z_1_179 $x6406)))
(assert
 (let (($x6411 (not z_2_180)))
 (= z_1_180 $x6411)))
(assert
 (let (($x6416 (not z_2_181)))
 (= z_1_181 $x6416)))
(assert
 (let (($x6421 (not z_2_182)))
 (= z_1_182 $x6421)))
(assert
 (let (($x6426 (not z_2_183)))
 (= z_1_183 $x6426)))
(assert
 (let (($x6431 (not z_2_184)))
 (= z_1_184 $x6431)))
(assert
 (let (($x6436 (not z_2_185)))
 (= z_1_185 $x6436)))
(assert
 (let (($x6441 (not z_2_186)))
 (= z_1_186 $x6441)))
(assert
 (let (($x6446 (not z_2_187)))
 (= z_1_187 $x6446)))
(assert
 (let (($x6451 (not z_2_188)))
 (= z_1_188 $x6451)))
(assert
 (let (($x6456 (not z_2_189)))
 (= z_1_189 $x6456)))
(assert
 (let (($x6461 (not z_2_190)))
 (= z_1_190 $x6461)))
(assert
 (let (($x6466 (not z_2_191)))
 (= z_1_191 $x6466)))
(assert
 (let (($x6471 (not z_2_192)))
 (= z_1_192 $x6471)))
(assert
 (let (($x6476 (not z_2_193)))
 (= z_1_193 $x6476)))
(assert
 (let (($x6481 (not z_2_194)))
 (= z_1_194 $x6481)))
(assert
 (let (($x6486 (not z_2_195)))
 (= z_1_195 $x6486)))
(assert
 (let (($x6491 (not z_2_196)))
 (= z_1_196 $x6491)))
(assert
 (let (($x6496 (not z_2_197)))
 (= z_1_197 $x6496)))
(assert
 (let (($x6501 (not z_2_198)))
 (= z_1_198 $x6501)))
(assert
 (let (($x6506 (not z_2_199)))
 (= z_1_199 $x6506)))
(assert
 (let (($x6511 (not z_2_200)))
 (= z_1_200 $x6511)))
(assert
 (let (($x6516 (not z_2_201)))
 (= z_1_201 $x6516)))
(assert
 (let (($x6521 (not z_2_202)))
 (= z_1_202 $x6521)))
(assert
 (let (($x6526 (not z_2_203)))
 (= z_1_203 $x6526)))
(assert
 (let (($x6531 (not z_2_204)))
 (= z_1_204 $x6531)))
(assert
 (let (($x6536 (not z_2_205)))
 (= z_1_205 $x6536)))
(assert
 (let (($x6541 (not z_2_206)))
 (= z_1_206 $x6541)))
(assert
 (let (($x6546 (not z_2_207)))
 (= z_1_207 $x6546)))
(assert
 (let (($x6551 (not z_2_208)))
 (= z_1_208 $x6551)))
(assert
 (let (($x6556 (not z_2_209)))
 (= z_1_209 $x6556)))
(assert
 (let (($x6561 (not z_2_210)))
 (= z_1_210 $x6561)))
(assert
 (let (($x6566 (not z_2_211)))
 (= z_1_211 $x6566)))
(assert
 (let (($x6571 (not z_2_212)))
 (= z_1_212 $x6571)))
(assert
 (let (($x6576 (not z_2_213)))
 (= z_1_213 $x6576)))
(assert
 (let (($x6581 (not z_2_214)))
 (= z_1_214 $x6581)))
(assert
 (let (($x6586 (not z_2_215)))
 (= z_1_215 $x6586)))
(assert
 (let (($x6591 (not z_2_216)))
 (= z_1_216 $x6591)))
(assert
 (let (($x6596 (not z_2_217)))
 (= z_1_217 $x6596)))
(assert
 (let (($x6601 (not z_2_218)))
 (= z_1_218 $x6601)))
(assert
 (let (($x6606 (not z_2_219)))
 (= z_1_219 $x6606)))
(assert
 (let (($x6611 (not z_2_220)))
 (= z_1_220 $x6611)))
(assert
 (let (($x6616 (not z_2_221)))
 (= z_1_221 $x6616)))
(assert
 (let (($x6621 (not z_2_222)))
 (= z_1_222 $x6621)))
(assert
 (let (($x6626 (not z_2_223)))
 (= z_1_223 $x6626)))
(assert
 (let (($x6631 (not z_2_224)))
 (= z_1_224 $x6631)))
(assert
 (let (($x6636 (not z_2_225)))
 (= z_1_225 $x6636)))
(assert
 (let (($x6641 (not z_2_226)))
 (= z_1_226 $x6641)))
(assert
 (let (($x6646 (not z_2_227)))
 (= z_1_227 $x6646)))
(assert
 (let (($x6651 (not z_2_228)))
 (= z_1_228 $x6651)))
(assert
 (let (($x6656 (not z_2_229)))
 (= z_1_229 $x6656)))
(assert
 (let (($x6661 (not z_2_230)))
 (= z_1_230 $x6661)))
(assert
 (let (($x6666 (not z_2_231)))
 (= z_1_231 $x6666)))
(assert
 (let (($x6671 (not z_2_232)))
 (= z_1_232 $x6671)))
(assert
 (let (($x6676 (not z_2_233)))
 (= z_1_233 $x6676)))
(assert
 (let (($x6681 (not z_2_234)))
 (= z_1_234 $x6681)))
(assert
 (let (($x6686 (not z_2_235)))
 (= z_1_235 $x6686)))
(assert
 (let (($x6691 (not z_2_236)))
 (= z_1_236 $x6691)))
(assert
 (let (($x6696 (not z_2_237)))
 (= z_1_237 $x6696)))
(assert
 (let (($x6701 (not z_2_238)))
 (= z_1_238 $x6701)))
(assert
 (let (($x6706 (not z_2_239)))
 (= z_1_239 $x6706)))
(assert
 (let (($x6711 (not z_2_240)))
 (= z_1_240 $x6711)))
(assert
 (let (($x6716 (not z_2_241)))
 (= z_1_241 $x6716)))
(assert
 (let (($x6721 (not z_2_242)))
 (= z_1_242 $x6721)))
(assert
 (let (($x6726 (not z_2_243)))
 (= z_1_243 $x6726)))
(assert
 (let (($x6731 (not z_2_244)))
 (= z_1_244 $x6731)))
(assert
 (let (($x6736 (not z_2_245)))
 (= z_1_245 $x6736)))
(assert
 (let (($x6741 (not z_2_246)))
 (= z_1_246 $x6741)))
(assert
 (let (($x6746 (not z_2_247)))
 (= z_1_247 $x6746)))
(assert
 (let (($x6751 (not z_2_248)))
 (= z_1_248 $x6751)))
(assert
 (let (($x6756 (not z_2_249)))
 (= z_1_249 $x6756)))
(assert
 (let (($x6761 (not z_2_250)))
 (= z_1_250 $x6761)))
(assert
 (let (($x6766 (not z_2_251)))
 (= z_1_251 $x6766)))
(assert
 (let (($x6771 (not z_2_252)))
 (= z_1_252 $x6771)))
(assert
 (let (($x6776 (not z_2_253)))
 (= z_1_253 $x6776)))
(assert
 (let (($x6781 (not z_2_254)))
 (= z_1_254 $x6781)))
(assert
 (let (($x6786 (not z_2_255)))
 (= z_1_255 $x6786)))
(assert
 (let (($x6791 (not z_2_256)))
 (= z_1_256 $x6791)))
(assert
 (let (($x6796 (not z_2_257)))
 (= z_1_257 $x6796)))
(assert
 (let (($x6801 (not z_2_258)))
 (= z_1_258 $x6801)))
(assert
 (let (($x6806 (not z_2_259)))
 (= z_1_259 $x6806)))
(assert
 (let (($x6811 (not z_2_260)))
 (= z_1_260 $x6811)))
(assert
 (let (($x6816 (not z_2_261)))
 (= z_1_261 $x6816)))
(assert
 (let (($x6821 (not z_2_262)))
 (= z_1_262 $x6821)))
(assert
 (let (($x6826 (not z_2_263)))
 (= z_1_263 $x6826)))
(assert
 (let (($x6831 (not z_2_264)))
 (= z_1_264 $x6831)))
(assert
 (let (($x6836 (not z_2_265)))
 (= z_1_265 $x6836)))
(assert
 (let (($x6841 (not z_2_266)))
 (= z_1_266 $x6841)))
(assert
 (let (($x6846 (not z_2_267)))
 (= z_1_267 $x6846)))
(assert
 (let (($x6851 (not z_2_268)))
 (= z_1_268 $x6851)))
(assert
 (let (($x6856 (not z_2_269)))
 (= z_1_269 $x6856)))
(assert
 (let (($x6861 (not z_2_270)))
 (= z_1_270 $x6861)))
(assert
 (let (($x6866 (not z_2_271)))
 (= z_1_271 $x6866)))
(assert
 (let (($x6871 (not z_2_272)))
 (= z_1_272 $x6871)))
(assert
 (let (($x6876 (not z_2_273)))
 (= z_1_273 $x6876)))
(assert
 (not z_2_0))
(assert
