...
(assert
 (= z_1_12 (not z_3_12)))
(assert
 (let (($x7365 (not z_3_13)))
 (= z_1_13 $x7365)))
(assert
 (let (($x7370 (not z_3_14)))
 (= z_1_14 $x7370)))
(assert
 (let (($x7375 (not z_3_15)))
 (= z_1_15 $x7375)))
(assert
 (let (($x7380 (not z_3_16)))
 (= z_1_16 $x7380)))
(assert
 (= z_1_17 (not z_3_17)))
(assert
 (let (($x7390 (not z_3_18)))
 (= z_1_18 $x7390)))
(assert
 (let (($x7395 (not z_3_19)))
 (= z_1_19 $x7395)))
(assert
 (= z_1_20 (not z_3_20)))
(assert
 (= z_1_21 (not z_3_21)))
(assert
 (let (($x7410 (not z_3_22)))
 (= z_1_22 $x7410)))
(assert
 (let (($x7415 (not z_3_23)))
 (= z_1_23 $x7415)))
(assert
 (= z_1_24 (not z_3_24)))
(assert
 (let (($x7425 (not z_3_25)))
 (= z_1_25 $x7425)))
(assert
 (= z_1_26 (not z_3_26)))
(assert
...
(assert
 (= z_1_28 (not z_3_28)))
(assert
 (let (($x7445 (not z_3_29)))
 (= z_1_29 $x7445)))
(assert
 (= z_1_30 (not z_3_30)))
(assert
 (let (($x7455 (not z_3_31)))
 (= z_1_31 $x7455)))
(assert
 (let (($x7460 (not z_3_32)))
 (= z_1_32 $x7460)))
(assert
 (let (($x7465 (not z_3_33)))
 (= z_1_33 $x7465)))
(assert
 (= z_1_34 (not z_3_34)))
(assert
...
(assert
 (= z_1_36 (not z_3_36)))
(assert
 (let (($x7485 (not z_3_37)))
 (= z_1_37 $x7485)))
(assert
 (let (($x7490 (not z_3_38)))
 (= z_1_38 $x7490)))
(assert
 (= z_1_39 (not z_3_39)))
(assert
 (= z_1_40 (not z_3_40)))
(assert
 (let (($x7505 (not z_3_41)))
 (= z_1_41 $x7505)))
(assert
 (let (($x7510 (not z_3_42)))
 (= z_1_42 $x7510)))
(assert
 (let (($x7515 (not z_3_43)))
 (= z_1_43 $x7515)))
(assert
 (= z_1_44 (not z_3_44)))
(assert
 (= z_1_45 (not z_3_45)))
(assert
 (let (($x7530 (not z_3_46)))
 (= z_1_46 $x7530)))
(assert
 (let (($x7535 (not z_3_47)))
 (= z_1_47 $x7535)))
(assert
 (let (($x7540 (not z_3_48)))
 (= z_1_48 $x7540)))
(assert
 (let (($x7545 (not z_3_49)))
 (= z_1_49 $x7545)))
(assert
 (let (($x7550 (not z_3_50)))
 (= z_1_50 $x7550)))
(assert
 (= z_1_51 (not z_3_51)))
(assert
 (= z_1_52 (not z_3_52)))
(assert
 (let (($x7565 (not z_3_53)))
 (= z_1_53 $x7565)))
(assert
 (= z_1_54 (not z_3_54)))
(assert
 (let (($x7575 (not z_3_55)))
 (= z_1_55 $x7575)))
(assert
 (let (($x7580 (not z_3_56)))
 (= z_1_56 $x7580)))
(assert
 (= z_1_57 (not z_3_57)))
(assert
 (let (($x7590 (not z_3_58)))
 (= z_1_58 $x7590)))
(assert
 (let (($x7595 (not z_3_59)))
 (= z_1_59 $x7595)))
(assert
 (= z_1_60 (not z_3_60)))
(assert
...
(assert
 (= z_1_69 (not z_3_69)))
(assert
 (let (($x7650 (not z_3_70)))
 (= z_1_70 $x7650)))
(assert
 (= z_1_71 (not z_3_71)))
(assert
 (let (($x7660 (not z_3_72)))
 (= z_1_72 $x7660)))
(assert
 (= z_1_73 (not z_3_73)))
(assert
 (let (($x7670 (not z_3_74)))
 (= z_1_74 $x7670)))
(assert
 (= z_1_75 (not z_3_75)))
(assert
 (let (($x7680 (not z_3_76)))
 (= z_1_76 $x7680)))
(assert
 (= z_1_77 (not z_3_77)))
(assert
...
(assert
 (= z_1_79 (not z_3_79)))
(assert
 (let (($x7700 (not z_3_80)))
 (= z_1_80 $x7700)))
(assert
 (let (($x7705 (not z_3_81)))
 (= z_1_81 $x7705)))
(assert
 (= z_1_82 (not z_3_82)))
(assert
 (let (($x7715 (not z_3_83)))
 (= z_1_83 $x7715)))
(assert
 (= z_1_84 (not z_3_84)))
(assert
...
(assert
 (= z_1_86 (not z_3_86)))
(assert
 (let (($x7735 (not z_3_87)))
 (= z_1_87 $x7735)))
(assert
 (= z_1_88 (not z_3_88)))
(assert
 (let (($x7745 (not z_3_89)))
 (= z_1_89 $x7745)))
(assert
 (let (($x7750 (not z_3_90)))
 (= z_1_90 $x7750)))
(assert
 (let (($x7755 (not z_3_91)))
 (= z_1_91 $x7755)))
(assert
 (and true true))
(assert
...
(assert
 ...
 (let (($x7765 (not x_3_F)))
 (let (($x7763 (not x_3_G)))
 (and $x7763 $x7765 $x7767 $x7769 $x7771 $x7773 $x7775 $x7777))))))))))
(check-sat)
