...
(assert
 (= z_0_61 (and z_1_61 z_1_62 z_1_63 z_1_64 z_1_3 z_1_2)))
(assert
 (= z_0_62 (and z_1_62 z_1_63 z_1_64 z_1_3 z_1_2)))
(assert
 (= z_0_63 (and z_1_63 z_1_64 z_1_3 z_1_2)))
(assert
 (= z_0_64 (and z_1_64 z_1_3 z_1_2)))
(assert
 (= z_0_65 (and z_1_65 z_1_66 z_1_67 z_1_39 z_1_26 z_1_24 z_1_25)))
(assert
 (= z_0_66 (and z_1_66 z_1_67 z_1_39 z_1_26 z_1_24 z_1_25)))
(assert
 (= z_0_67 (and z_1_67 z_1_39 z_1_26 z_1_24 z_1_25)))
(assert
 (= z_0_68 (and z_1_68 z_1_47 z_1_45 z_1_46)))
(assert
 (= z_0_69 (and z_1_69 z_1_70 z_1_71 z_1_72 z_1_46 z_1_47 z_1_45)))
(assert
 (= z_0_70 (and z_1_70 z_1_71 z_1_72 z_1_46 z_1_47 z_1_45)))
(assert
 (= z_0_71 (and z_1_71 z_1_72 z_1_46 z_1_47 z_1_45)))
(assert
 (= z_0_72 (and z_1_72 z_1_46 z_1_47 z_1_45)))
(assert
 (= z_0_73 (and z_1_73 z_1_74 z_1_58 z_1_59 z_1_60)))
(assert
 (= z_0_74 (and z_1_74 z_1_58 z_1_59 z_1_60)))
(assert
 (= z_0_75 (and z_1_75 z_1_6 z_1_7 z_1_8 z_1_9 z_1_10 z_1_11)))
(assert
 (= z_0_76 (and z_1_76 z_1_77 z_1_78 z_1_59 z_1_60)))
(assert
 (= z_0_77 (and z_1_77 z_1_78 z_1_59 z_1_60)))
(assert
 (= z_0_78 (and z_1_78 z_1_59 z_1_60)))
(assert
 (let (($x344 (and z_1_79 z_1_80 z_1_81 z_1_62 z_1_63 z_1_64 z_1_3 z_1_2)))
 (= z_0_79 $x344)))
(assert
 (= z_0_80 (and z_1_80 z_1_81 z_1_62 z_1_63 z_1_64 z_1_3 z_1_2)))
(assert
 (= z_0_81 (and z_1_81 z_1_62 z_1_63 z_1_64 z_1_3 z_1_2)))
(assert
 (= z_0_82 (and z_1_82 z_1_83 z_1_84 z_1_10 z_1_11 z_1_8 z_1_9)))
(assert
 (= z_0_83 (and z_1_83 z_1_84 z_1_10 z_1_11 z_1_8 z_1_9)))
(assert
 (= z_0_84 (and z_1_84 z_1_10 z_1_11 z_1_8 z_1_9)))
(assert
 (= z_0_85 (and z_1_85 z_1_86 z_1_87 z_1_37 z_1_3 z_1_2)))
(assert
 (= z_0_86 (and z_1_86 z_1_87 z_1_37 z_1_3 z_1_2)))
(assert
 (= z_0_87 (and z_1_87 z_1_37 z_1_3 z_1_2)))
(assert
 (= z_0_88 (and z_1_88 z_1_57 z_1_58 z_1_59 z_1_60)))
(assert
 (= z_0_89 (and z_1_89 z_1_90 z_1_91 z_1_1 z_1_2 z_1_3)))
(assert
 (= z_0_90 (and z_1_90 z_1_91 z_1_1 z_1_2 z_1_3)))
(assert
 (= z_0_91 (and z_1_91 z_1_1 z_1_2 z_1_3)))
(assert
 (let (($x3036 (not z_3_0)))
 (= z_1_0 $x3036)))
(assert
...
(assert
 (= z_1_12 (not z_3_12)))
(assert
 (let (($x3101 (not z_3_13)))
 (= z_1_13 $x3101)))
(assert
 (let (($x3106 (not z_3_14)))
 (= z_1_14 $x3106)))
(assert
 (let (($x3111 (not z_3_15)))
 (= z_1_15 $x3111)))
(assert
 (let (($x3116 (not z_3_16)))
 (= z_1_16 $x3116)))
(assert
 (= z_1_17 (not z_3_17)))
(assert
 (let (($x3126 (not z_3_18)))
 (= z_1_18 $x3126)))
(assert
 (let (($x3131 (not z_3_19)))
 (= z_1_19 $x3131)))
(assert
 (= z_1_20 (not z_3_20)))
(assert
 (= z_1_21 (not z_3_21)))
(assert
 (let (($x3146 (not z_3_22)))
 (= z_1_22 $x3146)))
(assert
 (let (($x3151 (not z_3_23)))
 (= z_1_23 $x3151)))
(assert
 (= z_1_24 (not z_3_24)))
(assert
 (let (($x3161 (not z_3_25)))
 (= z_1_25 $x3161)))
(assert
 (= z_1_26 (not z_3_26)))
(assert
...
(assert
 (= z_1_28 (not z_3_28)))
(assert
 (let (($x3181 (not z_3_29)))
 (= z_1_29 $x3181)))
(assert
 (= z_1_30 (not z_3_30)))
(assert
 (let (($x3191 (not z_3_31)))
 (= z_1_31 $x3191)))
(assert
 (let (($x3196 (not z_3_32)))
 (= z_1_32 $x3196)))
(assert
 (let (($x3201 (not z_3_33)))
 (= z_1_33 $x3201)))
(assert
 (= z_1_34 (not z_3_34)))
(assert
...
(assert
 (= z_1_36 (not z_3_36)))
(assert
 (let (($x3221 (not z_3_37)))
 (= z_1_37 $x3221)))
(assert
 (let (($x3226 (not z_3_38)))
 (= z_1_38 $x3226)))
(assert
 (= z_1_39 (not z_3_39)))
(assert
 (= z_1_40 (not z_3_40)))
(assert
 (let (($x3241 (not z_3_41)))
 (= z_1_41 $x3241)))
(assert
 (let (($x3246 (not z_3_42)))
 (= z_1_42 $x3246)))
(assert
 (let (($x3251 (not z_3_43)))
 (= z_1_43 $x3251)))
(assert
 (= z_1_44 (not z_3_44)))
(assert
 (= z_1_45 (not z_3_45)))
(assert
 (let (($x3266 (not z_3_46)))
 (= z_1_46 $x3266)))
(assert
 (let (($x3271 (not z_3_47)))
 (= z_1_47 $x3271)))
(assert
 (let (($x3276 (not z_3_48)))
 (= z_1_48 $x3276)))
(assert
 (let (($x3281 (not z_3_49)))
 (= z_1_49 $x3281)))
(assert
 (let (($x3286 (not z_3_50)))
 (= z_1_50 $x3286)))
(assert
 (= z_1_51 (not z_3_51)))
(assert
 (= z_1_52 (not z_3_52)))
(assert
 (let (($x3301 (not z_3_53)))
 (= z_1_53 $x3301)))
(assert
 (= z_1_54 (not z_3_54)))
(assert
 (let (($x3311 (not z_3_55)))
 (= z_1_55 $x3311)))
(assert
 (let (($x3316 (not z_3_56)))
 (= z_1_56 $x3316)))
(assert
 (= z_1_57 (not z_3_57)))
(assert
 (let (($x3326 (not z_3_58)))
 (= z_1_58 $x3326)))
(assert
 (let (($x3331 (not z_3_59)))
 (= z_1_59 $x3331)))
(assert
 (= z_1_60 (not z_3_60)))
(assert
...
(assert
 (= z_1_69 (not z_3_69)))
(assert
 (let (($x3386 (not z_3_70)))
 (= z_1_70 $x3386)))
(assert
 (= z_1_71 (not z_3_71)))
(assert
 (let (($x3396 (not z_3_72)))
 (= z_1_72 $x3396)))
(assert
 (= z_1_73 (not z_3_73)))
(assert
 (let (($x3406 (not z_3_74)))
 (= z_1_74 $x3406)))
(assert
 (= z_1_75 (not z_3_75)))
(assert
 (let (($x3416 (not z_3_76)))
 (= z_1_76 $x3416)))
(assert
 (= z_1_77 (not z_3_77)))
(assert
...
(assert
 (= z_1_79 (not z_3_79)))
(assert
 (let (($x3436 (not z_3_80)))
 (= z_1_80 $x3436)))
(assert
 (let (($x3441 (not z_3_81)))
 (= z_1_81 $x3441)))
(assert
 (= z_1_82 (not z_3_82)))
(assert
 (let (($x3451 (not z_3_83)))
 (= z_1_83 $x3451)))
(assert
 (= z_1_84 (not z_3_84)))
(assert
...
(assert
 (= z_1_86 (not z_3_86)))
(assert
 (let (($x3471 (not z_3_87)))
 (= z_1_87 $x3471)))
(assert
 (= z_1_88 (not z_3_88)))
(assert
 (let (($x3481 (not z_3_89)))
 (= z_1_89 $x3481)))
(assert
 (let (($x3486 (not z_3_90)))
 (= z_1_90 $x3486)))
(assert
 (let (($x3491 (not z_3_91)))
 (= z_1_91 $x3491)))
(assert
 (and true true))
(assert
...
(assert
 ...
 (let (($x3501 (not x_3_F)))
 (let (($x3499 (not x_3_G)))
 (and $x3499 $x3501 $x3503 $x3505 $x3507 $x3509 $x3511 $x3513))))))))))
(check-sat)
