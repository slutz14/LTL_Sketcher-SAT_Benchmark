...
(assert
 (= z_0_34 (and z_1_34 z_0_25)))
(assert
 (= z_0_35 (and z_1_35 z_0_7)))
(assert
 (= z_0_36 (and z_1_36 z_0_17)))
(assert
 (= z_0_37 (and z_1_37 z_0_38)))
(assert
 (= z_0_38 (and z_1_38 z_0_20)))
(assert
 (= z_0_39 (and z_1_39 z_0_40)))
(assert
 (= z_0_40 (and z_1_40 z_0_41)))
(assert
 (= z_0_41 (and z_1_41 z_0_6)))
(assert
 (= z_0_42 (and z_1_42 z_0_8)))
(assert
...
(assert
 (= z_0_51 (and z_1_51 z_0_48)))
(assert
 (= z_0_52 (and z_1_52 z_0_53)))
(assert
 (= z_0_53 (and z_1_53 z_0_42)))
(assert
 (= z_0_54 (and z_1_54 z_0_55)))
(assert
 (= z_0_55 (and z_1_55 z_0_42)))
(assert
 (= z_0_56 (and z_1_56 z_0_57)))
(assert
 (= z_0_57 (and z_1_57 z_0_4)))
(assert
 (= z_0_58 (and z_1_58 z_0_55)))
(assert
 (= z_0_59 (and z_1_59 z_0_1)))
(assert
 (= z_0_60 (and z_1_60 z_0_1)))
(assert
 (= z_0_61 (and z_1_61 z_0_60)))
(assert
 (= z_0_62 (and z_1_62 z_0_63)))
(assert
 (= z_0_63 (and z_1_63 z_0_27)))
(assert
 (= z_0_64 (and z_1_64 z_0_65)))
(assert
 (= z_0_65 (and z_1_65 z_0_66)))
(assert
 (= z_0_66 (and z_1_66 z_0_2)))
(assert
 (= z_0_67 (and z_1_67 z_0_14)))
(assert
...
(assert
 (= z_0_75 (and z_1_75 z_0_19)))
(assert
 (= z_0_76 (and z_1_76 z_0_77)))
(assert
 (= z_0_77 (and z_1_77 z_0_78)))
(assert
 (= z_0_78 (and z_1_78 z_0_23)))
(assert
 (= z_0_79 (and z_1_79 z_0_80)))
(assert
 (= z_0_80 (and z_1_80 z_0_81)))
(assert
 (= z_0_81 (and z_1_81 z_0_73)))
(assert
 (= z_0_82 (and z_1_82 z_0_66)))
(assert
 (= z_0_83 (and z_1_83 z_0_84)))
(assert
 (= z_0_84 (and z_1_84 z_0_57)))
(assert
 z_0_0)
(assert
 (not z_0_1))
