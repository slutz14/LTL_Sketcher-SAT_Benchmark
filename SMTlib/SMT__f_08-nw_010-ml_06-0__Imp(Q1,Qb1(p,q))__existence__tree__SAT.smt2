...
(assert
 (= z_0_19_0 false))
(assert
 (let (($x3900 (= z_1_0_2 z_1_6_0)))
 (and $x3900)))
(assert
 (let (($x3902 (= z_1_0_3 z_1_6_1)))
 (and $x3902)))
(assert
 (let (($x3904 (= z_1_0_4 z_1_6_2)))
 (and $x3904)))
(assert
 (let (($x3906 (= z_1_0_5 z_1_6_3)))
 (and $x3906)))
(assert
 (let (($x3908 (= z_1_0_6 z_1_6_4)))
 (and $x3908)))
(assert
 (let (($x3910 (= z_1_0_3 z_1_9_1)))
 (and $x3910)))
(assert
 (let (($x3912 (= z_1_0_4 z_1_9_2)))
 (and $x3912)))
(assert
 (let (($x3914 (= z_1_0_5 z_1_9_3)))
 (and $x3914)))
(assert
 (let (($x3916 (= z_1_0_6 z_1_9_4)))
 (and $x3916)))
(assert
 (let (($x3918 (= z_1_0_4 z_1_18_4)))
 (and $x3918)))
(assert
 (let (($x3920 (= z_1_0_5 z_1_18_5)))
 (and $x3920)))
(assert
 (let (($x3922 (= z_1_0_6 z_1_18_3)))
 (and $x3922)))
(assert
 (let (($x3924 (= z_1_1_2 z_1_16_5)))
 (and $x3924)))
(assert
 (let (($x3926 (= z_1_1_3 z_1_16_6)))
 (and $x3926)))
(assert
 (let (($x3928 (= z_1_1_4 z_1_16_3)))
 (and $x3928)))
(assert
 (let (($x3930 (= z_1_1_5 z_1_16_4)))
 (and $x3930)))
(assert
 (let (($x3932 (= z_1_2_1 z_1_8_1)))
 (and $x3932)))
(assert
 (let (($x3934 (= z_1_2_2 z_1_8_2)))
 (and $x3934)))
(assert
 (let (($x3936 (= z_1_2_3 z_1_8_3)))
 (and $x3936)))
(assert
 (let (($x3938 (= z_1_2_4 z_1_8_4)))
 (and $x3938)))
(assert
 (let (($x3940 (= z_1_2_5 z_1_8_5)))
 (and $x3940)))
(assert
 (let (($x3942 (= z_1_5_0 z_1_7_3)))
 (and $x3942)))
(assert
 (let (($x3944 (= z_1_6_1 z_1_9_1)))
 (and $x3944)))
(assert
 (let (($x3946 (= z_1_6_2 z_1_9_2)))
 (and $x3946)))
(assert
 (let (($x3948 (= z_1_6_3 z_1_9_3)))
 (and $x3948)))
(assert
 (let (($x3950 (= z_1_6_4 z_1_9_4)))
 (and $x3950)))
(assert
 (let (($x3952 (= z_1_6_2 z_1_18_4)))
 (and $x3952)))
(assert
 (let (($x3954 (= z_1_6_3 z_1_18_5)))
 (and $x3954)))
(assert
 (let (($x3956 (= z_1_6_4 z_1_18_3)))
 (and $x3956)))
(assert
 (let (($x3958 (= z_1_9_2 z_1_18_4)))
 (and $x3958)))
(assert
 (let (($x3960 (= z_1_9_3 z_1_18_5)))
 (and $x3960)))
(assert
 (let (($x3962 (= z_1_9_4 z_1_18_3)))
 (and $x3962)))
(assert
 (let (($x3964 (= z_1_10_3 z_1_19_5)))
 (and $x3964)))
(assert
 (let (($x3966 (= z_1_10_4 z_1_19_6)))
 (and $x3966)))
(assert
 (let (($x3968 (= z_1_10_5 z_1_19_4)))
 (and $x3968)))
(check-sat)
