...
(assert
 (= z_0_19_0 false))
(assert
 (let (($x6165 (= z_1_0_3 z_1_6_7)))
 (and $x6165)))
(assert
 (let (($x6167 (= z_1_0_4 z_1_6_8)))
 (and $x6167)))
(assert
 (let (($x6169 (= z_1_0_5 z_1_6_9)))
 (and $x6169)))
(assert
 (let (($x6171 (= z_1_0_6 z_1_6_10)))
 (and $x6171)))
(assert
 (let (($x6173 (= z_1_0_7 z_1_6_6)))
 (and $x6173)))
(assert
 (let (($x6175 (= z_1_2_5 z_1_5_4)))
 (and $x6175)))
(assert
 (let (($x6177 (= z_1_2_6 z_1_5_5)))
 (and $x6177)))
(assert
 (let (($x6179 (= z_1_2_7 z_1_5_6)))
 (and $x6179)))
(assert
 (let (($x6181 (= z_1_2_8 z_1_5_1)))
 (and $x6181)))
(assert
 (let (($x6183 (= z_1_2_9 z_1_5_2)))
 (and $x6183)))
(assert
 (let (($x6185 (= z_1_2_10 z_1_5_3)))
 (and $x6185)))
(assert
 (let (($x6187 (= z_1_4_1 z_1_9_7)))
 (and $x6187)))
(assert
 (let (($x6189 (= z_1_4_2 z_1_9_8)))
 (and $x6189)))
(assert
 (let (($x6191 (= z_1_4_3 z_1_9_5)))
 (and $x6191)))
(assert
 (let (($x6193 (= z_1_4_4 z_1_9_6)))
 (and $x6193)))
(check-sat)
