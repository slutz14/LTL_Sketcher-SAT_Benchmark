...
(assert
 (let (($x4804 (= z_3_0_0 z_4_0_1)))
 (=> x_3_X $x4804)))
(assert
 (let (($x4814 (or z_4_0_0 z_4_0_1 z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4815 (= z_3_0_0 $x4814)))
 (=> x_3_F $x4815))))
(assert
 (let (($x4820 (and z_4_0_0 z_4_0_1 z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4821 (= z_3_0_0 $x4820)))
 (=> x_3_G $x4821))))
(assert
 (=> x_3_! (= z_3_0_1 (not z_4_0_1))))
(assert
 (let (($x4831 (= z_3_0_1 z_4_0_2)))
 (=> x_3_X $x4831)))
(assert
 (let (($x4835 (= z_3_0_1 (or z_4_0_1 z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6))))
 (=> x_3_F $x4835)))
(assert
 (let (($x4839 (= z_3_0_1 (and z_4_0_1 z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6))))
 (=> x_3_G $x4839)))
(assert
 (=> x_3_! (= z_3_0_2 (not z_4_0_2))))
(assert
 (let (($x4848 (= z_3_0_2 z_4_0_3)))
 (=> x_3_X $x4848)))
(assert
 (let (($x4851 (or z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4852 (= z_3_0_2 $x4851)))
 (=> x_3_F $x4852))))
(assert
 (let (($x4855 (and z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4856 (= z_3_0_2 $x4855)))
 (=> x_3_G $x4856))))
(assert
 (=> x_3_! (= z_3_0_3 (not z_4_0_3))))
(assert
 (let (($x4865 (= z_3_0_3 z_4_0_4)))
 (=> x_3_X $x4865)))
(assert
 (let (($x4851 (or z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4868 (= z_3_0_3 $x4851)))
 (=> x_3_F $x4868))))
(assert
 (let (($x4855 (and z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4871 (= z_3_0_3 $x4855)))
 (=> x_3_G $x4871))))
(assert
 (=> x_3_! (= z_3_0_4 (not z_4_0_4))))
(assert
 (let (($x4880 (= z_3_0_4 z_4_0_5)))
 (=> x_3_X $x4880)))
(assert
 (let (($x4851 (or z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4883 (= z_3_0_4 $x4851)))
 (=> x_3_F $x4883))))
(assert
 (let (($x4855 (and z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4886 (= z_3_0_4 $x4855)))
 (=> x_3_G $x4886))))
(assert
 (=> x_3_! (= z_3_0_5 (not z_4_0_5))))
(assert
 (let (($x4895 (= z_3_0_5 z_4_0_6)))
 (=> x_3_X $x4895)))
(assert
 (let (($x4851 (or z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4898 (= z_3_0_5 $x4851)))
 (=> x_3_F $x4898))))
(assert
 (let (($x4855 (and z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4901 (= z_3_0_5 $x4855)))
 (=> x_3_G $x4901))))
(assert
 (=> x_3_! (= z_3_0_6 (not z_4_0_6))))
(assert
 (let (($x4910 (= z_3_0_6 z_4_0_2)))
 (=> x_3_X $x4910)))
(assert
 (let (($x4851 (or z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4913 (= z_3_0_6 $x4851)))
 (=> x_3_F $x4913))))
(assert
 (let (($x4855 (and z_4_0_2 z_4_0_3 z_4_0_4 z_4_0_5 z_4_0_6)))
 (let (($x4916 (= z_3_0_6 $x4855)))
 (=> x_3_G $x4916))))
(assert
 (=> x_3_! (= z_3_1_0 (not z_4_1_0))))
(assert
 (let (($x4927 (= z_3_1_0 z_4_1_1)))
 (=> x_3_X $x4927)))
(assert
 (let (($x4939 (or z_4_1_0 z_4_1_1 z_4_1_2 z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4940 (= z_3_1_0 $x4939)))
 (=> x_3_F $x4940))))
(assert
 (let (($x4943 (and z_4_1_0 z_4_1_1 z_4_1_2 z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4944 (= z_3_1_0 $x4943)))
 (=> x_3_G $x4944))))
(assert
 (=> x_3_! (= z_3_1_1 (not z_4_1_1))))
(assert
 (let (($x4953 (= z_3_1_1 z_4_1_2)))
 (=> x_3_X $x4953)))
(assert
 (let (($x4956 (or z_4_1_1 z_4_1_2 z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4957 (= z_3_1_1 $x4956)))
 (=> x_3_F $x4957))))
(assert
 (let (($x4960 (and z_4_1_1 z_4_1_2 z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4961 (= z_3_1_1 $x4960)))
 (=> x_3_G $x4961))))
(assert
 (=> x_3_! (= z_3_1_2 (not z_4_1_2))))
(assert
 (let (($x4970 (= z_3_1_2 z_4_1_3)))
 (=> x_3_X $x4970)))
(assert
 (let (($x4973 (or z_4_1_2 z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4974 (= z_3_1_2 $x4973)))
 (=> x_3_F $x4974))))
(assert
 (let (($x4977 (and z_4_1_2 z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4978 (= z_3_1_2 $x4977)))
 (=> x_3_G $x4978))))
(assert
 (=> x_3_! (= z_3_1_3 (not z_4_1_3))))
(assert
 (let (($x4987 (= z_3_1_3 z_4_1_4)))
 (=> x_3_X $x4987)))
(assert
 (let (($x4990 (or z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4991 (= z_3_1_3 $x4990)))
 (=> x_3_F $x4991))))
(assert
 (let (($x4994 (and z_4_1_3 z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x4995 (= z_3_1_3 $x4994)))
 (=> x_3_G $x4995))))
(assert
 (=> x_3_! (= z_3_1_4 (not z_4_1_4))))
(assert
 (let (($x5004 (= z_3_1_4 z_4_1_5)))
 (=> x_3_X $x5004)))
(assert
 (let (($x5007 (or z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5008 (= z_3_1_4 $x5007)))
 (=> x_3_F $x5008))))
(assert
 (let (($x5011 (and z_4_1_4 z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5012 (= z_3_1_4 $x5011)))
 (=> x_3_G $x5012))))
(assert
 (=> x_3_! (= z_3_1_5 (not z_4_1_5))))
(assert
 (let (($x5021 (= z_3_1_5 z_4_1_6)))
 (=> x_3_X $x5021)))
(assert
 (let (($x5024 (or z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5025 (= z_3_1_5 $x5024)))
 (=> x_3_F $x5025))))
(assert
 (let (($x5028 (and z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5029 (= z_3_1_5 $x5028)))
 (=> x_3_G $x5029))))
(assert
 (=> x_3_! (= z_3_1_6 (not z_4_1_6))))
(assert
 (let (($x5038 (= z_3_1_6 z_4_1_7)))
 (=> x_3_X $x5038)))
(assert
 (let (($x5024 (or z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5041 (= z_3_1_6 $x5024)))
 (=> x_3_F $x5041))))
(assert
 (let (($x5028 (and z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5044 (= z_3_1_6 $x5028)))
 (=> x_3_G $x5044))))
(assert
 (=> x_3_! (= z_3_1_7 (not z_4_1_7))))
(assert
 (let (($x5053 (= z_3_1_7 z_4_1_8)))
 (=> x_3_X $x5053)))
(assert
 (let (($x5024 (or z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5056 (= z_3_1_7 $x5024)))
 (=> x_3_F $x5056))))
(assert
 (let (($x5028 (and z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5059 (= z_3_1_7 $x5028)))
 (=> x_3_G $x5059))))
(assert
 (=> x_3_! (= z_3_1_8 (not z_4_1_8))))
(assert
 (let (($x5068 (= z_3_1_8 z_4_1_9)))
 (=> x_3_X $x5068)))
(assert
 (let (($x5024 (or z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5071 (= z_3_1_8 $x5024)))
 (=> x_3_F $x5071))))
(assert
 (let (($x5028 (and z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5074 (= z_3_1_8 $x5028)))
 (=> x_3_G $x5074))))
(assert
 (=> x_3_! (= z_3_1_9 (not z_4_1_9))))
(assert
 (let (($x5083 (= z_3_1_9 z_4_1_10)))
 (=> x_3_X $x5083)))
(assert
 (let (($x5024 (or z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5086 (= z_3_1_9 $x5024)))
 (=> x_3_F $x5086))))
(assert
 (let (($x5028 (and z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5089 (= z_3_1_9 $x5028)))
 (=> x_3_G $x5089))))
(assert
 (=> x_3_! (= z_3_1_10 (not z_4_1_10))))
(assert
 (let (($x5098 (= z_3_1_10 z_4_1_5)))
 (=> x_3_X $x5098)))
(assert
 (let (($x5024 (or z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5101 (= z_3_1_10 $x5024)))
 (=> x_3_F $x5101))))
(assert
 (let (($x5028 (and z_4_1_5 z_4_1_6 z_4_1_7 z_4_1_8 z_4_1_9 z_4_1_10)))
 (let (($x5104 (= z_3_1_10 $x5028)))
 (=> x_3_G $x5104))))
(assert
 (=> x_3_! (= z_3_2_0 (not z_4_2_0))))
(assert
 (let (($x5115 (= z_3_2_0 z_4_2_1)))
 (=> x_3_X $x5115)))
(assert
 (let (($x5126 (or z_4_2_0 z_4_2_1 z_4_2_2 z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5127 (= z_3_2_0 $x5126)))
 (=> x_3_F $x5127))))
(assert
 (let (($x5130 (and z_4_2_0 z_4_2_1 z_4_2_2 z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5131 (= z_3_2_0 $x5130)))
 (=> x_3_G $x5131))))
(assert
 (=> x_3_! (= z_3_2_1 (not z_4_2_1))))
(assert
 (let (($x5140 (= z_3_2_1 z_4_2_2)))
 (=> x_3_X $x5140)))
(assert
 (let (($x5143 (or z_4_2_1 z_4_2_2 z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5144 (= z_3_2_1 $x5143)))
 (=> x_3_F $x5144))))
(assert
 (let (($x5147 (and z_4_2_1 z_4_2_2 z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5148 (= z_3_2_1 $x5147)))
 (=> x_3_G $x5148))))
(assert
 (=> x_3_! (= z_3_2_2 (not z_4_2_2))))
(assert
 (let (($x5157 (= z_3_2_2 z_4_2_3)))
 (=> x_3_X $x5157)))
(assert
 (let (($x5160 (or z_4_2_2 z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5161 (= z_3_2_2 $x5160)))
 (=> x_3_F $x5161))))
(assert
 (let (($x5164 (and z_4_2_2 z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5165 (= z_3_2_2 $x5164)))
 (=> x_3_G $x5165))))
(assert
 (=> x_3_! (= z_3_2_3 (not z_4_2_3))))
(assert
 (let (($x5174 (= z_3_2_3 z_4_2_4)))
 (=> x_3_X $x5174)))
(assert
 (let (($x5177 (or z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5178 (= z_3_2_3 $x5177)))
 (=> x_3_F $x5178))))
(assert
 (let (($x5181 (and z_4_2_3 z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5182 (= z_3_2_3 $x5181)))
 (=> x_3_G $x5182))))
(assert
 (=> x_3_! (= z_3_2_4 (not z_4_2_4))))
(assert
 (let (($x5191 (= z_3_2_4 z_4_2_5)))
 (=> x_3_X $x5191)))
(assert
 (let (($x5195 (= z_3_2_4 (or z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9))))
 (=> x_3_F $x5195)))
(assert
 (let (($x5199 (= z_3_2_4 (and z_4_2_4 z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9))))
 (=> x_3_G $x5199)))
(assert
 (=> x_3_! (= z_3_2_5 (not z_4_2_5))))
(assert
 (let (($x5208 (= z_3_2_5 z_4_2_6)))
 (=> x_3_X $x5208)))
(assert
 (let (($x5211 (or z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5212 (= z_3_2_5 $x5211)))
 (=> x_3_F $x5212))))
(assert
 (let (($x5215 (and z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5216 (= z_3_2_5 $x5215)))
 (=> x_3_G $x5216))))
(assert
 (=> x_3_! (= z_3_2_6 (not z_4_2_6))))
(assert
 (let (($x5225 (= z_3_2_6 z_4_2_7)))
 (=> x_3_X $x5225)))
(assert
 (let (($x5211 (or z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5228 (= z_3_2_6 $x5211)))
 (=> x_3_F $x5228))))
(assert
 (let (($x5215 (and z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5231 (= z_3_2_6 $x5215)))
 (=> x_3_G $x5231))))
(assert
 (=> x_3_! (= z_3_2_7 (not z_4_2_7))))
(assert
 (let (($x5240 (= z_3_2_7 z_4_2_8)))
 (=> x_3_X $x5240)))
(assert
 (let (($x5211 (or z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5243 (= z_3_2_7 $x5211)))
 (=> x_3_F $x5243))))
(assert
 (let (($x5215 (and z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5246 (= z_3_2_7 $x5215)))
 (=> x_3_G $x5246))))
(assert
 (=> x_3_! (= z_3_2_8 (not z_4_2_8))))
(assert
 (let (($x5255 (= z_3_2_8 z_4_2_9)))
 (=> x_3_X $x5255)))
(assert
 (let (($x5211 (or z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5258 (= z_3_2_8 $x5211)))
 (=> x_3_F $x5258))))
(assert
 (let (($x5215 (and z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5261 (= z_3_2_8 $x5215)))
 (=> x_3_G $x5261))))
(assert
 (=> x_3_! (= z_3_2_9 (not z_4_2_9))))
(assert
 (let (($x5270 (= z_3_2_9 z_4_2_5)))
 (=> x_3_X $x5270)))
(assert
 (let (($x5211 (or z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5273 (= z_3_2_9 $x5211)))
 (=> x_3_F $x5273))))
(assert
 (let (($x5215 (and z_4_2_5 z_4_2_6 z_4_2_7 z_4_2_8 z_4_2_9)))
 (let (($x5276 (= z_3_2_9 $x5215)))
 (=> x_3_G $x5276))))
(assert
 (=> x_3_! (= z_3_3_0 (not z_4_3_0))))
(assert
 (let (($x5287 (= z_3_3_0 z_4_3_1)))
 (=> x_3_X $x5287)))
(assert
 (let (($x5293 (= z_3_3_0 (or z_4_3_0 z_4_3_1 z_4_3_2 z_4_3_3))))
 (=> x_3_F $x5293)))
(assert
 (let (($x5297 (= z_3_3_0 (and z_4_3_0 z_4_3_1 z_4_3_2 z_4_3_3))))
 (=> x_3_G $x5297)))
(assert
 (=> x_3_! (= z_3_3_1 (not z_4_3_1))))
(assert
 (let (($x5306 (= z_3_3_1 z_4_3_2)))
 (=> x_3_X $x5306)))
(assert
 (let (($x5310 (= z_3_3_1 (or z_4_3_1 z_4_3_2 z_4_3_3))))
 (=> x_3_F $x5310)))
(assert
 (let (($x5314 (= z_3_3_1 (and z_4_3_1 z_4_3_2 z_4_3_3))))
 (=> x_3_G $x5314)))
(assert
 (=> x_3_! (= z_3_3_2 (not z_4_3_2))))
(assert
 (let (($x5323 (= z_3_3_2 z_4_3_3)))
 (=> x_3_X $x5323)))
(assert
 (let (($x5327 (= z_3_3_2 (or z_4_3_2 z_4_3_3))))
 (=> x_3_F $x5327)))
(assert
 (let (($x5331 (= z_3_3_2 (and z_4_3_2 z_4_3_3))))
 (=> x_3_G $x5331)))
(assert
 (=> x_3_! (= z_3_3_3 (not z_4_3_3))))
(assert
 (let (($x5340 (= z_3_3_3 z_4_3_3)))
 (=> x_3_X $x5340)))
(assert
...
(assert
 (let (($x5359 (= z_3_4_0 z_4_4_1)))
 (=> x_3_X $x5359)))
(assert
 (let (($x5370 (or z_4_4_0 z_4_4_1 z_4_4_2 z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5371 (= z_3_4_0 $x5370)))
 (=> x_3_F $x5371))))
(assert
 (let (($x5374 (and z_4_4_0 z_4_4_1 z_4_4_2 z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5375 (= z_3_4_0 $x5374)))
 (=> x_3_G $x5375))))
(assert
 (=> x_3_! (= z_3_4_1 (not z_4_4_1))))
(assert
 (let (($x5384 (= z_3_4_1 z_4_4_2)))
 (=> x_3_X $x5384)))
(assert
 (let (($x5387 (or z_4_4_1 z_4_4_2 z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5388 (= z_3_4_1 $x5387)))
 (=> x_3_F $x5388))))
(assert
 (let (($x5391 (and z_4_4_1 z_4_4_2 z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5392 (= z_3_4_1 $x5391)))
 (=> x_3_G $x5392))))
(assert
 (=> x_3_! (= z_3_4_2 (not z_4_4_2))))
(assert
 (let (($x5401 (= z_3_4_2 z_4_4_3)))
 (=> x_3_X $x5401)))
(assert
 (let (($x5404 (or z_4_4_2 z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5405 (= z_3_4_2 $x5404)))
 (=> x_3_F $x5405))))
(assert
 (let (($x5408 (and z_4_4_2 z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5409 (= z_3_4_2 $x5408)))
 (=> x_3_G $x5409))))
(assert
 (=> x_3_! (= z_3_4_3 (not z_4_4_3))))
(assert
 (let (($x5418 (= z_3_4_3 z_4_4_4)))
 (=> x_3_X $x5418)))
(assert
 (let (($x5421 (or z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5422 (= z_3_4_3 $x5421)))
 (=> x_3_F $x5422))))
(assert
 (let (($x5425 (and z_4_4_3 z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5426 (= z_3_4_3 $x5425)))
 (=> x_3_G $x5426))))
(assert
 (=> x_3_! (= z_3_4_4 (not z_4_4_4))))
(assert
 (let (($x5435 (= z_3_4_4 z_4_4_5)))
 (=> x_3_X $x5435)))
(assert
 (let (($x5439 (= z_3_4_4 (or z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9))))
 (=> x_3_F $x5439)))
(assert
 (let (($x5443 (= z_3_4_4 (and z_4_4_4 z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9))))
 (=> x_3_G $x5443)))
(assert
 (=> x_3_! (= z_3_4_5 (not z_4_4_5))))
(assert
 (let (($x5452 (= z_3_4_5 z_4_4_6)))
 (=> x_3_X $x5452)))
(assert
 (let (($x5455 (or z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5456 (= z_3_4_5 $x5455)))
 (=> x_3_F $x5456))))
(assert
 (let (($x5459 (and z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5460 (= z_3_4_5 $x5459)))
 (=> x_3_G $x5460))))
(assert
 (=> x_3_! (= z_3_4_6 (not z_4_4_6))))
(assert
 (let (($x5469 (= z_3_4_6 z_4_4_7)))
 (=> x_3_X $x5469)))
(assert
 (let (($x5455 (or z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5472 (= z_3_4_6 $x5455)))
 (=> x_3_F $x5472))))
(assert
 (let (($x5459 (and z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5475 (= z_3_4_6 $x5459)))
 (=> x_3_G $x5475))))
(assert
 (=> x_3_! (= z_3_4_7 (not z_4_4_7))))
(assert
 (let (($x5484 (= z_3_4_7 z_4_4_8)))
 (=> x_3_X $x5484)))
(assert
 (let (($x5455 (or z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5487 (= z_3_4_7 $x5455)))
 (=> x_3_F $x5487))))
(assert
 (let (($x5459 (and z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5490 (= z_3_4_7 $x5459)))
 (=> x_3_G $x5490))))
(assert
 (=> x_3_! (= z_3_4_8 (not z_4_4_8))))
(assert
 (let (($x5499 (= z_3_4_8 z_4_4_9)))
 (=> x_3_X $x5499)))
(assert
 (let (($x5455 (or z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5502 (= z_3_4_8 $x5455)))
 (=> x_3_F $x5502))))
(assert
 (let (($x5459 (and z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5505 (= z_3_4_8 $x5459)))
 (=> x_3_G $x5505))))
(assert
 (=> x_3_! (= z_3_4_9 (not z_4_4_9))))
(assert
 (let (($x5514 (= z_3_4_9 z_4_4_5)))
 (=> x_3_X $x5514)))
(assert
 (let (($x5455 (or z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5517 (= z_3_4_9 $x5455)))
 (=> x_3_F $x5517))))
(assert
 (let (($x5459 (and z_4_4_5 z_4_4_6 z_4_4_7 z_4_4_8 z_4_4_9)))
 (let (($x5520 (= z_3_4_9 $x5459)))
 (=> x_3_G $x5520))))
(assert
 (=> x_3_! (= z_3_5_0 (not z_4_5_0))))
(assert
 (let (($x5531 (= z_3_5_0 z_4_5_1)))
 (=> x_3_X $x5531)))
(assert
 (let (($x5541 (or z_4_5_0 z_4_5_1 z_4_5_2 z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5542 (= z_3_5_0 $x5541)))
 (=> x_3_F $x5542))))
(assert
 (let (($x5545 (and z_4_5_0 z_4_5_1 z_4_5_2 z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5546 (= z_3_5_0 $x5545)))
 (=> x_3_G $x5546))))
(assert
 (=> x_3_! (= z_3_5_1 (not z_4_5_1))))
(assert
 (let (($x5555 (= z_3_5_1 z_4_5_2)))
 (=> x_3_X $x5555)))
(assert
 (let (($x5558 (or z_4_5_1 z_4_5_2 z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5559 (= z_3_5_1 $x5558)))
 (=> x_3_F $x5559))))
(assert
 (let (($x5562 (and z_4_5_1 z_4_5_2 z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5563 (= z_3_5_1 $x5562)))
 (=> x_3_G $x5563))))
(assert
 (=> x_3_! (= z_3_5_2 (not z_4_5_2))))
(assert
 (let (($x5572 (= z_3_5_2 z_4_5_3)))
 (=> x_3_X $x5572)))
(assert
 (let (($x5575 (or z_4_5_2 z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5576 (= z_3_5_2 $x5575)))
 (=> x_3_F $x5576))))
(assert
 (let (($x5579 (and z_4_5_2 z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5580 (= z_3_5_2 $x5579)))
 (=> x_3_G $x5580))))
(assert
 (=> x_3_! (= z_3_5_3 (not z_4_5_3))))
(assert
 (let (($x5589 (= z_3_5_3 z_4_5_4)))
 (=> x_3_X $x5589)))
(assert
 (let (($x5593 (= z_3_5_3 (or z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8))))
 (=> x_3_F $x5593)))
(assert
 (let (($x5597 (= z_3_5_3 (and z_4_5_3 z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8))))
 (=> x_3_G $x5597)))
(assert
 (=> x_3_! (= z_3_5_4 (not z_4_5_4))))
(assert
 (let (($x5606 (= z_3_5_4 z_4_5_5)))
 (=> x_3_X $x5606)))
(assert
 (let (($x5609 (or z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5610 (= z_3_5_4 $x5609)))
 (=> x_3_F $x5610))))
(assert
 (let (($x5613 (and z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5614 (= z_3_5_4 $x5613)))
 (=> x_3_G $x5614))))
(assert
 (=> x_3_! (= z_3_5_5 (not z_4_5_5))))
(assert
 (let (($x5623 (= z_3_5_5 z_4_5_6)))
 (=> x_3_X $x5623)))
(assert
 (let (($x5609 (or z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5626 (= z_3_5_5 $x5609)))
 (=> x_3_F $x5626))))
(assert
 (let (($x5613 (and z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5629 (= z_3_5_5 $x5613)))
 (=> x_3_G $x5629))))
(assert
 (=> x_3_! (= z_3_5_6 (not z_4_5_6))))
(assert
 (let (($x5638 (= z_3_5_6 z_4_5_7)))
 (=> x_3_X $x5638)))
(assert
 (let (($x5609 (or z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5641 (= z_3_5_6 $x5609)))
 (=> x_3_F $x5641))))
(assert
 (let (($x5613 (and z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5644 (= z_3_5_6 $x5613)))
 (=> x_3_G $x5644))))
(assert
 (=> x_3_! (= z_3_5_7 (not z_4_5_7))))
(assert
 (let (($x5653 (= z_3_5_7 z_4_5_8)))
 (=> x_3_X $x5653)))
(assert
 (let (($x5609 (or z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5656 (= z_3_5_7 $x5609)))
 (=> x_3_F $x5656))))
(assert
 (let (($x5613 (and z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5659 (= z_3_5_7 $x5613)))
 (=> x_3_G $x5659))))
(assert
 (=> x_3_! (= z_3_5_8 (not z_4_5_8))))
(assert
 (let (($x5668 (= z_3_5_8 z_4_5_4)))
 (=> x_3_X $x5668)))
(assert
 (let (($x5609 (or z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5671 (= z_3_5_8 $x5609)))
 (=> x_3_F $x5671))))
(assert
 (let (($x5613 (and z_4_5_4 z_4_5_5 z_4_5_6 z_4_5_7 z_4_5_8)))
 (let (($x5674 (= z_3_5_8 $x5613)))
 (=> x_3_G $x5674))))
(assert
 (=> x_3_! (= z_3_6_0 (not z_4_6_0))))
(assert
 (let (($x5685 (= z_3_6_0 z_4_6_1)))
 (=> x_3_X $x5685)))
(assert
 (let (($x5697 (or z_4_6_0 z_4_6_1 z_4_6_2 z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5698 (= z_3_6_0 $x5697)))
 (=> x_3_F $x5698))))
(assert
 (let (($x5701 (and z_4_6_0 z_4_6_1 z_4_6_2 z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5702 (= z_3_6_0 $x5701)))
 (=> x_3_G $x5702))))
(assert
 (=> x_3_! (= z_3_6_1 (not z_4_6_1))))
(assert
 (let (($x5711 (= z_3_6_1 z_4_6_2)))
 (=> x_3_X $x5711)))
(assert
 (let (($x5714 (or z_4_6_1 z_4_6_2 z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5715 (= z_3_6_1 $x5714)))
 (=> x_3_F $x5715))))
(assert
 (let (($x5718 (and z_4_6_1 z_4_6_2 z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5719 (= z_3_6_1 $x5718)))
 (=> x_3_G $x5719))))
(assert
 (=> x_3_! (= z_3_6_2 (not z_4_6_2))))
(assert
 (let (($x5728 (= z_3_6_2 z_4_6_3)))
 (=> x_3_X $x5728)))
(assert
 (let (($x5731 (or z_4_6_2 z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5732 (= z_3_6_2 $x5731)))
 (=> x_3_F $x5732))))
(assert
 (let (($x5735 (and z_4_6_2 z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5736 (= z_3_6_2 $x5735)))
 (=> x_3_G $x5736))))
(assert
 (=> x_3_! (= z_3_6_3 (not z_4_6_3))))
(assert
 (let (($x5745 (= z_3_6_3 z_4_6_4)))
 (=> x_3_X $x5745)))
(assert
 (let (($x5748 (or z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5749 (= z_3_6_3 $x5748)))
 (=> x_3_F $x5749))))
(assert
 (let (($x5752 (and z_4_6_3 z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5753 (= z_3_6_3 $x5752)))
 (=> x_3_G $x5753))))
(assert
 (=> x_3_! (= z_3_6_4 (not z_4_6_4))))
(assert
 (let (($x5762 (= z_3_6_4 z_4_6_5)))
 (=> x_3_X $x5762)))
(assert
 (let (($x5765 (or z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5766 (= z_3_6_4 $x5765)))
 (=> x_3_F $x5766))))
(assert
 (let (($x5769 (and z_4_6_4 z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5770 (= z_3_6_4 $x5769)))
 (=> x_3_G $x5770))))
(assert
 (=> x_3_! (= z_3_6_5 (not z_4_6_5))))
(assert
 (let (($x5779 (= z_3_6_5 z_4_6_6)))
 (=> x_3_X $x5779)))
(assert
 (let (($x5782 (or z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5783 (= z_3_6_5 $x5782)))
 (=> x_3_F $x5783))))
(assert
 (let (($x5786 (and z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5787 (= z_3_6_5 $x5786)))
 (=> x_3_G $x5787))))
(assert
 (=> x_3_! (= z_3_6_6 (not z_4_6_6))))
(assert
 (let (($x5796 (= z_3_6_6 z_4_6_7)))
 (=> x_3_X $x5796)))
(assert
 (let (($x5782 (or z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5799 (= z_3_6_6 $x5782)))
 (=> x_3_F $x5799))))
(assert
 (let (($x5786 (and z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5802 (= z_3_6_6 $x5786)))
 (=> x_3_G $x5802))))
(assert
 (=> x_3_! (= z_3_6_7 (not z_4_6_7))))
(assert
 (let (($x5811 (= z_3_6_7 z_4_6_8)))
 (=> x_3_X $x5811)))
(assert
 (let (($x5782 (or z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5814 (= z_3_6_7 $x5782)))
 (=> x_3_F $x5814))))
(assert
 (let (($x5786 (and z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5817 (= z_3_6_7 $x5786)))
 (=> x_3_G $x5817))))
(assert
 (=> x_3_! (= z_3_6_8 (not z_4_6_8))))
(assert
 (let (($x5826 (= z_3_6_8 z_4_6_9)))
 (=> x_3_X $x5826)))
(assert
 (let (($x5782 (or z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5829 (= z_3_6_8 $x5782)))
 (=> x_3_F $x5829))))
(assert
 (let (($x5786 (and z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5832 (= z_3_6_8 $x5786)))
 (=> x_3_G $x5832))))
(assert
 (=> x_3_! (= z_3_6_9 (not z_4_6_9))))
(assert
 (let (($x5841 (= z_3_6_9 z_4_6_10)))
 (=> x_3_X $x5841)))
(assert
 (let (($x5782 (or z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5844 (= z_3_6_9 $x5782)))
 (=> x_3_F $x5844))))
(assert
 (let (($x5786 (and z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5847 (= z_3_6_9 $x5786)))
 (=> x_3_G $x5847))))
(assert
 (=> x_3_! (= z_3_6_10 (not z_4_6_10))))
(assert
 (let (($x5856 (= z_3_6_10 z_4_6_5)))
 (=> x_3_X $x5856)))
(assert
 (let (($x5782 (or z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5859 (= z_3_6_10 $x5782)))
 (=> x_3_F $x5859))))
(assert
 (let (($x5786 (and z_4_6_5 z_4_6_6 z_4_6_7 z_4_6_8 z_4_6_9 z_4_6_10)))
 (let (($x5862 (= z_3_6_10 $x5786)))
 (=> x_3_G $x5862))))
(assert
 (=> x_3_! (= z_3_7_0 (not z_4_7_0))))
(assert
 (let (($x5873 (= z_3_7_0 z_4_7_1)))
 (=> x_3_X $x5873)))
(assert
 (let (($x5883 (or z_4_7_0 z_4_7_1 z_4_7_2 z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5884 (= z_3_7_0 $x5883)))
 (=> x_3_F $x5884))))
(assert
 (let (($x5887 (and z_4_7_0 z_4_7_1 z_4_7_2 z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5888 (= z_3_7_0 $x5887)))
 (=> x_3_G $x5888))))
(assert
 (=> x_3_! (= z_3_7_1 (not z_4_7_1))))
(assert
 (let (($x5897 (= z_3_7_1 z_4_7_2)))
 (=> x_3_X $x5897)))
(assert
 (let (($x5900 (or z_4_7_1 z_4_7_2 z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5901 (= z_3_7_1 $x5900)))
 (=> x_3_F $x5901))))
(assert
 (let (($x5904 (and z_4_7_1 z_4_7_2 z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5905 (= z_3_7_1 $x5904)))
 (=> x_3_G $x5905))))
(assert
 (=> x_3_! (= z_3_7_2 (not z_4_7_2))))
(assert
 (let (($x5914 (= z_3_7_2 z_4_7_3)))
 (=> x_3_X $x5914)))
(assert
 (let (($x5917 (or z_4_7_2 z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5918 (= z_3_7_2 $x5917)))
 (=> x_3_F $x5918))))
(assert
 (let (($x5921 (and z_4_7_2 z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5922 (= z_3_7_2 $x5921)))
 (=> x_3_G $x5922))))
(assert
 (=> x_3_! (= z_3_7_3 (not z_4_7_3))))
(assert
 (let (($x5931 (= z_3_7_3 z_4_7_4)))
 (=> x_3_X $x5931)))
(assert
 (let (($x5935 (= z_3_7_3 (or z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8))))
 (=> x_3_F $x5935)))
(assert
 (let (($x5939 (= z_3_7_3 (and z_4_7_3 z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8))))
 (=> x_3_G $x5939)))
(assert
 (=> x_3_! (= z_3_7_4 (not z_4_7_4))))
(assert
 (let (($x5948 (= z_3_7_4 z_4_7_5)))
 (=> x_3_X $x5948)))
(assert
 (let (($x5952 (= z_3_7_4 (or z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8))))
 (=> x_3_F $x5952)))
(assert
 (let (($x5956 (= z_3_7_4 (and z_4_7_4 z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8))))
 (=> x_3_G $x5956)))
(assert
 (=> x_3_! (= z_3_7_5 (not z_4_7_5))))
(assert
 (let (($x5965 (= z_3_7_5 z_4_7_6)))
 (=> x_3_X $x5965)))
(assert
 (let (($x5968 (or z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5969 (= z_3_7_5 $x5968)))
 (=> x_3_F $x5969))))
(assert
 (let (($x5972 (and z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5973 (= z_3_7_5 $x5972)))
 (=> x_3_G $x5973))))
(assert
 (=> x_3_! (= z_3_7_6 (not z_4_7_6))))
(assert
 (let (($x5982 (= z_3_7_6 z_4_7_7)))
 (=> x_3_X $x5982)))
(assert
 (let (($x5968 (or z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5985 (= z_3_7_6 $x5968)))
 (=> x_3_F $x5985))))
(assert
 (let (($x5972 (and z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x5988 (= z_3_7_6 $x5972)))
 (=> x_3_G $x5988))))
(assert
 (=> x_3_! (= z_3_7_7 (not z_4_7_7))))
(assert
 (let (($x5997 (= z_3_7_7 z_4_7_8)))
 (=> x_3_X $x5997)))
(assert
 (let (($x5968 (or z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x6000 (= z_3_7_7 $x5968)))
 (=> x_3_F $x6000))))
(assert
 (let (($x5972 (and z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x6003 (= z_3_7_7 $x5972)))
 (=> x_3_G $x6003))))
(assert
 (=> x_3_! (= z_3_7_8 (not z_4_7_8))))
(assert
 (let (($x6012 (= z_3_7_8 z_4_7_5)))
 (=> x_3_X $x6012)))
(assert
 (let (($x5968 (or z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x6015 (= z_3_7_8 $x5968)))
 (=> x_3_F $x6015))))
(assert
 (let (($x5972 (and z_4_7_5 z_4_7_6 z_4_7_7 z_4_7_8)))
 (let (($x6018 (= z_3_7_8 $x5972)))
 (=> x_3_G $x6018))))
(assert
 (=> x_3_! (= z_3_8_0 (not z_4_8_0))))
(assert
 (let (($x6029 (= z_3_8_0 z_4_8_1)))
 (=> x_3_X $x6029)))
(assert
 (let (($x6041 (or z_4_8_0 z_4_8_1 z_4_8_2 z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6042 (= z_3_8_0 $x6041)))
 (=> x_3_F $x6042))))
(assert
 (let (($x6045 (and z_4_8_0 z_4_8_1 z_4_8_2 z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6046 (= z_3_8_0 $x6045)))
 (=> x_3_G $x6046))))
(assert
 (=> x_3_! (= z_3_8_1 (not z_4_8_1))))
(assert
 (let (($x6055 (= z_3_8_1 z_4_8_2)))
 (=> x_3_X $x6055)))
(assert
 (let (($x6058 (or z_4_8_1 z_4_8_2 z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6059 (= z_3_8_1 $x6058)))
 (=> x_3_F $x6059))))
(assert
 (let (($x6062 (and z_4_8_1 z_4_8_2 z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6063 (= z_3_8_1 $x6062)))
 (=> x_3_G $x6063))))
(assert
 (=> x_3_! (= z_3_8_2 (not z_4_8_2))))
(assert
 (let (($x6072 (= z_3_8_2 z_4_8_3)))
 (=> x_3_X $x6072)))
(assert
 (let (($x6075 (or z_4_8_2 z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6076 (= z_3_8_2 $x6075)))
 (=> x_3_F $x6076))))
(assert
 (let (($x6079 (and z_4_8_2 z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6080 (= z_3_8_2 $x6079)))
 (=> x_3_G $x6080))))
(assert
 (=> x_3_! (= z_3_8_3 (not z_4_8_3))))
(assert
 (let (($x6089 (= z_3_8_3 z_4_8_4)))
 (=> x_3_X $x6089)))
(assert
 (let (($x6092 (or z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6093 (= z_3_8_3 $x6092)))
 (=> x_3_F $x6093))))
(assert
 (let (($x6096 (and z_4_8_3 z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6097 (= z_3_8_3 $x6096)))
 (=> x_3_G $x6097))))
(assert
 (=> x_3_! (= z_3_8_4 (not z_4_8_4))))
(assert
 (let (($x6106 (= z_3_8_4 z_4_8_5)))
 (=> x_3_X $x6106)))
(assert
 (let (($x6109 (or z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6110 (= z_3_8_4 $x6109)))
 (=> x_3_F $x6110))))
(assert
 (let (($x6113 (and z_4_8_4 z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6114 (= z_3_8_4 $x6113)))
 (=> x_3_G $x6114))))
(assert
 (=> x_3_! (= z_3_8_5 (not z_4_8_5))))
(assert
 (let (($x6123 (= z_3_8_5 z_4_8_6)))
 (=> x_3_X $x6123)))
(assert
 (let (($x6126 (or z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6127 (= z_3_8_5 $x6126)))
 (=> x_3_F $x6127))))
(assert
 (let (($x6130 (and z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6131 (= z_3_8_5 $x6130)))
 (=> x_3_G $x6131))))
(assert
 (=> x_3_! (= z_3_8_6 (not z_4_8_6))))
(assert
 (let (($x6140 (= z_3_8_6 z_4_8_7)))
 (=> x_3_X $x6140)))
(assert
 (let (($x6126 (or z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6143 (= z_3_8_6 $x6126)))
 (=> x_3_F $x6143))))
(assert
 (let (($x6130 (and z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6146 (= z_3_8_6 $x6130)))
 (=> x_3_G $x6146))))
(assert
 (=> x_3_! (= z_3_8_7 (not z_4_8_7))))
(assert
 (let (($x6155 (= z_3_8_7 z_4_8_8)))
 (=> x_3_X $x6155)))
(assert
 (let (($x6126 (or z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6158 (= z_3_8_7 $x6126)))
 (=> x_3_F $x6158))))
(assert
 (let (($x6130 (and z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6161 (= z_3_8_7 $x6130)))
 (=> x_3_G $x6161))))
(assert
 (=> x_3_! (= z_3_8_8 (not z_4_8_8))))
(assert
 (let (($x6170 (= z_3_8_8 z_4_8_9)))
 (=> x_3_X $x6170)))
(assert
 (let (($x6126 (or z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6173 (= z_3_8_8 $x6126)))
 (=> x_3_F $x6173))))
(assert
 (let (($x6130 (and z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6176 (= z_3_8_8 $x6130)))
 (=> x_3_G $x6176))))
(assert
 (=> x_3_! (= z_3_8_9 (not z_4_8_9))))
(assert
 (let (($x6185 (= z_3_8_9 z_4_8_10)))
 (=> x_3_X $x6185)))
(assert
 (let (($x6126 (or z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6188 (= z_3_8_9 $x6126)))
 (=> x_3_F $x6188))))
(assert
 (let (($x6130 (and z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6191 (= z_3_8_9 $x6130)))
 (=> x_3_G $x6191))))
(assert
 (=> x_3_! (= z_3_8_10 (not z_4_8_10))))
(assert
 (let (($x6200 (= z_3_8_10 z_4_8_5)))
 (=> x_3_X $x6200)))
(assert
 (let (($x6126 (or z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6203 (= z_3_8_10 $x6126)))
 (=> x_3_F $x6203))))
(assert
 (let (($x6130 (and z_4_8_5 z_4_8_6 z_4_8_7 z_4_8_8 z_4_8_9 z_4_8_10)))
 (let (($x6206 (= z_3_8_10 $x6130)))
 (=> x_3_G $x6206))))
(assert
 (=> x_3_! (= z_3_9_0 (not z_4_9_0))))
(assert
 (let (($x6217 (= z_3_9_0 z_4_9_1)))
 (=> x_3_X $x6217)))
(assert
 (let (($x6228 (or z_4_9_0 z_4_9_1 z_4_9_2 z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6229 (= z_3_9_0 $x6228)))
 (=> x_3_F $x6229))))
(assert
 (let (($x6232 (and z_4_9_0 z_4_9_1 z_4_9_2 z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6233 (= z_3_9_0 $x6232)))
 (=> x_3_G $x6233))))
(assert
 (=> x_3_! (= z_3_9_1 (not z_4_9_1))))
(assert
 (let (($x6242 (= z_3_9_1 z_4_9_2)))
 (=> x_3_X $x6242)))
(assert
 (let (($x6245 (or z_4_9_1 z_4_9_2 z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6246 (= z_3_9_1 $x6245)))
 (=> x_3_F $x6246))))
(assert
 (let (($x6249 (and z_4_9_1 z_4_9_2 z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6250 (= z_3_9_1 $x6249)))
 (=> x_3_G $x6250))))
(assert
 (=> x_3_! (= z_3_9_2 (not z_4_9_2))))
(assert
 (let (($x6259 (= z_3_9_2 z_4_9_3)))
 (=> x_3_X $x6259)))
(assert
 (let (($x6262 (or z_4_9_2 z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6263 (= z_3_9_2 $x6262)))
 (=> x_3_F $x6263))))
(assert
 (let (($x6266 (and z_4_9_2 z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6267 (= z_3_9_2 $x6266)))
 (=> x_3_G $x6267))))
(assert
 (=> x_3_! (= z_3_9_3 (not z_4_9_3))))
(assert
 (let (($x6276 (= z_3_9_3 z_4_9_4)))
 (=> x_3_X $x6276)))
(assert
 (let (($x6279 (or z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6280 (= z_3_9_3 $x6279)))
 (=> x_3_F $x6280))))
(assert
 (let (($x6283 (and z_4_9_3 z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6284 (= z_3_9_3 $x6283)))
 (=> x_3_G $x6284))))
(assert
 (=> x_3_! (= z_3_9_4 (not z_4_9_4))))
(assert
 (let (($x6293 (= z_3_9_4 z_4_9_5)))
 (=> x_3_X $x6293)))
(assert
 (let (($x6296 (or z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6297 (= z_3_9_4 $x6296)))
 (=> x_3_F $x6297))))
(assert
 (let (($x6300 (and z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6301 (= z_3_9_4 $x6300)))
 (=> x_3_G $x6301))))
(assert
 (=> x_3_! (= z_3_9_5 (not z_4_9_5))))
(assert
 (let (($x6310 (= z_3_9_5 z_4_9_6)))
 (=> x_3_X $x6310)))
(assert
 (let (($x6296 (or z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6313 (= z_3_9_5 $x6296)))
 (=> x_3_F $x6313))))
(assert
 (let (($x6300 (and z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6316 (= z_3_9_5 $x6300)))
 (=> x_3_G $x6316))))
(assert
 (=> x_3_! (= z_3_9_6 (not z_4_9_6))))
(assert
 (let (($x6325 (= z_3_9_6 z_4_9_7)))
 (=> x_3_X $x6325)))
(assert
 (let (($x6296 (or z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6328 (= z_3_9_6 $x6296)))
 (=> x_3_F $x6328))))
(assert
 (let (($x6300 (and z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6331 (= z_3_9_6 $x6300)))
 (=> x_3_G $x6331))))
(assert
 (=> x_3_! (= z_3_9_7 (not z_4_9_7))))
(assert
 (let (($x6340 (= z_3_9_7 z_4_9_8)))
 (=> x_3_X $x6340)))
(assert
 (let (($x6296 (or z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6343 (= z_3_9_7 $x6296)))
 (=> x_3_F $x6343))))
(assert
 (let (($x6300 (and z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6346 (= z_3_9_7 $x6300)))
 (=> x_3_G $x6346))))
(assert
 (=> x_3_! (= z_3_9_8 (not z_4_9_8))))
(assert
 (let (($x6355 (= z_3_9_8 z_4_9_9)))
 (=> x_3_X $x6355)))
(assert
 (let (($x6296 (or z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6358 (= z_3_9_8 $x6296)))
 (=> x_3_F $x6358))))
(assert
 (let (($x6300 (and z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6361 (= z_3_9_8 $x6300)))
 (=> x_3_G $x6361))))
(assert
 (=> x_3_! (= z_3_9_9 (not z_4_9_9))))
(assert
 (let (($x6370 (= z_3_9_9 z_4_9_4)))
 (=> x_3_X $x6370)))
(assert
 (let (($x6296 (or z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6373 (= z_3_9_9 $x6296)))
 (=> x_3_F $x6373))))
(assert
 (let (($x6300 (and z_4_9_4 z_4_9_5 z_4_9_6 z_4_9_7 z_4_9_8 z_4_9_9)))
 (let (($x6376 (= z_3_9_9 $x6300)))
 (=> x_3_G $x6376))))
(assert
 (=> x_3_! (= z_3_10_0 (not z_4_10_0))))
(assert
 (let (($x6387 (= z_3_10_0 z_4_10_1)))
 (=> x_3_X $x6387)))
(assert
 (let (($x6397 (or z_4_10_0 z_4_10_1 z_4_10_2 z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6398 (= z_3_10_0 $x6397)))
 (=> x_3_F $x6398))))
(assert
 (let (($x6401 (and z_4_10_0 z_4_10_1 z_4_10_2 z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6402 (= z_3_10_0 $x6401)))
 (=> x_3_G $x6402))))
(assert
 (=> x_3_! (= z_3_10_1 (not z_4_10_1))))
(assert
 (let (($x6411 (= z_3_10_1 z_4_10_2)))
 (=> x_3_X $x6411)))
(assert
 (let (($x6414 (or z_4_10_1 z_4_10_2 z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6415 (= z_3_10_1 $x6414)))
 (=> x_3_F $x6415))))
(assert
 (let (($x6418 (and z_4_10_1 z_4_10_2 z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6419 (= z_3_10_1 $x6418)))
 (=> x_3_G $x6419))))
(assert
 (=> x_3_! (= z_3_10_2 (not z_4_10_2))))
(assert
 (let (($x6428 (= z_3_10_2 z_4_10_3)))
 (=> x_3_X $x6428)))
(assert
 (let (($x6431 (or z_4_10_2 z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6432 (= z_3_10_2 $x6431)))
 (=> x_3_F $x6432))))
(assert
 (let (($x6435 (and z_4_10_2 z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6436 (= z_3_10_2 $x6435)))
 (=> x_3_G $x6436))))
(assert
 (=> x_3_! (= z_3_10_3 (not z_4_10_3))))
(assert
 (let (($x6445 (= z_3_10_3 z_4_10_4)))
 (=> x_3_X $x6445)))
(assert
 (let (($x6449 (= z_3_10_3 (or z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8))))
 (=> x_3_F $x6449)))
(assert
 (let (($x6453 (= z_3_10_3 (and z_4_10_3 z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8))))
 (=> x_3_G $x6453)))
(assert
 (=> x_3_! (= z_3_10_4 (not z_4_10_4))))
(assert
 (let (($x6462 (= z_3_10_4 z_4_10_5)))
 (=> x_3_X $x6462)))
(assert
 (let (($x6465 (or z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6466 (= z_3_10_4 $x6465)))
 (=> x_3_F $x6466))))
(assert
 (let (($x6469 (and z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6470 (= z_3_10_4 $x6469)))
 (=> x_3_G $x6470))))
(assert
 (=> x_3_! (= z_3_10_5 (not z_4_10_5))))
(assert
 (let (($x6479 (= z_3_10_5 z_4_10_6)))
 (=> x_3_X $x6479)))
(assert
 (let (($x6465 (or z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6482 (= z_3_10_5 $x6465)))
 (=> x_3_F $x6482))))
(assert
 (let (($x6469 (and z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6485 (= z_3_10_5 $x6469)))
 (=> x_3_G $x6485))))
(assert
 (=> x_3_! (= z_3_10_6 (not z_4_10_6))))
(assert
 (let (($x6494 (= z_3_10_6 z_4_10_7)))
 (=> x_3_X $x6494)))
(assert
 (let (($x6465 (or z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6497 (= z_3_10_6 $x6465)))
 (=> x_3_F $x6497))))
(assert
 (let (($x6469 (and z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6500 (= z_3_10_6 $x6469)))
 (=> x_3_G $x6500))))
(assert
 (=> x_3_! (= z_3_10_7 (not z_4_10_7))))
(assert
 (let (($x6509 (= z_3_10_7 z_4_10_8)))
 (=> x_3_X $x6509)))
(assert
 (let (($x6465 (or z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6512 (= z_3_10_7 $x6465)))
 (=> x_3_F $x6512))))
(assert
 (let (($x6469 (and z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6515 (= z_3_10_7 $x6469)))
 (=> x_3_G $x6515))))
(assert
 (=> x_3_! (= z_3_10_8 (not z_4_10_8))))
(assert
 (let (($x6524 (= z_3_10_8 z_4_10_4)))
 (=> x_3_X $x6524)))
(assert
 (let (($x6465 (or z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6527 (= z_3_10_8 $x6465)))
 (=> x_3_F $x6527))))
(assert
 (let (($x6469 (and z_4_10_4 z_4_10_5 z_4_10_6 z_4_10_7 z_4_10_8)))
 (let (($x6530 (= z_3_10_8 $x6469)))
 (=> x_3_G $x6530))))
(assert
 (=> x_3_! (= z_3_11_0 (not z_4_11_0))))
(assert
 (let (($x6541 (= z_3_11_0 z_4_11_1)))
 (=> x_3_X $x6541)))
(assert
 (let (($x6553 (or z_4_11_0 z_4_11_1 z_4_11_2 z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6554 (= z_3_11_0 $x6553)))
 (=> x_3_F $x6554))))
(assert
 (let (($x6557 (and z_4_11_0 z_4_11_1 z_4_11_2 z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6558 (= z_3_11_0 $x6557)))
 (=> x_3_G $x6558))))
(assert
 (=> x_3_! (= z_3_11_1 (not z_4_11_1))))
(assert
 (let (($x6567 (= z_3_11_1 z_4_11_2)))
 (=> x_3_X $x6567)))
(assert
 (let (($x6570 (or z_4_11_1 z_4_11_2 z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6571 (= z_3_11_1 $x6570)))
 (=> x_3_F $x6571))))
(assert
 (let (($x6574 (and z_4_11_1 z_4_11_2 z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6575 (= z_3_11_1 $x6574)))
 (=> x_3_G $x6575))))
(assert
 (=> x_3_! (= z_3_11_2 (not z_4_11_2))))
(assert
 (let (($x6584 (= z_3_11_2 z_4_11_3)))
 (=> x_3_X $x6584)))
(assert
 (let (($x6587 (or z_4_11_2 z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6588 (= z_3_11_2 $x6587)))
 (=> x_3_F $x6588))))
(assert
 (let (($x6591 (and z_4_11_2 z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6592 (= z_3_11_2 $x6591)))
 (=> x_3_G $x6592))))
(assert
 (=> x_3_! (= z_3_11_3 (not z_4_11_3))))
(assert
 (let (($x6601 (= z_3_11_3 z_4_11_4)))
 (=> x_3_X $x6601)))
(assert
 (let (($x6604 (or z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6605 (= z_3_11_3 $x6604)))
 (=> x_3_F $x6605))))
(assert
 (let (($x6608 (and z_4_11_3 z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6609 (= z_3_11_3 $x6608)))
 (=> x_3_G $x6609))))
(assert
 (=> x_3_! (= z_3_11_4 (not z_4_11_4))))
(assert
 (let (($x6618 (= z_3_11_4 z_4_11_5)))
 (=> x_3_X $x6618)))
(assert
 (let (($x6621 (or z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6622 (= z_3_11_4 $x6621)))
 (=> x_3_F $x6622))))
(assert
 (let (($x6625 (and z_4_11_4 z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6626 (= z_3_11_4 $x6625)))
 (=> x_3_G $x6626))))
(assert
 (=> x_3_! (= z_3_11_5 (not z_4_11_5))))
(assert
 (let (($x6635 (= z_3_11_5 z_4_11_6)))
 (=> x_3_X $x6635)))
(assert
 (let (($x6638 (or z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6639 (= z_3_11_5 $x6638)))
 (=> x_3_F $x6639))))
(assert
 (let (($x6642 (and z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6643 (= z_3_11_5 $x6642)))
 (=> x_3_G $x6643))))
(assert
 (=> x_3_! (= z_3_11_6 (not z_4_11_6))))
(assert
 (let (($x6652 (= z_3_11_6 z_4_11_7)))
 (=> x_3_X $x6652)))
(assert
 (let (($x6638 (or z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6655 (= z_3_11_6 $x6638)))
 (=> x_3_F $x6655))))
(assert
 (let (($x6642 (and z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6658 (= z_3_11_6 $x6642)))
 (=> x_3_G $x6658))))
(assert
 (=> x_3_! (= z_3_11_7 (not z_4_11_7))))
(assert
 (let (($x6667 (= z_3_11_7 z_4_11_8)))
 (=> x_3_X $x6667)))
(assert
 (let (($x6638 (or z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6670 (= z_3_11_7 $x6638)))
 (=> x_3_F $x6670))))
(assert
 (let (($x6642 (and z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6673 (= z_3_11_7 $x6642)))
 (=> x_3_G $x6673))))
(assert
 (=> x_3_! (= z_3_11_8 (not z_4_11_8))))
(assert
 (let (($x6682 (= z_3_11_8 z_4_11_9)))
 (=> x_3_X $x6682)))
(assert
 (let (($x6638 (or z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6685 (= z_3_11_8 $x6638)))
 (=> x_3_F $x6685))))
(assert
 (let (($x6642 (and z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6688 (= z_3_11_8 $x6642)))
 (=> x_3_G $x6688))))
(assert
 (=> x_3_! (= z_3_11_9 (not z_4_11_9))))
(assert
 (let (($x6697 (= z_3_11_9 z_4_11_10)))
 (=> x_3_X $x6697)))
(assert
 (let (($x6638 (or z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6700 (= z_3_11_9 $x6638)))
 (=> x_3_F $x6700))))
(assert
 (let (($x6642 (and z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6703 (= z_3_11_9 $x6642)))
 (=> x_3_G $x6703))))
(assert
 (=> x_3_! (= z_3_11_10 (not z_4_11_10))))
(assert
 (let (($x6712 (= z_3_11_10 z_4_11_5)))
 (=> x_3_X $x6712)))
(assert
 (let (($x6638 (or z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6715 (= z_3_11_10 $x6638)))
 (=> x_3_F $x6715))))
(assert
 (let (($x6642 (and z_4_11_5 z_4_11_6 z_4_11_7 z_4_11_8 z_4_11_9 z_4_11_10)))
 (let (($x6718 (= z_3_11_10 $x6642)))
 (=> x_3_G $x6718))))
(assert
 (=> x_3_! (= z_3_12_0 (not z_4_12_0))))
(assert
 (let (($x6729 (= z_3_12_0 z_4_12_1)))
 (=> x_3_X $x6729)))
(assert
 (let (($x6741 (or z_4_12_0 z_4_12_1 z_4_12_2 z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6742 (= z_3_12_0 $x6741)))
 (=> x_3_F $x6742))))
(assert
 (let (($x6745 (and z_4_12_0 z_4_12_1 z_4_12_2 z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6746 (= z_3_12_0 $x6745)))
 (=> x_3_G $x6746))))
(assert
 (=> x_3_! (= z_3_12_1 (not z_4_12_1))))
(assert
 (let (($x6755 (= z_3_12_1 z_4_12_2)))
 (=> x_3_X $x6755)))
(assert
 (let (($x6758 (or z_4_12_1 z_4_12_2 z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6759 (= z_3_12_1 $x6758)))
 (=> x_3_F $x6759))))
(assert
 (let (($x6762 (and z_4_12_1 z_4_12_2 z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6763 (= z_3_12_1 $x6762)))
 (=> x_3_G $x6763))))
(assert
 (=> x_3_! (= z_3_12_2 (not z_4_12_2))))
(assert
 (let (($x6772 (= z_3_12_2 z_4_12_3)))
 (=> x_3_X $x6772)))
(assert
 (let (($x6775 (or z_4_12_2 z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6776 (= z_3_12_2 $x6775)))
 (=> x_3_F $x6776))))
(assert
 (let (($x6779 (and z_4_12_2 z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6780 (= z_3_12_2 $x6779)))
 (=> x_3_G $x6780))))
(assert
 (=> x_3_! (= z_3_12_3 (not z_4_12_3))))
(assert
 (let (($x6789 (= z_3_12_3 z_4_12_4)))
 (=> x_3_X $x6789)))
(assert
 (let (($x6792 (or z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6793 (= z_3_12_3 $x6792)))
 (=> x_3_F $x6793))))
(assert
 (let (($x6796 (and z_4_12_3 z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6797 (= z_3_12_3 $x6796)))
 (=> x_3_G $x6797))))
(assert
 (=> x_3_! (= z_3_12_4 (not z_4_12_4))))
(assert
 (let (($x6806 (= z_3_12_4 z_4_12_5)))
 (=> x_3_X $x6806)))
(assert
 (let (($x6809 (or z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6810 (= z_3_12_4 $x6809)))
 (=> x_3_F $x6810))))
(assert
 (let (($x6813 (and z_4_12_4 z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6814 (= z_3_12_4 $x6813)))
 (=> x_3_G $x6814))))
(assert
 (=> x_3_! (= z_3_12_5 (not z_4_12_5))))
(assert
 (let (($x6823 (= z_3_12_5 z_4_12_6)))
 (=> x_3_X $x6823)))
(assert
 (let (($x6826 (or z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6827 (= z_3_12_5 $x6826)))
 (=> x_3_F $x6827))))
(assert
 (let (($x6830 (and z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6831 (= z_3_12_5 $x6830)))
 (=> x_3_G $x6831))))
(assert
 (=> x_3_! (= z_3_12_6 (not z_4_12_6))))
(assert
 (let (($x6840 (= z_3_12_6 z_4_12_7)))
 (=> x_3_X $x6840)))
(assert
 (let (($x6826 (or z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6843 (= z_3_12_6 $x6826)))
 (=> x_3_F $x6843))))
(assert
 (let (($x6830 (and z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6846 (= z_3_12_6 $x6830)))
 (=> x_3_G $x6846))))
(assert
 (=> x_3_! (= z_3_12_7 (not z_4_12_7))))
(assert
 (let (($x6855 (= z_3_12_7 z_4_12_8)))
 (=> x_3_X $x6855)))
(assert
 (let (($x6826 (or z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6858 (= z_3_12_7 $x6826)))
 (=> x_3_F $x6858))))
(assert
 (let (($x6830 (and z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6861 (= z_3_12_7 $x6830)))
 (=> x_3_G $x6861))))
(assert
 (=> x_3_! (= z_3_12_8 (not z_4_12_8))))
(assert
 (let (($x6870 (= z_3_12_8 z_4_12_9)))
 (=> x_3_X $x6870)))
(assert
 (let (($x6826 (or z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6873 (= z_3_12_8 $x6826)))
 (=> x_3_F $x6873))))
(assert
 (let (($x6830 (and z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6876 (= z_3_12_8 $x6830)))
 (=> x_3_G $x6876))))
(assert
 (=> x_3_! (= z_3_12_9 (not z_4_12_9))))
(assert
 (let (($x6885 (= z_3_12_9 z_4_12_10)))
 (=> x_3_X $x6885)))
(assert
 (let (($x6826 (or z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6888 (= z_3_12_9 $x6826)))
 (=> x_3_F $x6888))))
(assert
 (let (($x6830 (and z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6891 (= z_3_12_9 $x6830)))
 (=> x_3_G $x6891))))
(assert
 (=> x_3_! (= z_3_12_10 (not z_4_12_10))))
(assert
 (let (($x6900 (= z_3_12_10 z_4_12_5)))
 (=> x_3_X $x6900)))
(assert
 (let (($x6826 (or z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6903 (= z_3_12_10 $x6826)))
 (=> x_3_F $x6903))))
(assert
 (let (($x6830 (and z_4_12_5 z_4_12_6 z_4_12_7 z_4_12_8 z_4_12_9 z_4_12_10)))
 (let (($x6906 (= z_3_12_10 $x6830)))
 (=> x_3_G $x6906))))
(assert
 (=> x_3_! (= z_3_13_0 (not z_4_13_0))))
(assert
 (let (($x6917 (= z_3_13_0 z_4_13_1)))
 (=> x_3_X $x6917)))
(assert
 (let (($x6926 (or z_4_13_0 z_4_13_1 z_4_13_2 z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x6927 (= z_3_13_0 $x6926)))
 (=> x_3_F $x6927))))
(assert
 (let (($x6930 (and z_4_13_0 z_4_13_1 z_4_13_2 z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x6931 (= z_3_13_0 $x6930)))
 (=> x_3_G $x6931))))
(assert
 (=> x_3_! (= z_3_13_1 (not z_4_13_1))))
(assert
 (let (($x6940 (= z_3_13_1 z_4_13_2)))
 (=> x_3_X $x6940)))
(assert
 (let (($x6943 (or z_4_13_1 z_4_13_2 z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x6944 (= z_3_13_1 $x6943)))
 (=> x_3_F $x6944))))
(assert
 (let (($x6947 (and z_4_13_1 z_4_13_2 z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x6948 (= z_3_13_1 $x6947)))
 (=> x_3_G $x6948))))
(assert
 (=> x_3_! (= z_3_13_2 (not z_4_13_2))))
(assert
 (let (($x6957 (= z_3_13_2 z_4_13_3)))
 (=> x_3_X $x6957)))
(assert
 (let (($x6961 (= z_3_13_2 (or z_4_13_2 z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7))))
 (=> x_3_F $x6961)))
(assert
 (let (($x6965 (= z_3_13_2 (and z_4_13_2 z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7))))
 (=> x_3_G $x6965)))
(assert
 (=> x_3_! (= z_3_13_3 (not z_4_13_3))))
(assert
 (let (($x6974 (= z_3_13_3 z_4_13_4)))
 (=> x_3_X $x6974)))
(assert
 (let (($x6978 (= z_3_13_3 (or z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7))))
 (=> x_3_F $x6978)))
(assert
 (let (($x6982 (= z_3_13_3 (and z_4_13_3 z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7))))
 (=> x_3_G $x6982)))
(assert
 (=> x_3_! (= z_3_13_4 (not z_4_13_4))))
(assert
 (let (($x6991 (= z_3_13_4 z_4_13_5)))
 (=> x_3_X $x6991)))
(assert
 (let (($x6994 (or z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x6995 (= z_3_13_4 $x6994)))
 (=> x_3_F $x6995))))
(assert
 (let (($x6998 (and z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x6999 (= z_3_13_4 $x6998)))
 (=> x_3_G $x6999))))
(assert
 (=> x_3_! (= z_3_13_5 (not z_4_13_5))))
(assert
 (let (($x7008 (= z_3_13_5 z_4_13_6)))
 (=> x_3_X $x7008)))
(assert
 (let (($x6994 (or z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x7011 (= z_3_13_5 $x6994)))
 (=> x_3_F $x7011))))
(assert
 (let (($x6998 (and z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x7014 (= z_3_13_5 $x6998)))
 (=> x_3_G $x7014))))
(assert
 (=> x_3_! (= z_3_13_6 (not z_4_13_6))))
(assert
 (let (($x7023 (= z_3_13_6 z_4_13_7)))
 (=> x_3_X $x7023)))
(assert
 (let (($x6994 (or z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x7026 (= z_3_13_6 $x6994)))
 (=> x_3_F $x7026))))
(assert
 (let (($x6998 (and z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x7029 (= z_3_13_6 $x6998)))
 (=> x_3_G $x7029))))
(assert
 (=> x_3_! (= z_3_13_7 (not z_4_13_7))))
(assert
 (let (($x7038 (= z_3_13_7 z_4_13_4)))
 (=> x_3_X $x7038)))
(assert
 (let (($x6994 (or z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x7041 (= z_3_13_7 $x6994)))
 (=> x_3_F $x7041))))
(assert
 (let (($x6998 (and z_4_13_4 z_4_13_5 z_4_13_6 z_4_13_7)))
 (let (($x7044 (= z_3_13_7 $x6998)))
 (=> x_3_G $x7044))))
(assert
 (=> x_3_! (= z_3_14_0 (not z_4_14_0))))
(assert
 (let (($x7055 (= z_3_14_0 z_4_14_1)))
 (=> x_3_X $x7055)))
(assert
 (let (($x7063 (= z_3_14_0 (or z_4_14_0 z_4_14_1 z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5))))
 (=> x_3_F $x7063)))
(assert
 (let (($x7067 (= z_3_14_0 (and z_4_14_0 z_4_14_1 z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5))))
 (=> x_3_G $x7067)))
(assert
 (=> x_3_! (= z_3_14_1 (not z_4_14_1))))
(assert
 (let (($x7076 (= z_3_14_1 z_4_14_2)))
 (=> x_3_X $x7076)))
(assert
 (let (($x7080 (= z_3_14_1 (or z_4_14_1 z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5))))
 (=> x_3_F $x7080)))
(assert
 (let (($x7084 (= z_3_14_1 (and z_4_14_1 z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5))))
 (=> x_3_G $x7084)))
(assert
 (=> x_3_! (= z_3_14_2 (not z_4_14_2))))
(assert
 (let (($x7093 (= z_3_14_2 z_4_14_3)))
 (=> x_3_X $x7093)))
(assert
 (let (($x7096 (or z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7097 (= z_3_14_2 $x7096)))
 (=> x_3_F $x7097))))
(assert
 (let (($x7100 (and z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7101 (= z_3_14_2 $x7100)))
 (=> x_3_G $x7101))))
(assert
 (=> x_3_! (= z_3_14_3 (not z_4_14_3))))
(assert
 (let (($x7110 (= z_3_14_3 z_4_14_4)))
 (=> x_3_X $x7110)))
(assert
 (let (($x7096 (or z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7113 (= z_3_14_3 $x7096)))
 (=> x_3_F $x7113))))
(assert
 (let (($x7100 (and z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7116 (= z_3_14_3 $x7100)))
 (=> x_3_G $x7116))))
(assert
 (=> x_3_! (= z_3_14_4 (not z_4_14_4))))
(assert
 (let (($x7125 (= z_3_14_4 z_4_14_5)))
 (=> x_3_X $x7125)))
(assert
 (let (($x7096 (or z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7128 (= z_3_14_4 $x7096)))
 (=> x_3_F $x7128))))
(assert
 (let (($x7100 (and z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7131 (= z_3_14_4 $x7100)))
 (=> x_3_G $x7131))))
(assert
 (=> x_3_! (= z_3_14_5 (not z_4_14_5))))
(assert
 (let (($x7140 (= z_3_14_5 z_4_14_2)))
 (=> x_3_X $x7140)))
(assert
 (let (($x7096 (or z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7143 (= z_3_14_5 $x7096)))
 (=> x_3_F $x7143))))
(assert
 (let (($x7100 (and z_4_14_2 z_4_14_3 z_4_14_4 z_4_14_5)))
 (let (($x7146 (= z_3_14_5 $x7100)))
 (=> x_3_G $x7146))))
(assert
 (=> x_3_! (= z_3_15_0 (not z_4_15_0))))
(assert
 (let (($x7157 (= z_3_15_0 z_4_15_1)))
 (=> x_3_X $x7157)))
(assert
 (let (($x7169 (or z_4_15_0 z_4_15_1 z_4_15_2 z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7170 (= z_3_15_0 $x7169)))
 (=> x_3_F $x7170))))
(assert
 (let (($x7173 (and z_4_15_0 z_4_15_1 z_4_15_2 z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7174 (= z_3_15_0 $x7173)))
 (=> x_3_G $x7174))))
(assert
 (=> x_3_! (= z_3_15_1 (not z_4_15_1))))
(assert
 (let (($x7183 (= z_3_15_1 z_4_15_2)))
 (=> x_3_X $x7183)))
(assert
 (let (($x7186 (or z_4_15_1 z_4_15_2 z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7187 (= z_3_15_1 $x7186)))
 (=> x_3_F $x7187))))
(assert
 (let (($x7190 (and z_4_15_1 z_4_15_2 z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7191 (= z_3_15_1 $x7190)))
 (=> x_3_G $x7191))))
(assert
 (=> x_3_! (= z_3_15_2 (not z_4_15_2))))
(assert
 (let (($x7200 (= z_3_15_2 z_4_15_3)))
 (=> x_3_X $x7200)))
(assert
 (let (($x7203 (or z_4_15_2 z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7204 (= z_3_15_2 $x7203)))
 (=> x_3_F $x7204))))
(assert
 (let (($x7207 (and z_4_15_2 z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7208 (= z_3_15_2 $x7207)))
 (=> x_3_G $x7208))))
(assert
 (=> x_3_! (= z_3_15_3 (not z_4_15_3))))
(assert
 (let (($x7217 (= z_3_15_3 z_4_15_4)))
 (=> x_3_X $x7217)))
(assert
 (let (($x7220 (or z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7221 (= z_3_15_3 $x7220)))
 (=> x_3_F $x7221))))
(assert
 (let (($x7224 (and z_4_15_3 z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7225 (= z_3_15_3 $x7224)))
 (=> x_3_G $x7225))))
(assert
 (=> x_3_! (= z_3_15_4 (not z_4_15_4))))
(assert
 (let (($x7234 (= z_3_15_4 z_4_15_5)))
 (=> x_3_X $x7234)))
(assert
 (let (($x7237 (or z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7238 (= z_3_15_4 $x7237)))
 (=> x_3_F $x7238))))
(assert
 (let (($x7241 (and z_4_15_4 z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7242 (= z_3_15_4 $x7241)))
 (=> x_3_G $x7242))))
(assert
 (=> x_3_! (= z_3_15_5 (not z_4_15_5))))
(assert
 (let (($x7251 (= z_3_15_5 z_4_15_6)))
 (=> x_3_X $x7251)))
(assert
 (let (($x7254 (or z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7255 (= z_3_15_5 $x7254)))
 (=> x_3_F $x7255))))
(assert
 (let (($x7258 (and z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7259 (= z_3_15_5 $x7258)))
 (=> x_3_G $x7259))))
(assert
 (=> x_3_! (= z_3_15_6 (not z_4_15_6))))
(assert
 (let (($x7268 (= z_3_15_6 z_4_15_7)))
 (=> x_3_X $x7268)))
(assert
 (let (($x7254 (or z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7271 (= z_3_15_6 $x7254)))
 (=> x_3_F $x7271))))
(assert
 (let (($x7258 (and z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7274 (= z_3_15_6 $x7258)))
 (=> x_3_G $x7274))))
(assert
 (=> x_3_! (= z_3_15_7 (not z_4_15_7))))
(assert
 (let (($x7283 (= z_3_15_7 z_4_15_8)))
 (=> x_3_X $x7283)))
(assert
 (let (($x7254 (or z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7286 (= z_3_15_7 $x7254)))
 (=> x_3_F $x7286))))
(assert
 (let (($x7258 (and z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7289 (= z_3_15_7 $x7258)))
 (=> x_3_G $x7289))))
(assert
 (=> x_3_! (= z_3_15_8 (not z_4_15_8))))
(assert
 (let (($x7298 (= z_3_15_8 z_4_15_9)))
 (=> x_3_X $x7298)))
(assert
 (let (($x7254 (or z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7301 (= z_3_15_8 $x7254)))
 (=> x_3_F $x7301))))
(assert
 (let (($x7258 (and z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7304 (= z_3_15_8 $x7258)))
 (=> x_3_G $x7304))))
(assert
 (=> x_3_! (= z_3_15_9 (not z_4_15_9))))
(assert
 (let (($x7313 (= z_3_15_9 z_4_15_10)))
 (=> x_3_X $x7313)))
(assert
 (let (($x7254 (or z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7316 (= z_3_15_9 $x7254)))
 (=> x_3_F $x7316))))
(assert
 (let (($x7258 (and z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7319 (= z_3_15_9 $x7258)))
 (=> x_3_G $x7319))))
(assert
 (=> x_3_! (= z_3_15_10 (not z_4_15_10))))
(assert
 (let (($x7328 (= z_3_15_10 z_4_15_5)))
 (=> x_3_X $x7328)))
(assert
 (let (($x7254 (or z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7331 (= z_3_15_10 $x7254)))
 (=> x_3_F $x7331))))
(assert
 (let (($x7258 (and z_4_15_5 z_4_15_6 z_4_15_7 z_4_15_8 z_4_15_9 z_4_15_10)))
 (let (($x7334 (= z_3_15_10 $x7258)))
 (=> x_3_G $x7334))))
(assert
 (=> x_3_! (= z_3_16_0 (not z_4_16_0))))
(assert
 (let (($x7345 (= z_3_16_0 z_4_16_1)))
 (=> x_3_X $x7345)))
(assert
 (let (($x7356 (or z_4_16_0 z_4_16_1 z_4_16_2 z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7357 (= z_3_16_0 $x7356)))
 (=> x_3_F $x7357))))
(assert
 (let (($x7360 (and z_4_16_0 z_4_16_1 z_4_16_2 z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7361 (= z_3_16_0 $x7360)))
 (=> x_3_G $x7361))))
(assert
 (=> x_3_! (= z_3_16_1 (not z_4_16_1))))
(assert
 (let (($x7370 (= z_3_16_1 z_4_16_2)))
 (=> x_3_X $x7370)))
(assert
 (let (($x7373 (or z_4_16_1 z_4_16_2 z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7374 (= z_3_16_1 $x7373)))
 (=> x_3_F $x7374))))
(assert
 (let (($x7377 (and z_4_16_1 z_4_16_2 z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7378 (= z_3_16_1 $x7377)))
 (=> x_3_G $x7378))))
(assert
 (=> x_3_! (= z_3_16_2 (not z_4_16_2))))
(assert
 (let (($x7387 (= z_3_16_2 z_4_16_3)))
 (=> x_3_X $x7387)))
(assert
 (let (($x7390 (or z_4_16_2 z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7391 (= z_3_16_2 $x7390)))
 (=> x_3_F $x7391))))
(assert
 (let (($x7394 (and z_4_16_2 z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7395 (= z_3_16_2 $x7394)))
 (=> x_3_G $x7395))))
(assert
 (=> x_3_! (= z_3_16_3 (not z_4_16_3))))
(assert
 (let (($x7404 (= z_3_16_3 z_4_16_4)))
 (=> x_3_X $x7404)))
(assert
 (let (($x7407 (or z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7408 (= z_3_16_3 $x7407)))
 (=> x_3_F $x7408))))
(assert
 (let (($x7411 (and z_4_16_3 z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7412 (= z_3_16_3 $x7411)))
 (=> x_3_G $x7412))))
(assert
 (=> x_3_! (= z_3_16_4 (not z_4_16_4))))
(assert
 (let (($x7421 (= z_3_16_4 z_4_16_5)))
 (=> x_3_X $x7421)))
(assert
 (let (($x7424 (or z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7425 (= z_3_16_4 $x7424)))
 (=> x_3_F $x7425))))
(assert
 (let (($x7428 (and z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7429 (= z_3_16_4 $x7428)))
 (=> x_3_G $x7429))))
(assert
 (=> x_3_! (= z_3_16_5 (not z_4_16_5))))
(assert
 (let (($x7438 (= z_3_16_5 z_4_16_6)))
 (=> x_3_X $x7438)))
(assert
 (let (($x7424 (or z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7441 (= z_3_16_5 $x7424)))
 (=> x_3_F $x7441))))
(assert
 (let (($x7428 (and z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7444 (= z_3_16_5 $x7428)))
 (=> x_3_G $x7444))))
(assert
 (=> x_3_! (= z_3_16_6 (not z_4_16_6))))
(assert
 (let (($x7453 (= z_3_16_6 z_4_16_7)))
 (=> x_3_X $x7453)))
(assert
 (let (($x7424 (or z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7456 (= z_3_16_6 $x7424)))
 (=> x_3_F $x7456))))
(assert
 (let (($x7428 (and z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7459 (= z_3_16_6 $x7428)))
 (=> x_3_G $x7459))))
(assert
 (=> x_3_! (= z_3_16_7 (not z_4_16_7))))
(assert
 (let (($x7468 (= z_3_16_7 z_4_16_8)))
 (=> x_3_X $x7468)))
(assert
 (let (($x7424 (or z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7471 (= z_3_16_7 $x7424)))
 (=> x_3_F $x7471))))
(assert
 (let (($x7428 (and z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7474 (= z_3_16_7 $x7428)))
 (=> x_3_G $x7474))))
(assert
 (=> x_3_! (= z_3_16_8 (not z_4_16_8))))
(assert
 (let (($x7483 (= z_3_16_8 z_4_16_9)))
 (=> x_3_X $x7483)))
(assert
 (let (($x7424 (or z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7486 (= z_3_16_8 $x7424)))
 (=> x_3_F $x7486))))
(assert
 (let (($x7428 (and z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7489 (= z_3_16_8 $x7428)))
 (=> x_3_G $x7489))))
(assert
 (=> x_3_! (= z_3_16_9 (not z_4_16_9))))
(assert
 (let (($x7498 (= z_3_16_9 z_4_16_4)))
 (=> x_3_X $x7498)))
(assert
 (let (($x7424 (or z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7501 (= z_3_16_9 $x7424)))
 (=> x_3_F $x7501))))
(assert
 (let (($x7428 (and z_4_16_4 z_4_16_5 z_4_16_6 z_4_16_7 z_4_16_8 z_4_16_9)))
 (let (($x7504 (= z_3_16_9 $x7428)))
 (=> x_3_G $x7504))))
(assert
 (=> x_3_! (= z_3_17_0 (not z_4_17_0))))
(assert
 (let (($x7515 (= z_3_17_0 z_4_17_1)))
 (=> x_3_X $x7515)))
(assert
 (let (($x7528 (or z_4_17_0 z_4_17_1 z_4_17_2 z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7529 (= z_3_17_0 $x7528)))
 (=> x_3_F $x7529))))
(assert
 (let (($x7532 (and z_4_17_0 z_4_17_1 z_4_17_2 z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7533 (= z_3_17_0 $x7532)))
 (=> x_3_G $x7533))))
(assert
 (=> x_3_! (= z_3_17_1 (not z_4_17_1))))
(assert
 (let (($x7542 (= z_3_17_1 z_4_17_2)))
 (=> x_3_X $x7542)))
(assert
 (let (($x7545 (or z_4_17_1 z_4_17_2 z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7546 (= z_3_17_1 $x7545)))
 (=> x_3_F $x7546))))
(assert
 (let (($x7549 (and z_4_17_1 z_4_17_2 z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7550 (= z_3_17_1 $x7549)))
 (=> x_3_G $x7550))))
(assert
 (=> x_3_! (= z_3_17_2 (not z_4_17_2))))
(assert
 (let (($x7559 (= z_3_17_2 z_4_17_3)))
 (=> x_3_X $x7559)))
(assert
 (let (($x7562 (or z_4_17_2 z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7563 (= z_3_17_2 $x7562)))
 (=> x_3_F $x7563))))
(assert
 (let (($x7566 (and z_4_17_2 z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7567 (= z_3_17_2 $x7566)))
 (=> x_3_G $x7567))))
(assert
 (=> x_3_! (= z_3_17_3 (not z_4_17_3))))
(assert
 (let (($x7576 (= z_3_17_3 z_4_17_4)))
 (=> x_3_X $x7576)))
(assert
 (let (($x7579 (or z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7580 (= z_3_17_3 $x7579)))
 (=> x_3_F $x7580))))
(assert
 (let (($x7583 (and z_4_17_3 z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7584 (= z_3_17_3 $x7583)))
 (=> x_3_G $x7584))))
(assert
 (=> x_3_! (= z_3_17_4 (not z_4_17_4))))
(assert
 (let (($x7593 (= z_3_17_4 z_4_17_5)))
 (=> x_3_X $x7593)))
(assert
 (let (($x7596 (or z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7597 (= z_3_17_4 $x7596)))
 (=> x_3_F $x7597))))
(assert
 (let (($x7600 (and z_4_17_4 z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7601 (= z_3_17_4 $x7600)))
 (=> x_3_G $x7601))))
(assert
 (=> x_3_! (= z_3_17_5 (not z_4_17_5))))
(assert
 (let (($x7610 (= z_3_17_5 z_4_17_6)))
 (=> x_3_X $x7610)))
(assert
 (let (($x7613 (or z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7614 (= z_3_17_5 $x7613)))
 (=> x_3_F $x7614))))
(assert
 (let (($x7617 (and z_4_17_5 z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7618 (= z_3_17_5 $x7617)))
 (=> x_3_G $x7618))))
(assert
 (=> x_3_! (= z_3_17_6 (not z_4_17_6))))
(assert
 (let (($x7627 (= z_3_17_6 z_4_17_7)))
 (=> x_3_X $x7627)))
(assert
 (let (($x7630 (or z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7631 (= z_3_17_6 $x7630)))
 (=> x_3_F $x7631))))
(assert
 (let (($x7634 (and z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7635 (= z_3_17_6 $x7634)))
 (=> x_3_G $x7635))))
(assert
 (=> x_3_! (= z_3_17_7 (not z_4_17_7))))
(assert
 (let (($x7644 (= z_3_17_7 z_4_17_8)))
 (=> x_3_X $x7644)))
(assert
 (let (($x7630 (or z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7647 (= z_3_17_7 $x7630)))
 (=> x_3_F $x7647))))
(assert
 (let (($x7634 (and z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7650 (= z_3_17_7 $x7634)))
 (=> x_3_G $x7650))))
(assert
 (=> x_3_! (= z_3_17_8 (not z_4_17_8))))
(assert
 (let (($x7659 (= z_3_17_8 z_4_17_9)))
 (=> x_3_X $x7659)))
(assert
 (let (($x7630 (or z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7662 (= z_3_17_8 $x7630)))
 (=> x_3_F $x7662))))
(assert
 (let (($x7634 (and z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7665 (= z_3_17_8 $x7634)))
 (=> x_3_G $x7665))))
(assert
 (=> x_3_! (= z_3_17_9 (not z_4_17_9))))
(assert
 (let (($x7674 (= z_3_17_9 z_4_17_10)))
 (=> x_3_X $x7674)))
(assert
 (let (($x7630 (or z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7677 (= z_3_17_9 $x7630)))
 (=> x_3_F $x7677))))
(assert
 (let (($x7634 (and z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7680 (= z_3_17_9 $x7634)))
 (=> x_3_G $x7680))))
(assert
 (=> x_3_! (= z_3_17_10 (not z_4_17_10))))
(assert
 (let (($x7689 (= z_3_17_10 z_4_17_11)))
 (=> x_3_X $x7689)))
(assert
 (let (($x7630 (or z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7692 (= z_3_17_10 $x7630)))
 (=> x_3_F $x7692))))
(assert
 (let (($x7634 (and z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7695 (= z_3_17_10 $x7634)))
 (=> x_3_G $x7695))))
(assert
 (=> x_3_! (= z_3_17_11 (not z_4_17_11))))
(assert
 (let (($x7704 (= z_3_17_11 z_4_17_6)))
 (=> x_3_X $x7704)))
(assert
 (let (($x7630 (or z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7707 (= z_3_17_11 $x7630)))
 (=> x_3_F $x7707))))
(assert
 (let (($x7634 (and z_4_17_6 z_4_17_7 z_4_17_8 z_4_17_9 z_4_17_10 z_4_17_11)))
 (let (($x7710 (= z_3_17_11 $x7634)))
 (=> x_3_G $x7710))))
(assert
 (=> x_3_! (= z_3_18_0 (not z_4_18_0))))
(assert
 (let (($x7721 (= z_3_18_0 z_4_18_1)))
 (=> x_3_X $x7721)))
(assert
 (let (($x7732 (or z_4_18_0 z_4_18_1 z_4_18_2 z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7733 (= z_3_18_0 $x7732)))
 (=> x_3_F $x7733))))
(assert
 (let (($x7736 (and z_4_18_0 z_4_18_1 z_4_18_2 z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7737 (= z_3_18_0 $x7736)))
 (=> x_3_G $x7737))))
(assert
 (=> x_3_! (= z_3_18_1 (not z_4_18_1))))
(assert
 (let (($x7746 (= z_3_18_1 z_4_18_2)))
 (=> x_3_X $x7746)))
(assert
 (let (($x7749 (or z_4_18_1 z_4_18_2 z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7750 (= z_3_18_1 $x7749)))
 (=> x_3_F $x7750))))
(assert
 (let (($x7753 (and z_4_18_1 z_4_18_2 z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7754 (= z_3_18_1 $x7753)))
 (=> x_3_G $x7754))))
(assert
 (=> x_3_! (= z_3_18_2 (not z_4_18_2))))
(assert
 (let (($x7763 (= z_3_18_2 z_4_18_3)))
 (=> x_3_X $x7763)))
(assert
 (let (($x7766 (or z_4_18_2 z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7767 (= z_3_18_2 $x7766)))
 (=> x_3_F $x7767))))
(assert
 (let (($x7770 (and z_4_18_2 z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7771 (= z_3_18_2 $x7770)))
 (=> x_3_G $x7771))))
(assert
 (=> x_3_! (= z_3_18_3 (not z_4_18_3))))
(assert
 (let (($x7780 (= z_3_18_3 z_4_18_4)))
 (=> x_3_X $x7780)))
(assert
 (let (($x7783 (or z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7784 (= z_3_18_3 $x7783)))
 (=> x_3_F $x7784))))
(assert
 (let (($x7787 (and z_4_18_3 z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7788 (= z_3_18_3 $x7787)))
 (=> x_3_G $x7788))))
(assert
 (=> x_3_! (= z_3_18_4 (not z_4_18_4))))
(assert
 (let (($x7797 (= z_3_18_4 z_4_18_5)))
 (=> x_3_X $x7797)))
(assert
 (let (($x7801 (= z_3_18_4 (or z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9))))
 (=> x_3_F $x7801)))
(assert
 (let (($x7805 (= z_3_18_4 (and z_4_18_4 z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9))))
 (=> x_3_G $x7805)))
(assert
 (=> x_3_! (= z_3_18_5 (not z_4_18_5))))
(assert
 (let (($x7814 (= z_3_18_5 z_4_18_6)))
 (=> x_3_X $x7814)))
(assert
 (let (($x7818 (= z_3_18_5 (or z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9))))
 (=> x_3_F $x7818)))
(assert
 (let (($x7822 (= z_3_18_5 (and z_4_18_5 z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9))))
 (=> x_3_G $x7822)))
(assert
 (=> x_3_! (= z_3_18_6 (not z_4_18_6))))
(assert
 (let (($x7831 (= z_3_18_6 z_4_18_7)))
 (=> x_3_X $x7831)))
(assert
 (let (($x7834 (or z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7835 (= z_3_18_6 $x7834)))
 (=> x_3_F $x7835))))
(assert
 (let (($x7838 (and z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7839 (= z_3_18_6 $x7838)))
 (=> x_3_G $x7839))))
(assert
 (=> x_3_! (= z_3_18_7 (not z_4_18_7))))
(assert
 (let (($x7848 (= z_3_18_7 z_4_18_8)))
 (=> x_3_X $x7848)))
(assert
 (let (($x7834 (or z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7851 (= z_3_18_7 $x7834)))
 (=> x_3_F $x7851))))
(assert
 (let (($x7838 (and z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7854 (= z_3_18_7 $x7838)))
 (=> x_3_G $x7854))))
(assert
 (=> x_3_! (= z_3_18_8 (not z_4_18_8))))
(assert
 (let (($x7863 (= z_3_18_8 z_4_18_9)))
 (=> x_3_X $x7863)))
(assert
 (let (($x7834 (or z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7866 (= z_3_18_8 $x7834)))
 (=> x_3_F $x7866))))
(assert
 (let (($x7838 (and z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7869 (= z_3_18_8 $x7838)))
 (=> x_3_G $x7869))))
(assert
 (=> x_3_! (= z_3_18_9 (not z_4_18_9))))
(assert
 (let (($x7878 (= z_3_18_9 z_4_18_6)))
 (=> x_3_X $x7878)))
(assert
 (let (($x7834 (or z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7881 (= z_3_18_9 $x7834)))
 (=> x_3_F $x7881))))
(assert
 (let (($x7838 (and z_4_18_6 z_4_18_7 z_4_18_8 z_4_18_9)))
 (let (($x7884 (= z_3_18_9 $x7838)))
 (=> x_3_G $x7884))))
(assert
 (=> x_3_! (= z_3_19_0 (not z_4_19_0))))
(assert
 (let (($x7895 (= z_3_19_0 z_4_19_1)))
 (=> x_3_X $x7895)))
(assert
 (let (($x7905 (or z_4_19_0 z_4_19_1 z_4_19_2 z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7906 (= z_3_19_0 $x7905)))
 (=> x_3_F $x7906))))
(assert
 (let (($x7909 (and z_4_19_0 z_4_19_1 z_4_19_2 z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7910 (= z_3_19_0 $x7909)))
 (=> x_3_G $x7910))))
(assert
 (=> x_3_! (= z_3_19_1 (not z_4_19_1))))
(assert
 (let (($x7919 (= z_3_19_1 z_4_19_2)))
 (=> x_3_X $x7919)))
(assert
 (let (($x7922 (or z_4_19_1 z_4_19_2 z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7923 (= z_3_19_1 $x7922)))
 (=> x_3_F $x7923))))
(assert
 (let (($x7926 (and z_4_19_1 z_4_19_2 z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7927 (= z_3_19_1 $x7926)))
 (=> x_3_G $x7927))))
(assert
 (=> x_3_! (= z_3_19_2 (not z_4_19_2))))
(assert
 (let (($x7936 (= z_3_19_2 z_4_19_3)))
 (=> x_3_X $x7936)))
(assert
 (let (($x7939 (or z_4_19_2 z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7940 (= z_3_19_2 $x7939)))
 (=> x_3_F $x7940))))
(assert
 (let (($x7943 (and z_4_19_2 z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7944 (= z_3_19_2 $x7943)))
 (=> x_3_G $x7944))))
(assert
 (=> x_3_! (= z_3_19_3 (not z_4_19_3))))
(assert
 (let (($x7953 (= z_3_19_3 z_4_19_4)))
 (=> x_3_X $x7953)))
(assert
 (let (($x7957 (= z_3_19_3 (or z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8))))
 (=> x_3_F $x7957)))
(assert
 (let (($x7961 (= z_3_19_3 (and z_4_19_3 z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8))))
 (=> x_3_G $x7961)))
(assert
 (=> x_3_! (= z_3_19_4 (not z_4_19_4))))
(assert
 (let (($x7970 (= z_3_19_4 z_4_19_5)))
 (=> x_3_X $x7970)))
(assert
 (let (($x7974 (= z_3_19_4 (or z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8))))
 (=> x_3_F $x7974)))
(assert
 (let (($x7978 (= z_3_19_4 (and z_4_19_4 z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8))))
 (=> x_3_G $x7978)))
(assert
 (=> x_3_! (= z_3_19_5 (not z_4_19_5))))
(assert
 (let (($x7987 (= z_3_19_5 z_4_19_6)))
 (=> x_3_X $x7987)))
(assert
 (let (($x7990 (or z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7991 (= z_3_19_5 $x7990)))
 (=> x_3_F $x7991))))
(assert
 (let (($x7994 (and z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x7995 (= z_3_19_5 $x7994)))
 (=> x_3_G $x7995))))
(assert
 (=> x_3_! (= z_3_19_6 (not z_4_19_6))))
(assert
 (let (($x8004 (= z_3_19_6 z_4_19_7)))
 (=> x_3_X $x8004)))
(assert
 (let (($x7990 (or z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x8007 (= z_3_19_6 $x7990)))
 (=> x_3_F $x8007))))
(assert
 (let (($x7994 (and z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x8010 (= z_3_19_6 $x7994)))
 (=> x_3_G $x8010))))
(assert
 (=> x_3_! (= z_3_19_7 (not z_4_19_7))))
(assert
 (let (($x8019 (= z_3_19_7 z_4_19_8)))
 (=> x_3_X $x8019)))
(assert
 (let (($x7990 (or z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x8022 (= z_3_19_7 $x7990)))
 (=> x_3_F $x8022))))
(assert
 (let (($x7994 (and z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x8025 (= z_3_19_7 $x7994)))
 (=> x_3_G $x8025))))
(assert
 (=> x_3_! (= z_3_19_8 (not z_4_19_8))))
(assert
 (let (($x8034 (= z_3_19_8 z_4_19_5)))
 (=> x_3_X $x8034)))
(assert
 (let (($x7990 (or z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x8037 (= z_3_19_8 $x7990)))
 (=> x_3_F $x8037))))
(assert
 (let (($x7994 (and z_4_19_5 z_4_19_6 z_4_19_7 z_4_19_8)))
 (let (($x8040 (= z_3_19_8 $x7994)))
 (=> x_3_G $x8040))))
(assert
...
(assert
 (let (($x4823 (not x_3_G)))
 (let (($x4817 (not x_3_F)))
 (let (($x8049 (or $x4817 $x4823)))
 (let (($x4806 (not x_3_X)))
 (let (($x8048 (or $x4806 $x4823)))
 (let (($x8047 (or $x4806 $x4817)))
 (let (($x4800 (not x_3_!)))
 (let (($x8046 (or $x4800 $x4823)))
 (let (($x8045 (or $x4800 $x4817)))
 (let (($x8044 (or $x4800 $x4806)))
 (and $x8044 $x8045 $x8046 $x8047 $x8048 $x8049))))))))))))
(assert
 (= z_4_0_0 (not z_5_0_0)))
(assert
 (let (($x8057 (not z_5_0_1)))
 (= z_4_0_1 $x8057)))
(assert
 (let (($x8062 (not z_5_0_2)))
 (= z_4_0_2 $x8062)))
(assert
 (let (($x8067 (not z_5_0_3)))
 (= z_4_0_3 $x8067)))
(assert
 (let (($x8072 (not z_5_0_4)))
 (= z_4_0_4 $x8072)))
(assert
 (let (($x8077 (not z_5_0_5)))
 (= z_4_0_5 $x8077)))
(assert
 (let (($x8082 (not z_5_0_6)))
 (= z_4_0_6 $x8082)))
(assert
 (= z_4_1_0 (not z_5_1_0)))
(assert
...
(assert
 (= z_4_1_4 (not z_5_1_4)))
(assert
 (let (($x8112 (not z_5_1_5)))
 (= z_4_1_5 $x8112)))
(assert
 (let (($x8117 (not z_5_1_6)))
 (= z_4_1_6 $x8117)))
(assert
 (let (($x8122 (not z_5_1_7)))
 (= z_4_1_7 $x8122)))
(assert
 (let (($x8127 (not z_5_1_8)))
 (= z_4_1_8 $x8127)))
(assert
 (let (($x8132 (not z_5_1_9)))
 (= z_4_1_9 $x8132)))
(assert
 (let (($x8137 (not z_5_1_10)))
 (= z_4_1_10 $x8137)))
(assert
 (= z_4_2_0 (not z_5_2_0)))
(assert
 (let (($x8147 (not z_5_2_1)))
 (= z_4_2_1 $x8147)))
(assert
 (let (($x8152 (not z_5_2_2)))
 (= z_4_2_2 $x8152)))
(assert
 (let (($x8157 (not z_5_2_3)))
 (= z_4_2_3 $x8157)))
(assert
 (let (($x8162 (not z_5_2_4)))
 (= z_4_2_4 $x8162)))
(assert
 (let (($x8167 (not z_5_2_5)))
 (= z_4_2_5 $x8167)))
(assert
 (let (($x8172 (not z_5_2_6)))
 (= z_4_2_6 $x8172)))
(assert
 (let (($x8177 (not z_5_2_7)))
 (= z_4_2_7 $x8177)))
(assert
 (let (($x8182 (not z_5_2_8)))
 (= z_4_2_8 $x8182)))
(assert
 (let (($x8187 (not z_5_2_9)))
 (= z_4_2_9 $x8187)))
(assert
 (let (($x8192 (not z_5_3_0)))
 (= z_4_3_0 $x8192)))
(assert
 (= z_4_3_1 (not z_5_3_1)))
(assert
 (let (($x8202 (not z_5_3_2)))
 (= z_4_3_2 $x8202)))
(assert
 (let (($x8207 (not z_5_3_3)))
 (= z_4_3_3 $x8207)))
(assert
 (= z_4_4_0 (not z_5_4_0)))
(assert
...
(assert
 (= z_4_4_2 (not z_5_4_2)))
(assert
 (let (($x8227 (not z_5_4_3)))
 (= z_4_4_3 $x8227)))
(assert
 (let (($x8232 (not z_5_4_4)))
 (= z_4_4_4 $x8232)))
(assert
 (let (($x8237 (not z_5_4_5)))
 (= z_4_4_5 $x8237)))
(assert
 (let (($x8242 (not z_5_4_6)))
 (= z_4_4_6 $x8242)))
(assert
 (let (($x8247 (not z_5_4_7)))
 (= z_4_4_7 $x8247)))
(assert
 (let (($x8252 (not z_5_4_8)))
 (= z_4_4_8 $x8252)))
(assert
 (let (($x8257 (not z_5_4_9)))
 (= z_4_4_9 $x8257)))
(assert
 (= z_4_5_0 (not z_5_5_0)))
(assert
 (= z_4_5_1 (not z_5_5_1)))
(assert
 (let (($x8272 (not z_5_5_2)))
 (= z_4_5_2 $x8272)))
(assert
 (let (($x8277 (not z_5_5_3)))
 (= z_4_5_3 $x8277)))
(assert
 (let (($x8282 (not z_5_5_4)))
 (= z_4_5_4 $x8282)))
(assert
 (let (($x8287 (not z_5_5_5)))
 (= z_4_5_5 $x8287)))
(assert
 (let (($x8292 (not z_5_5_6)))
 (= z_4_5_6 $x8292)))
(assert
 (let (($x8297 (not z_5_5_7)))
 (= z_4_5_7 $x8297)))
(assert
 (let (($x8302 (not z_5_5_8)))
 (= z_4_5_8 $x8302)))
(assert
 (= z_4_6_0 (not z_5_6_0)))
(assert
 (= z_4_6_1 (not z_5_6_1)))
(assert
 (let (($x8317 (not z_5_6_2)))
 (= z_4_6_2 $x8317)))
(assert
 (let (($x8322 (not z_5_6_3)))
 (= z_4_6_3 $x8322)))
(assert
 (let (($x8327 (not z_5_6_4)))
 (= z_4_6_4 $x8327)))
(assert
 (let (($x8332 (not z_5_6_5)))
 (= z_4_6_5 $x8332)))
(assert
 (let (($x8337 (not z_5_6_6)))
 (= z_4_6_6 $x8337)))
(assert
 (let (($x8342 (not z_5_6_7)))
 (= z_4_6_7 $x8342)))
(assert
 (let (($x8347 (not z_5_6_8)))
 (= z_4_6_8 $x8347)))
(assert
 (let (($x8352 (not z_5_6_9)))
 (= z_4_6_9 $x8352)))
(assert
 (let (($x8357 (not z_5_6_10)))
 (= z_4_6_10 $x8357)))
(assert
 (let (($x8362 (not z_5_7_0)))
 (= z_4_7_0 $x8362)))
(assert
 (let (($x8367 (not z_5_7_1)))
 (= z_4_7_1 $x8367)))
(assert
 (let (($x8372 (not z_5_7_2)))
 (= z_4_7_2 $x8372)))
(assert
 (let (($x8377 (not z_5_7_3)))
 (= z_4_7_3 $x8377)))
(assert
 (let (($x8382 (not z_5_7_4)))
 (= z_4_7_4 $x8382)))
(assert
 (let (($x8387 (not z_5_7_5)))
 (= z_4_7_5 $x8387)))
(assert
 (let (($x8392 (not z_5_7_6)))
 (= z_4_7_6 $x8392)))
(assert
 (let (($x8397 (not z_5_7_7)))
 (= z_4_7_7 $x8397)))
(assert
 (let (($x8402 (not z_5_7_8)))
 (= z_4_7_8 $x8402)))
(assert
 (let (($x8407 (not z_5_8_0)))
 (= z_4_8_0 $x8407)))
(assert
 (= z_4_8_1 (not z_5_8_1)))
(assert
 (let (($x8417 (not z_5_8_2)))
 (= z_4_8_2 $x8417)))
(assert
 (let (($x8422 (not z_5_8_3)))
 (= z_4_8_3 $x8422)))
(assert
 (let (($x8427 (not z_5_8_4)))
 (= z_4_8_4 $x8427)))
(assert
 (let (($x8432 (not z_5_8_5)))
 (= z_4_8_5 $x8432)))
(assert
 (let (($x8437 (not z_5_8_6)))
 (= z_4_8_6 $x8437)))
(assert
 (let (($x8442 (not z_5_8_7)))
 (= z_4_8_7 $x8442)))
(assert
 (let (($x8447 (not z_5_8_8)))
 (= z_4_8_8 $x8447)))
(assert
 (let (($x8452 (not z_5_8_9)))
 (= z_4_8_9 $x8452)))
(assert
 (let (($x8457 (not z_5_8_10)))
 (= z_4_8_10 $x8457)))
(assert
 (= z_4_9_0 (not z_5_9_0)))
(assert
...
(assert
 (= z_4_9_2 (not z_5_9_2)))
(assert
 (let (($x8477 (not z_5_9_3)))
 (= z_4_9_3 $x8477)))
(assert
 (let (($x8482 (not z_5_9_4)))
 (= z_4_9_4 $x8482)))
(assert
 (let (($x8487 (not z_5_9_5)))
 (= z_4_9_5 $x8487)))
(assert
 (let (($x8492 (not z_5_9_6)))
 (= z_4_9_6 $x8492)))
(assert
 (let (($x8497 (not z_5_9_7)))
 (= z_4_9_7 $x8497)))
(assert
 (let (($x8502 (not z_5_9_8)))
 (= z_4_9_8 $x8502)))
(assert
 (let (($x8507 (not z_5_9_9)))
 (= z_4_9_9 $x8507)))
(assert
...
(assert
 (let (($x8552 (not z_5_10_8)))
 (= z_4_10_8 $x8552)))
(assert
 (let (($x8557 (not z_5_11_0)))
 (= z_4_11_0 $x8557)))
(assert
 (= z_4_11_1 (not z_5_11_1)))
(assert
 (let (($x8567 (not z_5_11_2)))
 (= z_4_11_2 $x8567)))
(assert
 (let (($x8572 (not z_5_11_3)))
 (= z_4_11_3 $x8572)))
(assert
...
(assert
 (let (($x8602 (not z_5_11_9)))
 (= z_4_11_9 $x8602)))
(assert
 (= z_4_11_10 (not z_5_11_10)))
(assert
 (let (($x8612 (not z_5_12_0)))
 (= z_4_12_0 $x8612)))
(assert
 (let (($x8617 (not z_5_12_1)))
 (= z_4_12_1 $x8617)))
(assert
...
(assert
 (let (($x8632 (not z_5_12_4)))
 (= z_4_12_4 $x8632)))
(assert
 (= z_4_12_5 (not z_5_12_5)))
(assert
 (let (($x8642 (not z_5_12_6)))
 (= z_4_12_6 $x8642)))
(assert
 (let (($x8647 (not z_5_12_7)))
 (= z_4_12_7 $x8647)))
(assert
...
(assert
 (let (($x8672 (not z_5_13_1)))
 (= z_4_13_1 $x8672)))
(assert
 (let (($x8677 (not z_5_13_2)))
 (= z_4_13_2 $x8677)))
(assert
 (let (($x8682 (not z_5_13_3)))
 (= z_4_13_3 $x8682)))
(assert
...
(assert
 (let (($x8697 (not z_5_13_6)))
 (= z_4_13_6 $x8697)))
(assert
 (let (($x8702 (not z_5_13_7)))
 (= z_4_13_7 $x8702)))
(assert
 (let (($x8707 (not z_5_14_0)))
 (= z_4_14_0 $x8707)))
(assert
...
(assert
 (= z_4_14_5 (not z_5_14_5)))
(assert
 (let (($x8737 (not z_5_15_0)))
 (= z_4_15_0 $x8737)))
(assert
 (let (($x8742 (not z_5_15_1)))
 (= z_4_15_1 $x8742)))
(assert
 (let (($x8747 (not z_5_15_2)))
 (= z_4_15_2 $x8747)))
(assert
 (let (($x8752 (not z_5_15_3)))
 (= z_4_15_3 $x8752)))
(assert
 (= z_4_15_4 (not z_5_15_4)))
(assert
 (let (($x8762 (not z_5_15_5)))
 (= z_4_15_5 $x8762)))
(assert
 (= z_4_15_6 (not z_5_15_6)))
(assert
 (let (($x8772 (not z_5_15_7)))
 (= z_4_15_7 $x8772)))
(assert
 (let (($x8777 (not z_5_15_8)))
 (= z_4_15_8 $x8777)))
(assert
 (let (($x8782 (not z_5_15_9)))
 (= z_4_15_9 $x8782)))
(assert
 (= z_4_15_10 (not z_5_15_10)))
(assert
 (let (($x8792 (not z_5_16_0)))
 (= z_4_16_0 $x8792)))
(assert
 (let (($x8797 (not z_5_16_1)))
 (= z_4_16_1 $x8797)))
(assert
 (= z_4_16_2 (not z_5_16_2)))
(assert
 (let (($x8807 (not z_5_16_3)))
 (= z_4_16_3 $x8807)))
(assert
 (let (($x8812 (not z_5_16_4)))
 (= z_4_16_4 $x8812)))
(assert
...
(assert
 (let (($x8832 (not z_5_16_8)))
 (= z_4_16_8 $x8832)))
(assert
 (= z_4_16_9 (not z_5_16_9)))
(assert
 (let (($x8842 (not z_5_17_0)))
 (= z_4_17_0 $x8842)))
(assert
...
(assert
 (let (($x8857 (not z_5_17_3)))
 (= z_4_17_3 $x8857)))
(assert
 (= z_4_17_4 (not z_5_17_4)))
(assert
 (let (($x8867 (not z_5_17_5)))
 (= z_4_17_5 $x8867)))
(assert
...
(assert
 (= z_4_17_11 (not z_5_17_11)))
(assert
 (= z_4_18_0 (not z_5_18_0)))
(assert
 (let (($x8907 (not z_5_18_1)))
 (= z_4_18_1 $x8907)))
(assert
 (let (($x8912 (not z_5_18_2)))
 (= z_4_18_2 $x8912)))
(assert
 (= z_4_18_3 (not z_5_18_3)))
(assert
 (let (($x8922 (not z_5_18_4)))
 (= z_4_18_4 $x8922)))
(assert
 (let (($x8927 (not z_5_18_5)))
 (= z_4_18_5 $x8927)))
(assert
 (let (($x8932 (not z_5_18_6)))
 (= z_4_18_6 $x8932)))
(assert
...
(assert
 (let (($x8952 (not z_5_19_0)))
 (= z_4_19_0 $x8952)))
(assert
 (= z_4_19_1 (not z_5_19_1)))
(assert
 (let (($x8962 (not z_5_19_2)))
 (= z_4_19_2 $x8962)))
(assert
 (= z_4_19_3 (not z_5_19_3)))
(assert
 (let (($x8972 (not z_5_19_4)))
 (= z_4_19_4 $x8972)))
(assert
...
(assert
 (let (($x8987 (not z_5_19_7)))
 (= z_4_19_7 $x8987)))
(assert
 (let (($x8992 (not z_5_19_8)))
 (= z_4_19_8 $x8992)))
(assert
 z_5_0_0)
(assert
...
(assert
 (= z_0_19_0 false))
(assert
 (let (($x9029 (= x_0_F x_3_F)))
 (let (($x9028 (= x_0_G x_3_G)))
 (let (($x9027 (= x_0_X x_3_X)))
 (let (($x9026 (= x_0_! x_3_!)))
 (and $x9026 $x9027 $x9028 $x9029))))))
(assert
 (let (($x9034 (= x_3_F x_0_F)))
 (let (($x9033 (= x_3_G x_0_G)))
 (let (($x9032 (= x_3_X x_0_X)))
 (let (($x9031 (= x_3_! x_0_!)))
 (and $x9031 $x9032 $x9033 $x9034))))))
(check-sat)
