...
(assert
 (= z_1_12 (not z_2_12)))
(assert
 (let (($x1982 (not z_2_13)))
 (= z_1_13 $x1982)))
(assert
 (let (($x1987 (not z_2_14)))
 (= z_1_14 $x1987)))
(assert
 (let (($x1992 (not z_2_15)))
 (= z_1_15 $x1992)))
(assert
 (let (($x1997 (not z_2_16)))
 (= z_1_16 $x1997)))
(assert
 (= z_1_17 (not z_2_17)))
(assert
 (let (($x2007 (not z_2_18)))
 (= z_1_18 $x2007)))
(assert
 (let (($x2012 (not z_2_19)))
 (= z_1_19 $x2012)))
(assert
 (= z_1_20 (not z_2_20)))
(assert
 (= z_1_21 (not z_2_21)))
(assert
 (let (($x2027 (not z_2_22)))
 (= z_1_22 $x2027)))
(assert
 (let (($x2032 (not z_2_23)))
 (= z_1_23 $x2032)))
(assert
 (= z_1_24 (not z_2_24)))
(assert
 (let (($x2042 (not z_2_25)))
 (= z_1_25 $x2042)))
(assert
 (= z_1_26 (not z_2_26)))
(assert
...
(assert
 (= z_1_28 (not z_2_28)))
(assert
 (let (($x2062 (not z_2_29)))
 (= z_1_29 $x2062)))
(assert
 (= z_1_30 (not z_2_30)))
(assert
 (let (($x2072 (not z_2_31)))
 (= z_1_31 $x2072)))
(assert
 (let (($x2077 (not z_2_32)))
 (= z_1_32 $x2077)))
(assert
 (let (($x2082 (not z_2_33)))
 (= z_1_33 $x2082)))
(assert
 (= z_1_34 (not z_2_34)))
(assert
...
(assert
 (= z_1_36 (not z_2_36)))
(assert
 (let (($x2102 (not z_2_37)))
 (= z_1_37 $x2102)))
(assert
 (let (($x2107 (not z_2_38)))
 (= z_1_38 $x2107)))
(assert
 (= z_1_39 (not z_2_39)))
(assert
 (= z_1_40 (not z_2_40)))
(assert
 (let (($x2122 (not z_2_41)))
 (= z_1_41 $x2122)))
(assert
 (let (($x2127 (not z_2_42)))
 (= z_1_42 $x2127)))
(assert
 (let (($x2132 (not z_2_43)))
 (= z_1_43 $x2132)))
(assert
 (= z_1_44 (not z_2_44)))
(assert
 (= z_1_45 (not z_2_45)))
(assert
 (let (($x2147 (not z_2_46)))
 (= z_1_46 $x2147)))
(assert
 (let (($x2152 (not z_2_47)))
 (= z_1_47 $x2152)))
(assert
 (let (($x2157 (not z_2_48)))
 (= z_1_48 $x2157)))
(assert
 (let (($x2162 (not z_2_49)))
 (= z_1_49 $x2162)))
(assert
 (let (($x2167 (not z_2_50)))
 (= z_1_50 $x2167)))
(assert
 (= z_1_51 (not z_2_51)))
(assert
 (= z_1_52 (not z_2_52)))
(assert
 (let (($x2182 (not z_2_53)))
 (= z_1_53 $x2182)))
(assert
 (= z_1_54 (not z_2_54)))
(assert
 (let (($x2192 (not z_2_55)))
 (= z_1_55 $x2192)))
(assert
 (let (($x2197 (not z_2_56)))
 (= z_1_56 $x2197)))
(assert
 (= z_1_57 (not z_2_57)))
(assert
 (let (($x2207 (not z_2_58)))
 (= z_1_58 $x2207)))
(assert
 (let (($x2212 (not z_2_59)))
 (= z_1_59 $x2212)))
(assert
 (= z_1_60 (not z_2_60)))
(assert
...
(assert
 (= z_1_69 (not z_2_69)))
(assert
 (let (($x2267 (not z_2_70)))
 (= z_1_70 $x2267)))
(assert
 (= z_1_71 (not z_2_71)))
(assert
 (let (($x2277 (not z_2_72)))
 (= z_1_72 $x2277)))
(assert
 (= z_1_73 (not z_2_73)))
(assert
 (let (($x2287 (not z_2_74)))
 (= z_1_74 $x2287)))
(assert
 (= z_1_75 (not z_2_75)))
(assert
 (let (($x2297 (not z_2_76)))
 (= z_1_76 $x2297)))
(assert
 (= z_1_77 (not z_2_77)))
(assert
...
(assert
 (= z_1_79 (not z_2_79)))
(assert
 (let (($x2317 (not z_2_80)))
 (= z_1_80 $x2317)))
(assert
 (let (($x2322 (not z_2_81)))
 (= z_1_81 $x2322)))
(assert
 (= z_1_82 (not z_2_82)))
(assert
 (let (($x2332 (not z_2_83)))
 (= z_1_83 $x2332)))
(assert
 (= z_1_84 (not z_2_84)))
(assert
...
(assert
 (= z_1_86 (not z_2_86)))
(assert
 (let (($x2352 (not z_2_87)))
 (= z_1_87 $x2352)))
(assert
 (= z_1_88 (not z_2_88)))
(assert
 (let (($x2362 (not z_2_89)))
 (= z_1_89 $x2362)))
(assert
 (let (($x2367 (not z_2_90)))
 (= z_1_90 $x2367)))
(assert
 (let (($x2372 (not z_2_91)))
 (= z_1_91 $x2372)))
(assert
 (not z_2_0))
(assert
