...
(assert
 (let (($x1496 (and z_4_6 z_3_7 z_3_3 z_3_4 z_3_5)))
 (let (($x1495 (and z_4_5 z_3_7 z_3_3 z_3_4)))
 (let (($x1494 (and z_4_4 z_3_7 z_3_3)))
 (let (($x1493 (and z_4_3 z_3_7)))
 (= z_2_7 (or (and z_4_7) $x1493 $x1494 $x1495 $x1496)))))))
(assert
...
(assert
 (let (($x1547 (and z_4_15 z_3_16 z_3_12 z_3_13 z_3_14)))
 (let (($x1546 (and z_4_14 z_3_16 z_3_12 z_3_13)))
 (let (($x1545 (and z_4_13 z_3_16 z_3_12)))
 (let (($x1544 (and z_4_12 z_3_16)))
 (= z_2_16 (or (and z_4_16) $x1544 $x1545 $x1546 $x1547)))))))
(assert
...
(assert
 (let (($x1609 (and z_4_26 z_3_27 z_3_22 z_3_23 z_3_24 z_3_25)))
 (let (($x1608 (and z_4_25 z_3_27 z_3_22 z_3_23 z_3_24)))
 (let (($x1607 (and z_4_24 z_3_27 z_3_22 z_3_23)))
 (let (($x1606 (and z_4_23 z_3_27 z_3_22)))
 (let (($x1605 (and z_4_22 z_3_27)))
 (= z_2_27 (or (and z_4_27) $x1605 $x1606 $x1607 $x1608 $x1609))))))))
(assert
...
(assert
 (let (($x1671 (and z_4_37 z_3_38 z_3_33 z_3_34 z_3_35 z_3_36)))
 (let (($x1670 (and z_4_36 z_3_38 z_3_33 z_3_34 z_3_35)))
 (let (($x1669 (and z_4_35 z_3_38 z_3_33 z_3_34)))
 (let (($x1668 (and z_4_34 z_3_38 z_3_33)))
 (let (($x1667 (and z_4_33 z_3_38)))
 (= z_2_38 (or (and z_4_38) $x1667 $x1668 $x1669 $x1670 $x1671))))))))
(assert
...
(assert
 (let (($x1701 (and z_4_42 z_3_43 z_3_40 z_3_41)))
 (let (($x1700 (and z_4_41 z_3_43 z_3_40)))
 (let (($x1699 (and z_4_40 z_3_43)))
 (= z_2_43 (or (and z_4_43) $x1699 $x1700 $x1701))))))
(assert
...
(assert
 (let (($x1797 (and z_4_60 z_3_61 z_3_57 z_3_58 z_3_59)))
 (let (($x1796 (and z_4_59 z_3_61 z_3_57 z_3_58)))
 (let (($x1795 (and z_4_58 z_3_61 z_3_57)))
 (let (($x1794 (and z_4_57 z_3_61)))
 (= z_2_61 (or (and z_4_61) $x1794 $x1795 $x1796 $x1797)))))))
(assert
...
(assert
 (let (($x1864 (and z_4_72 z_3_73 z_3_68 z_3_69 z_3_70 z_3_71)))
 (let (($x1863 (and z_4_71 z_3_73 z_3_68 z_3_69 z_3_70)))
 (let (($x1862 (and z_4_70 z_3_73 z_3_68 z_3_69)))
 (let (($x1861 (and z_4_69 z_3_73 z_3_68)))
 (let (($x1860 (and z_4_68 z_3_73)))
 (= z_2_73 (or (and z_4_73) $x1860 $x1861 $x1862 $x1863 $x1864))))))))
(assert
...
(assert
 (= z_2_87 (or z_4_87 (and z_3_87 z_2_88))))
(assert
 (let (($x1946 (and z_4_87 z_3_88 z_3_83 z_3_84 z_3_85 z_3_86)))
 (let (($x1945 (and z_4_86 z_3_88 z_3_83 z_3_84 z_3_85)))
 (let (($x1944 (and z_4_85 z_3_88 z_3_83 z_3_84)))
 (let (($x1943 (and z_4_84 z_3_88 z_3_83)))
 (let (($x1942 (and z_4_83 z_3_88)))
 (= z_2_88 (or (and z_4_88) $x1942 $x1943 $x1944 $x1945 $x1946))))))))
(assert
...
(assert
 (let (($x2013 (and z_4_99 z_3_100 z_3_95 z_3_96 z_3_97 z_3_98)))
 (let (($x2012 (and z_4_98 z_3_100 z_3_95 z_3_96 z_3_97)))
 (let (($x2011 (and z_4_97 z_3_100 z_3_95 z_3_96)))
 (let (($x2010 (and z_4_96 z_3_100 z_3_95)))
 (let (($x2009 (and z_4_95 z_3_100)))
 (= z_2_100 (or (and z_4_100) $x2009 $x2010 $x2011 $x2012 $x2013))))))))
(assert
...
(assert
 (let (($x2053 (and z_4_106 z_3_107 z_3_104 z_3_105)))
 (let (($x2052 (and z_4_105 z_3_107 z_3_104)))
 (let (($x2051 (and z_4_104 z_3_107)))
 (= z_2_107 (or (and z_4_107) $x2051 $x2052 $x2053))))))
(assert
...
(assert
 (= z_2_111 (or z_4_111 (and z_3_111 z_2_112))))
(assert
...
(assert
 (let (($x2108 (and z_4_116 z_3_117 z_3_114 z_3_115)))
 (let (($x2107 (and z_4_115 z_3_117 z_3_114)))
 (let (($x2106 (and z_4_114 z_3_117)))
 (= z_2_117 (or (and z_4_117) $x2106 $x2107 $x2108))))))
(assert
 (= z_2_118 (or z_4_118 (and z_3_118 z_2_119))))
(assert
 (= z_2_119 (or z_4_119 (and z_3_119 z_2_120))))
(assert
 (= z_2_120 (or z_4_120 (and z_3_120 z_2_121))))
(assert
...
(assert
 (let (($x2170 (and z_4_127 z_3_128 z_3_123 z_3_124 z_3_125 z_3_126)))
 (let (($x2169 (and z_4_126 z_3_128 z_3_123 z_3_124 z_3_125)))
 (let (($x2168 (and z_4_125 z_3_128 z_3_123 z_3_124)))
 (let (($x2167 (and z_4_124 z_3_128 z_3_123)))
 (let (($x2166 (and z_4_123 z_3_128)))
 (= z_2_128 (or (and z_4_128) $x2166 $x2167 $x2168 $x2169 $x2170))))))))
(assert
 (= z_2_129 (or z_4_129 (and z_3_129 z_2_130))))
(assert
 (= z_2_130 (or z_4_130 (and z_3_130 z_2_131))))
(assert
 (= z_2_131 (or z_4_131 (and z_3_131 z_2_132))))
(assert
...
(assert
 (let (($x2216 (and z_4_135 z_3_136 z_3_132 z_3_133 z_3_134)))
 (let (($x2215 (and z_4_134 z_3_136 z_3_132 z_3_133)))
 (let (($x2214 (and z_4_133 z_3_136 z_3_132)))
 (let (($x2213 (and z_4_132 z_3_136)))
 (= z_2_136 (or (and z_4_136) $x2213 $x2214 $x2215 $x2216)))))))
(assert
...
(assert
 (let (($x2283 (and z_4_147 z_3_148 z_3_143 z_3_144 z_3_145 z_3_146)))
 (let (($x2282 (and z_4_146 z_3_148 z_3_143 z_3_144 z_3_145)))
 (let (($x2281 (and z_4_145 z_3_148 z_3_143 z_3_144)))
 (let (($x2280 (and z_4_144 z_3_148 z_3_143)))
 (let (($x2279 (and z_4_143 z_3_148)))
 (= z_2_148 (or (and z_4_148) $x2279 $x2280 $x2281 $x2282 $x2283))))))))
(assert
...
(assert
 (= z_2_156 (or z_4_156 (and z_3_156 z_2_157))))
(assert
 (= z_2_157 (or z_4_157 (and z_3_157 z_2_158))))
(assert
 (= z_2_158 (or z_4_158 (and z_3_158 z_2_159))))
(assert
 (let (($x2345 (and z_4_158 z_3_159 z_3_154 z_3_155 z_3_156 z_3_157)))
 (let (($x2344 (and z_4_157 z_3_159 z_3_154 z_3_155 z_3_156)))
 (let (($x2343 (and z_4_156 z_3_159 z_3_154 z_3_155)))
 (let (($x2342 (and z_4_155 z_3_159 z_3_154)))
 (let (($x2341 (and z_4_154 z_3_159)))
 (= z_2_159 (or (and z_4_159) $x2341 $x2342 $x2343 $x2344 $x2345))))))))
(assert
...
(assert
 (let (($x2396 (and z_4_167 z_3_168 z_3_164 z_3_165 z_3_166)))
 (let (($x2395 (and z_4_166 z_3_168 z_3_164 z_3_165)))
 (let (($x2394 (and z_4_165 z_3_168 z_3_164)))
 (let (($x2393 (and z_4_164 z_3_168)))
 (= z_2_168 (or (and z_4_168) $x2393 $x2394 $x2395 $x2396)))))))
(assert
...
(assert
 (let (($x2452 (and z_4_177 z_3_178 z_3_174 z_3_175 z_3_176)))
 (let (($x2451 (and z_4_176 z_3_178 z_3_174 z_3_175)))
 (let (($x2450 (and z_4_175 z_3_178 z_3_174)))
 (let (($x2449 (and z_4_174 z_3_178)))
 (= z_2_178 (or (and z_4_178) $x2449 $x2450 $x2451 $x2452)))))))
(assert
 (not z_3_0))
(assert
 z_3_1)
...
(assert
 (=> x_5_p z_5_10))
(assert
 (let (($x3670 (not z_5_11)))
 (=> x_5_p $x3670)))
(assert
 (let (($x3617 (not z_5_12)))
 (=> x_5_p $x3617)))
(assert
 (=> x_5_p z_5_13))
(assert
 (let (($x3510 (not z_5_14)))
 (=> x_5_p $x3510)))
(assert
 (let (($x3457 (not z_5_15)))
 (=> x_5_p $x3457)))
(assert
 (=> x_5_p z_5_16))
(assert
 (let (($x3350 (not z_5_17)))
 (=> x_5_p $x3350)))
(assert
 (=> x_5_p z_5_18))
(assert
...
(assert
 (=> x_5_p z_5_22))
(assert
 (let (($x3026 (not z_5_23)))
 (=> x_5_p $x3026)))
(assert
 (let (($x2972 (not z_5_24)))
 (=> x_5_p $x2972)))
(assert
 (let (($x2918 (not z_5_25)))
 (=> x_5_p $x2918)))
(assert
 (=> x_5_p z_5_26))
(assert
 (let (($x2810 (not z_5_27)))
 (=> x_5_p $x2810)))
(assert
 (=> x_5_p z_5_28))
(assert
 (let (($x2702 (not z_5_29)))
 (=> x_5_p $x2702)))
(assert
 (let (($x4289 (not z_5_30)))
 (=> x_5_p $x4289)))
(assert
 (let (($x4280 (not z_5_31)))
 (=> x_5_p $x4280)))
(assert
 (=> x_5_p z_5_32))
(assert
 (let (($x4262 (not z_5_33)))
 (=> x_5_p $x4262)))
(assert
 (let (($x4253 (not z_5_34)))
 (=> x_5_p $x4253)))
(assert
 (let (($x4244 (not z_5_35)))
 (=> x_5_p $x4244)))
(assert
 (=> x_5_p z_5_36))
(assert
 (=> x_5_p z_5_37))
(assert
 (let (($x4217 (not z_5_38)))
 (=> x_5_p $x4217)))
(assert
 (let (($x4209 (not z_5_39)))
 (=> x_5_p $x4209)))
(assert
 (=> x_5_p z_5_40))
(assert
 (let (($x4191 (not z_5_41)))
 (=> x_5_p $x4191)))
(assert
 (=> x_5_p z_5_42))
(assert
...
(assert
 (=> x_5_p z_5_51))
(assert
 (let (($x4093 (not z_5_52)))
 (=> x_5_p $x4093)))
(assert
 (let (($x4084 (not z_5_53)))
 (=> x_5_p $x4084)))
(assert
 (let (($x4075 (not z_5_54)))
 (=> x_5_p $x4075)))
(assert
 (let (($x4066 (not z_5_55)))
 (=> x_5_p $x4066)))
(assert
 (=> x_5_p z_5_56))
(assert
 (=> x_5_p z_5_57))
(assert
 (let (($x4039 (not z_5_58)))
 (=> x_5_p $x4039)))
(assert
 (let (($x4031 (not z_5_59)))
 (=> x_5_p $x4031)))
(assert
 (let (($x4022 (not z_5_60)))
 (=> x_5_p $x4022)))
(assert
 (let (($x4013 (not z_5_61)))
 (=> x_5_p $x4013)))
(assert
 (let (($x4004 (not z_5_62)))
 (=> x_5_p $x4004)))
(assert
 (let (($x3995 (not z_5_63)))
 (=> x_5_p $x3995)))
(assert
 (=> x_5_p z_5_64))
(assert
 (=> x_5_p z_5_65))
(assert
 (let (($x3968 (not z_5_66)))
 (=> x_5_p $x3968)))
(assert
 (let (($x3959 (not z_5_67)))
 (=> x_5_p $x3959)))
(assert
 (let (($x3950 (not z_5_68)))
 (=> x_5_p $x3950)))
(assert
 (=> x_5_p z_5_69))
(assert
 (let (($x3932 (not z_5_70)))
 (=> x_5_p $x3932)))
(assert
 (=> x_5_p z_5_71))
(assert
...
(assert
 (=> x_5_p z_5_78))
(assert
 (let (($x3853 (not z_5_79)))
 (=> x_5_p $x3853)))
(assert
 (=> x_5_p z_5_80))
(assert
 (let (($x3835 (not z_5_81)))
 (=> x_5_p $x3835)))
(assert
 (let (($x3826 (not z_5_82)))
 (=> x_5_p $x3826)))
(assert
 (let (($x3817 (not z_5_83)))
 (=> x_5_p $x3817)))
(assert
 (=> x_5_p z_5_84))
(assert
...
(assert
 (=> x_5_p z_5_90))
(assert
 (let (($x3746 (not z_5_91)))
 (=> x_5_p $x3746)))
(assert
 (let (($x3737 (not z_5_92)))
 (=> x_5_p $x3737)))
(assert
 (let (($x3728 (not z_5_93)))
 (=> x_5_p $x3728)))
(assert
 (let (($x3719 (not z_5_94)))
 (=> x_5_p $x3719)))
(assert
 (let (($x3710 (not z_5_95)))
 (=> x_5_p $x3710)))
(assert
 (=> x_5_p z_5_96))
(assert
...
(assert
 (=> x_5_p z_5_102))
(assert
 (let (($x3639 (not z_5_103)))
 (=> x_5_p $x3639)))
(assert
 (let (($x3630 (not z_5_104)))
 (=> x_5_p $x3630)))
(assert
 (let (($x3621 (not z_5_105)))
 (=> x_5_p $x3621)))
(assert
 (=> x_5_p z_5_106))
(assert
...
(assert
 (=> x_5_p z_5_110))
(assert
 (let (($x3568 (not z_5_111)))
 (=> x_5_p $x3568)))
(assert
 (=> x_5_p z_5_112))
(assert
 (let (($x3550 (not z_5_113)))
 (=> x_5_p $x3550)))
(assert
 (=> x_5_p z_5_114))
(assert
...
(assert
 (=> x_5_p z_5_117))
(assert
 (let (($x3505 (not z_5_118)))
 (=> x_5_p $x3505)))
(assert
 (=> x_5_p z_5_119))
(assert
 (let (($x3488 (not z_5_120)))
 (=> x_5_p $x3488)))
(assert
 (let (($x3479 (not z_5_121)))
 (=> x_5_p $x3479)))
(assert
 (=> x_5_p z_5_122))
(assert
 (let (($x3461 (not z_5_123)))
 (=> x_5_p $x3461)))
(assert
 (let (($x3452 (not z_5_124)))
 (=> x_5_p $x3452)))
(assert
 (let (($x3443 (not z_5_125)))
 (=> x_5_p $x3443)))
(assert
 (=> x_5_p z_5_126))
(assert
...
(assert
 (=> x_5_p z_5_128))
(assert
 (let (($x3408 (not z_5_129)))
 (=> x_5_p $x3408)))
(assert
 (let (($x3399 (not z_5_130)))
 (=> x_5_p $x3399)))
(assert
 (=> x_5_p z_5_131))
(assert
 (=> x_5_p z_5_132))
(assert
 (let (($x3372 (not z_5_133)))
 (=> x_5_p $x3372)))
(assert
 (let (($x3363 (not z_5_134)))
 (=> x_5_p $x3363)))
(assert
 (let (($x3354 (not z_5_135)))
 (=> x_5_p $x3354)))
(assert
 (=> x_5_p z_5_136))
(assert
 (let (($x3336 (not z_5_137)))
 (=> x_5_p $x3336)))
(assert
 (=> x_5_p z_5_138))
(assert
...
(assert
 (=> x_5_p z_5_140))
(assert
 (let (($x3300 (not z_5_141)))
 (=> x_5_p $x3300)))
(assert
 (=> x_5_p z_5_142))
(assert
 (let (($x3282 (not z_5_143)))
 (=> x_5_p $x3282)))
(assert
 (let (($x3273 (not z_5_144)))
 (=> x_5_p $x3273)))
(assert
 (=> x_5_p z_5_145))
(assert
 (let (($x3255 (not z_5_146)))
 (=> x_5_p $x3255)))
(assert
 (let (($x3246 (not z_5_147)))
 (=> x_5_p $x3246)))
(assert
 (let (($x3237 (not z_5_148)))
 (=> x_5_p $x3237)))
(assert
 (let (($x3228 (not z_5_149)))
 (=> x_5_p $x3228)))
(assert
 (let (($x3219 (not z_5_150)))
 (=> x_5_p $x3219)))
(assert
 (let (($x3210 (not z_5_151)))
 (=> x_5_p $x3210)))
(assert
 (=> x_5_p z_5_152))
(assert
 (let (($x3192 (not z_5_153)))
 (=> x_5_p $x3192)))
(assert
 (let (($x3183 (not z_5_154)))
 (=> x_5_p $x3183)))
(assert
 (=> x_5_p z_5_155))
(assert
 (let (($x3165 (not z_5_156)))
 (=> x_5_p $x3165)))
(assert
 (let (($x3156 (not z_5_157)))
 (=> x_5_p $x3156)))
(assert
 (let (($x3147 (not z_5_158)))
 (=> x_5_p $x3147)))
(assert
 (=> x_5_p z_5_159))
(assert
 (let (($x3129 (not z_5_160)))
 (=> x_5_p $x3129)))
(assert
 (=> x_5_p z_5_161))
(assert
 (let (($x3111 (not z_5_162)))
 (=> x_5_p $x3111)))
(assert
 (let (($x3102 (not z_5_163)))
 (=> x_5_p $x3102)))
(assert
 (let (($x3093 (not z_5_164)))
 (=> x_5_p $x3093)))
(assert
 (let (($x3084 (not z_5_165)))
 (=> x_5_p $x3084)))
(assert
 (let (($x3075 (not z_5_166)))
 (=> x_5_p $x3075)))
(assert
 (=> x_5_p z_5_167))
(assert
 (let (($x3057 (not z_5_168)))
 (=> x_5_p $x3057)))
(assert
 (let (($x3048 (not z_5_169)))
 (=> x_5_p $x3048)))
(assert
 (=> x_5_p z_5_170))
(assert
...
(assert
 (=> x_5_p z_5_174))
(assert
 (let (($x2994 (not z_5_175)))
 (=> x_5_p $x2994)))
(assert
 (=> x_5_p z_5_176))
(assert
 (let (($x2976 (not z_5_177)))
 (=> x_5_p $x2976)))
(assert
 (let (($x2967 (not z_5_178)))
 (=> x_5_p $x2967)))
(assert
 (let (($x4258 (not z_5_0)))
 (=> x_5_q $x4258)))
...
(assert
 ...
 (=> x_5_q $x3457)))
(assert
 (let (($x3404 (not z_5_16)))
 (=> x_5_q $x3404)))
(assert
 (let (($x3350 (not z_5_17)))
 (=> x_5_q $x3350)))
(assert
 (let (($x3296 (not z_5_18)))
 (=> x_5_q $x3296)))
(assert
 (let (($x3242 (not z_5_19)))
 (=> x_5_q $x3242)))
(assert
 (let (($x3188 (not z_5_20)))
 (=> x_5_q $x3188)))
(assert
 (let (($x3134 (not z_5_21)))
 (=> x_5_q $x3134)))
(assert
 (let (($x3080 (not z_5_22)))
 (=> x_5_q $x3080)))
(assert
 (let (($x3026 (not z_5_23)))
 (=> x_5_q $x3026)))
...
(assert
 ...
 (=> x_5_q $x2918)))
(assert
 (let (($x2864 (not z_5_26)))
 (=> x_5_q $x2864)))
(assert
 (let (($x2810 (not z_5_27)))
 (=> x_5_q $x2810)))
(assert
 (let (($x2756 (not z_5_28)))
 (=> x_5_q $x2756)))
(assert
 (let (($x2702 (not z_5_29)))
 (=> x_5_q $x2702)))
...
(assert
 ...
 (=> x_5_q $x4244)))
(assert
 (let (($x4235 (not z_5_36)))
 (=> x_5_q $x4235)))
(assert
 (let (($x4226 (not z_5_37)))
 (=> x_5_q $x4226)))
(assert
 (let (($x4217 (not z_5_38)))
 (=> x_5_q $x4217)))
(assert
 ...
 (=> x_5_q $x4209)))
(assert
 (let (($x4200 (not z_5_40)))
 (=> x_5_q $x4200)))
(assert
 (let (($x4191 (not z_5_41)))
 (=> x_5_q $x4191)))
(assert
 (let (($x4182 (not z_5_42)))
 (=> x_5_q $x4182)))
(assert
 (let (($x4173 (not z_5_43)))
 (=> x_5_q $x4173)))
(assert
 (let (($x4164 (not z_5_44)))
 (=> x_5_q $x4164)))
(assert
 (let (($x4155 (not z_5_45)))
 (=> x_5_q $x4155)))
(assert
 (let (($x4146 (not z_5_46)))
 (=> x_5_q $x4146)))
(assert
 (let (($x4137 (not z_5_47)))
 (=> x_5_q $x4137)))
(assert
 (let (($x4129 (not z_5_48)))
 (=> x_5_q $x4129)))
(assert
 (let (($x4120 (not z_5_49)))
 (=> x_5_q $x4120)))
(assert
 (let (($x4111 (not z_5_50)))
 (=> x_5_q $x4111)))
(assert
 (let (($x4102 (not z_5_51)))
 (=> x_5_q $x4102)))
(assert
 (let (($x4093 (not z_5_52)))
 (=> x_5_q $x4093)))
...
(assert
 ...
 (=> x_5_q $x4066)))
(assert
 (let (($x4057 (not z_5_56)))
 (=> x_5_q $x4057)))
(assert
 (let (($x4048 (not z_5_57)))
 (=> x_5_q $x4048)))
(assert
 (let (($x4039 (not z_5_58)))
 (=> x_5_q $x4039)))
...
(assert
 ...
 (=> x_5_q $x3995)))
(assert
 (let (($x3986 (not z_5_64)))
 (=> x_5_q $x3986)))
(assert
 (let (($x3977 (not z_5_65)))
 (=> x_5_q $x3977)))
(assert
 (let (($x3968 (not z_5_66)))
 (=> x_5_q $x3968)))
...
(assert
 ...
 (=> x_5_q $x3950)))
(assert
 (let (($x3941 (not z_5_69)))
 (=> x_5_q $x3941)))
(assert
 (let (($x3932 (not z_5_70)))
 (=> x_5_q $x3932)))
(assert
 (let (($x3924 (not z_5_71)))
 (=> x_5_q $x3924)))
(assert
 (let (($x3915 (not z_5_72)))
 (=> x_5_q $x3915)))
(assert
 (let (($x3906 (not z_5_73)))
 (=> x_5_q $x3906)))
(assert
 (let (($x3897 (not z_5_74)))
 (=> x_5_q $x3897)))
(assert
 (let (($x3888 (not z_5_75)))
 (=> x_5_q $x3888)))
(assert
 (let (($x3879 (not z_5_76)))
 (=> x_5_q $x3879)))
(assert
 (let (($x3870 (not z_5_77)))
 (=> x_5_q $x3870)))
(assert
 (let (($x3861 (not z_5_78)))
 (=> x_5_q $x3861)))
(assert
 (let (($x3853 (not z_5_79)))
 (=> x_5_q $x3853)))
(assert
 (let (($x3844 (not z_5_80)))
 (=> x_5_q $x3844)))
(assert
 (let (($x3835 (not z_5_81)))
 (=> x_5_q $x3835)))
...
(assert
 ...
 (=> x_5_q $x3817)))
(assert
 (let (($x3808 (not z_5_84)))
 (=> x_5_q $x3808)))
(assert
 (let (($x3799 (not z_5_85)))
 (=> x_5_q $x3799)))
(assert
 (let (($x3790 (not z_5_86)))
 (=> x_5_q $x3790)))
(assert
 (let (($x3781 (not z_5_87)))
 (=> x_5_q $x3781)))
(assert
 (let (($x3772 (not z_5_88)))
 (=> x_5_q $x3772)))
(assert
 (let (($x3763 (not z_5_89)))
 (=> x_5_q $x3763)))
(assert
 (let (($x3755 (not z_5_90)))
 (=> x_5_q $x3755)))
(assert
 (let (($x3746 (not z_5_91)))
 (=> x_5_q $x3746)))
...
(assert
 (=> x_5_q z_5_100))
(assert
 (let (($x3657 (not z_5_101)))
 (=> x_5_q $x3657)))
(assert
 (let (($x3648 (not z_5_102)))
 (=> x_5_q $x3648)))
(assert
 (let (($x3639 (not z_5_103)))
 (=> x_5_q $x3639)))
...
(assert
 (=> x_5_q z_5_107))
(assert
 (let (($x3595 (not z_5_108)))
 (=> x_5_q $x3595)))
(assert
 (let (($x3586 (not z_5_109)))
 (=> x_5_q $x3586)))
(assert
 (let (($x3577 (not z_5_110)))
 (=> x_5_q $x3577)))
(assert
 (let (($x3568 (not z_5_111)))
 (=> x_5_q $x3568)))
(assert
 (let (($x3559 (not z_5_112)))
 (=> x_5_q $x3559)))
(assert
 (=> x_5_q z_5_113))
(assert
...
(assert
 (=> x_5_q z_5_125))
(assert
 (let (($x3434 (not z_5_126)))
 (=> x_5_q $x3434)))
(assert
 (let (($x3425 (not z_5_127)))
 (=> x_5_q $x3425)))
(assert
 (let (($x3416 (not z_5_128)))
 (=> x_5_q $x3416)))
(assert
 (let (($x3408 (not z_5_129)))
 (=> x_5_q $x3408)))
...
(assert
 ...
 (=> x_5_q $x3048)))
(assert
 (let (($x3039 (not z_5_170)))
 (=> x_5_q $x3039)))
(assert
 (let (($x3030 (not z_5_171)))
 (=> x_5_q $x3030)))
(assert
 (=> x_5_q z_5_172))
(assert
 (let (($x3012 (not z_5_173)))
 (=> x_5_q $x3012)))
(assert
 (let (($x3003 (not z_5_174)))
 (=> x_5_q $x3003)))
(assert
 (=> x_5_q z_5_175))
(assert
 (let (($x2985 (not z_5_176)))
 (=> x_5_q $x2985)))
(assert
 (=> x_5_q z_5_177))
(assert
...
(assert
 ...
 (let (($x2944 (not x_5_F)))
 (let (($x2949 (not x_5_G)))
 (and $x2949 $x2944 $x2943 $x2940 $x2935 $x2934 $x2931 $x2926))))))))))
(check-sat)
