...
(assert
 (= z_0_625 (=> z_1_625 z_2_625)))
(assert
 (= z_0_626 (=> z_1_626 z_2_626)))
(assert
 (= z_0_627 (=> z_1_627 z_2_627)))
(assert
 (= z_0_628 (=> z_1_628 z_2_628)))
(assert
 (= z_0_629 (=> z_1_629 z_2_629)))
(assert
 (= z_0_630 (=> z_1_630 z_2_630)))
(assert
 (= z_0_631 (=> z_1_631 z_2_631)))
(assert
 (= z_0_632 (=> z_1_632 z_2_632)))
(assert
 (= z_0_633 (=> z_1_633 z_2_633)))
(assert
 (= z_0_634 (=> z_1_634 z_2_634)))
(assert
 (= z_0_635 (=> z_1_635 z_2_635)))
(assert
 (= z_0_636 (=> z_1_636 z_2_636)))
(assert
 (= z_0_637 (=> z_1_637 z_2_637)))
(assert
 (= z_0_638 (=> z_1_638 z_2_638)))
(assert
 (= z_0_639 (=> z_1_639 z_2_639)))
(assert
 (= z_0_640 (=> z_1_640 z_2_640)))
(assert
 (= z_0_641 (=> z_1_641 z_2_641)))
(assert
 (= z_0_642 (=> z_1_642 z_2_642)))
(assert
 (= z_0_643 (=> z_1_643 z_2_643)))
(assert
 (= z_0_644 (=> z_1_644 z_2_644)))
(assert
 (= z_0_645 (=> z_1_645 z_2_645)))
(assert
 (= z_0_646 (=> z_1_646 z_2_646)))
(assert
 (= z_0_647 (=> z_1_647 z_2_647)))
(assert
 (= z_0_648 (=> z_1_648 z_2_648)))
(assert
 (= z_0_649 (=> z_1_649 z_2_649)))
(assert
 (= z_0_650 (=> z_1_650 z_2_650)))
(assert
 (= z_0_651 (=> z_1_651 z_2_651)))
(assert
 (= z_0_652 (=> z_1_652 z_2_652)))
(assert
 (= z_0_653 (=> z_1_653 z_2_653)))
(assert
 (= z_0_654 (=> z_1_654 z_2_654)))
(assert
 (= z_0_655 (=> z_1_655 z_2_655)))
(assert
 (= z_0_656 (=> z_1_656 z_2_656)))
(assert
 (= z_0_657 (=> z_1_657 z_2_657)))
(assert
 (= z_0_658 (=> z_1_658 z_2_658)))
(assert
 (= z_0_659 (=> z_1_659 z_2_659)))
(assert
 (= z_0_660 (=> z_1_660 z_2_660)))
(assert
 (= z_0_661 (=> z_1_661 z_2_661)))
(assert
 (= z_0_662 (=> z_1_662 z_2_662)))
(assert
 (= z_0_663 (=> z_1_663 z_2_663)))
(assert
 (= z_0_664 (=> z_1_664 z_2_664)))
(assert
 (= z_0_665 (=> z_1_665 z_2_665)))
(assert
 (= z_0_666 (=> z_1_666 z_2_666)))
(assert
 (= z_0_667 (=> z_1_667 z_2_667)))
(assert
 (= z_0_668 (=> z_1_668 z_2_668)))
(assert
 (= z_0_669 (=> z_1_669 z_2_669)))
(assert
 (= z_0_670 (=> z_1_670 z_2_670)))
(assert
 (= z_0_671 (=> z_1_671 z_2_671)))
(assert
 (= z_0_672 (=> z_1_672 z_2_672)))
(assert
 (= z_0_673 (=> z_1_673 z_2_673)))
(assert
 (= z_0_674 (=> z_1_674 z_2_674)))
(assert
 (= z_0_675 (=> z_1_675 z_2_675)))
(assert
 (= z_0_676 (=> z_1_676 z_2_676)))
(assert
 (= z_0_677 (=> z_1_677 z_2_677)))
(assert
 (= z_0_678 (=> z_1_678 z_2_678)))
(assert
 (= z_0_679 (=> z_1_679 z_2_679)))
(assert
 (= z_0_680 (=> z_1_680 z_2_680)))
(assert
 (= z_0_681 (=> z_1_681 z_2_681)))
(assert
 (= z_0_682 (=> z_1_682 z_2_682)))
(assert
 (= z_0_683 (=> z_1_683 z_2_683)))
(assert
 (= z_0_684 (=> z_1_684 z_2_684)))
(assert
 (= z_0_685 (=> z_1_685 z_2_685)))
(assert
 (= z_0_686 (=> z_1_686 z_2_686)))
(assert
 (= z_0_687 (=> z_1_687 z_2_687)))
(assert
 (= z_0_688 (=> z_1_688 z_2_688)))
(assert
 (= z_0_689 (=> z_1_689 z_2_689)))
(assert
 (= z_0_690 (=> z_1_690 z_2_690)))
(assert
 (= z_0_691 (=> z_1_691 z_2_691)))
(assert
 (= z_0_692 (=> z_1_692 z_2_692)))
(assert
 (= z_0_693 (=> z_1_693 z_2_693)))
(assert
 (= z_0_694 (=> z_1_694 z_2_694)))
(assert
 (= z_0_695 (=> z_1_695 z_2_695)))
(assert
 (= z_0_696 (=> z_1_696 z_2_696)))
(assert
 (= z_0_697 (=> z_1_697 z_2_697)))
(assert
 (= z_0_698 (=> z_1_698 z_2_698)))
(assert
 (= z_0_699 (=> z_1_699 z_2_699)))
(assert
 (= z_0_700 (=> z_1_700 z_2_700)))
(assert
 (= z_0_701 (=> z_1_701 z_2_701)))
(assert
 (= z_0_702 (=> z_1_702 z_2_702)))
(assert
 (= z_0_703 (=> z_1_703 z_2_703)))
(assert
 (= z_0_704 (=> z_1_704 z_2_704)))
(assert
 (= z_0_705 (=> z_1_705 z_2_705)))
(assert
 (= z_0_706 (=> z_1_706 z_2_706)))
(assert
 (= z_0_707 (=> z_1_707 z_2_707)))
(assert
 (= z_0_708 (=> z_1_708 z_2_708)))
(assert
 (= z_0_709 (=> z_1_709 z_2_709)))
(assert
 (= z_0_710 (=> z_1_710 z_2_710)))
(assert
 (= z_0_711 (=> z_1_711 z_2_711)))
(assert
 (= z_0_712 (=> z_1_712 z_2_712)))
(assert
 (= z_0_713 (=> z_1_713 z_2_713)))
(assert
 (= z_0_714 (=> z_1_714 z_2_714)))
(assert
 (= z_0_715 (=> z_1_715 z_2_715)))
(assert
 (= z_0_716 (=> z_1_716 z_2_716)))
(assert
 (= z_0_717 (=> z_1_717 z_2_717)))
(assert
 (= z_0_718 (=> z_1_718 z_2_718)))
(assert
 (= z_0_719 (=> z_1_719 z_2_719)))
(assert
 (= z_0_720 (=> z_1_720 z_2_720)))
(assert
 (= z_0_721 (=> z_1_721 z_2_721)))
(assert
 (= z_0_722 (=> z_1_722 z_2_722)))
(assert
 (= z_0_723 (=> z_1_723 z_2_723)))
(assert
 (= z_0_724 (=> z_1_724 z_2_724)))
(assert
 (= z_0_725 (=> z_1_725 z_2_725)))
(assert
 (= z_0_726 (=> z_1_726 z_2_726)))
(assert
 (= z_0_727 (=> z_1_727 z_2_727)))
(assert
 (= z_0_728 (=> z_1_728 z_2_728)))
(assert
 (= z_0_729 (=> z_1_729 z_2_729)))
(assert
 (= z_0_730 (=> z_1_730 z_2_730)))
(assert
 (= z_0_731 (=> z_1_731 z_2_731)))
(assert
 (= z_0_732 (=> z_1_732 z_2_732)))
(assert
 (= z_0_733 (=> z_1_733 z_2_733)))
(assert
 (= z_0_734 (=> z_1_734 z_2_734)))
(assert
 (= z_0_735 (=> z_1_735 z_2_735)))
(assert
 (= z_0_736 (=> z_1_736 z_2_736)))
(assert
 (= z_0_737 (=> z_1_737 z_2_737)))
(assert
 (= z_0_738 (=> z_1_738 z_2_738)))
(assert
 (= z_0_739 (=> z_1_739 z_2_739)))
(assert
 (= z_0_740 (=> z_1_740 z_2_740)))
(assert
 (= z_0_741 (=> z_1_741 z_2_741)))
(assert
 (= z_0_742 (=> z_1_742 z_2_742)))
(assert
 (= z_0_743 (=> z_1_743 z_2_743)))
(assert
 (= z_0_744 (=> z_1_744 z_2_744)))
(assert
 (= z_0_745 (=> z_1_745 z_2_745)))
(assert
 (= z_0_746 (=> z_1_746 z_2_746)))
(assert
 (= z_0_747 (=> z_1_747 z_2_747)))
(assert
 (= z_0_748 (=> z_1_748 z_2_748)))
(assert
 (= z_0_749 (=> z_1_749 z_2_749)))
(assert
 (= z_0_750 (=> z_1_750 z_2_750)))
(assert
 (= z_0_751 (=> z_1_751 z_2_751)))
(assert
 (= z_0_752 (=> z_1_752 z_2_752)))
(assert
 (= z_0_753 (=> z_1_753 z_2_753)))
(assert
 (= z_0_754 (=> z_1_754 z_2_754)))
(assert
 (= z_0_755 (=> z_1_755 z_2_755)))
(assert
 (= z_0_756 (=> z_1_756 z_2_756)))
(assert
 (= z_0_757 (=> z_1_757 z_2_757)))
(assert
 (= z_0_758 (=> z_1_758 z_2_758)))
(assert
 (= z_0_759 (=> z_1_759 z_2_759)))
(assert
 (= z_0_760 (=> z_1_760 z_2_760)))
(assert
 (= z_0_761 (=> z_1_761 z_2_761)))
(assert
 (= z_0_762 (=> z_1_762 z_2_762)))
(assert
 (= z_0_763 (=> z_1_763 z_2_763)))
(assert
 (= z_0_764 (=> z_1_764 z_2_764)))
(assert
 (= z_0_765 (=> z_1_765 z_2_765)))
(assert
 (= z_0_766 (=> z_1_766 z_2_766)))
(assert
 (= z_0_767 (=> z_1_767 z_2_767)))
(assert
 (= z_0_768 (=> z_1_768 z_2_768)))
(assert
 (= z_0_769 (=> z_1_769 z_2_769)))
(assert
 (= z_0_770 (=> z_1_770 z_2_770)))
(assert
 (= z_0_771 (=> z_1_771 z_2_771)))
(assert
 (= z_0_772 (=> z_1_772 z_2_772)))
(assert
 (= z_0_773 (=> z_1_773 z_2_773)))
(assert
 (= z_0_774 (=> z_1_774 z_2_774)))
(assert
 (= z_0_775 (=> z_1_775 z_2_775)))
(assert
 (= z_0_776 (=> z_1_776 z_2_776)))
(assert
 (= z_0_777 (=> z_1_777 z_2_777)))
(assert
 (= z_0_778 (=> z_1_778 z_2_778)))
(assert
 (= z_0_779 (=> z_1_779 z_2_779)))
(assert
 (= z_0_780 (=> z_1_780 z_2_780)))
(assert
 (= z_0_781 (=> z_1_781 z_2_781)))
(assert
 (= z_0_782 (=> z_1_782 z_2_782)))
(assert
 (= z_0_783 (=> z_1_783 z_2_783)))
(assert
 (= z_0_784 (=> z_1_784 z_2_784)))
(assert
 (= z_0_785 (=> z_1_785 z_2_785)))
(assert
 (= z_0_786 (=> z_1_786 z_2_786)))
(assert
 (= z_0_787 (=> z_1_787 z_2_787)))
(assert
 (= z_0_788 (=> z_1_788 z_2_788)))
(assert
 (= z_0_789 (=> z_1_789 z_2_789)))
(assert
 (= z_0_790 (=> z_1_790 z_2_790)))
(assert
 (= z_0_791 (=> z_1_791 z_2_791)))
(assert
 (= z_0_792 (=> z_1_792 z_2_792)))
(assert
 (= z_0_793 (=> z_1_793 z_2_793)))
(assert
 (= z_0_794 (=> z_1_794 z_2_794)))
(assert
 (= z_0_795 (=> z_1_795 z_2_795)))
(assert
 (= z_0_796 (=> z_1_796 z_2_796)))
(assert
 (= z_0_797 (=> z_1_797 z_2_797)))
(assert
 (= z_0_798 (=> z_1_798 z_2_798)))
(assert
 (= z_0_799 (=> z_1_799 z_2_799)))
(assert
 (= z_0_800 (=> z_1_800 z_2_800)))
(assert
 (= z_0_801 (=> z_1_801 z_2_801)))
(assert
 (= z_0_802 (=> z_1_802 z_2_802)))
(assert
 (= z_0_803 (=> z_1_803 z_2_803)))
(assert
 (= z_0_804 (=> z_1_804 z_2_804)))
(assert
 (= z_0_805 (=> z_1_805 z_2_805)))
(assert
 (= z_0_806 (=> z_1_806 z_2_806)))
(assert
 (= z_0_807 (=> z_1_807 z_2_807)))
(assert
 (= z_0_808 (=> z_1_808 z_2_808)))
(assert
 (= z_0_809 (=> z_1_809 z_2_809)))
(assert
 (= z_0_810 (=> z_1_810 z_2_810)))
(assert
 (= z_0_811 (=> z_1_811 z_2_811)))
(assert
 (= z_0_812 (=> z_1_812 z_2_812)))
(assert
 (= z_0_813 (=> z_1_813 z_2_813)))
(assert
 (= z_0_814 (=> z_1_814 z_2_814)))
(assert
 (= z_0_815 (=> z_1_815 z_2_815)))
(assert
 (= z_0_816 (=> z_1_816 z_2_816)))
(assert
 (= z_0_817 (=> z_1_817 z_2_817)))
(assert
 (= z_0_818 (=> z_1_818 z_2_818)))
(assert
 (= z_0_819 (=> z_1_819 z_2_819)))
(assert
 (= z_0_820 (=> z_1_820 z_2_820)))
(assert
 (= z_0_821 (=> z_1_821 z_2_821)))
(assert
 (= z_0_822 (=> z_1_822 z_2_822)))
(assert
 (= z_0_823 (=> z_1_823 z_2_823)))
(assert
 (= z_0_824 (=> z_1_824 z_2_824)))
(assert
 (= z_0_825 (=> z_1_825 z_2_825)))
(assert
 (= z_0_826 (=> z_1_826 z_2_826)))
(assert
 (= z_0_827 (=> z_1_827 z_2_827)))
(assert
 (= z_0_828 (=> z_1_828 z_2_828)))
(assert
 (= z_0_829 (=> z_1_829 z_2_829)))
(assert
 (= z_0_830 (=> z_1_830 z_2_830)))
(assert
 (= z_0_831 (=> z_1_831 z_2_831)))
(assert
 (= z_0_832 (=> z_1_832 z_2_832)))
(assert
 (= z_0_833 (=> z_1_833 z_2_833)))
(assert
 (= z_0_834 (=> z_1_834 z_2_834)))
(assert
 (= z_0_835 (=> z_1_835 z_2_835)))
(assert
 (= z_0_836 (=> z_1_836 z_2_836)))
(assert
 (= z_0_837 (=> z_1_837 z_2_837)))
(assert
 (= z_0_838 (=> z_1_838 z_2_838)))
(assert
 (= z_0_839 (=> z_1_839 z_2_839)))
(assert
 (= z_0_840 (=> z_1_840 z_2_840)))
(assert
 (= z_0_841 (=> z_1_841 z_2_841)))
(assert
 (= z_0_842 (=> z_1_842 z_2_842)))
(assert
 (= z_0_843 (=> z_1_843 z_2_843)))
(assert
 (= z_0_844 (=> z_1_844 z_2_844)))
(assert
 (= z_0_845 (=> z_1_845 z_2_845)))
(assert
 (= z_0_846 (=> z_1_846 z_2_846)))
(assert
 (= z_0_847 (=> z_1_847 z_2_847)))
(assert
 (= z_0_848 (=> z_1_848 z_2_848)))
(assert
 (= z_0_849 (=> z_1_849 z_2_849)))
(assert
 (= z_0_850 (=> z_1_850 z_2_850)))
(assert
 (= z_0_851 (=> z_1_851 z_2_851)))
(assert
 (= z_0_852 (=> z_1_852 z_2_852)))
(assert
 (= z_0_853 (=> z_1_853 z_2_853)))
(assert
 (= z_0_854 (=> z_1_854 z_2_854)))
(assert
 (= z_0_855 (=> z_1_855 z_2_855)))
(assert
 (= z_0_856 (=> z_1_856 z_2_856)))
(assert
 (= z_0_857 (=> z_1_857 z_2_857)))
(assert
 (= z_0_858 (=> z_1_858 z_2_858)))
(assert
 (= z_0_859 (=> z_1_859 z_2_859)))
(assert
 (= z_0_860 (=> z_1_860 z_2_860)))
(assert
 (= z_0_861 (=> z_1_861 z_2_861)))
(assert
 (= z_0_862 (=> z_1_862 z_2_862)))
(assert
 (= z_0_863 (=> z_1_863 z_2_863)))
(assert
 (= z_0_864 (=> z_1_864 z_2_864)))
(assert
 (= z_0_865 (=> z_1_865 z_2_865)))
(assert
 (= z_0_866 (=> z_1_866 z_2_866)))
(assert
 (= z_0_867 (=> z_1_867 z_2_867)))
(assert
 (= z_0_868 (=> z_1_868 z_2_868)))
(assert
 (= z_0_869 (=> z_1_869 z_2_869)))
(assert
 (= z_0_870 (=> z_1_870 z_2_870)))
(assert
 (= z_0_871 (=> z_1_871 z_2_871)))
(assert
 (= z_0_872 (=> z_1_872 z_2_872)))
(assert
 (= z_0_873 (=> z_1_873 z_2_873)))
(assert
 (= z_0_874 (=> z_1_874 z_2_874)))
(assert
 (= z_0_875 (=> z_1_875 z_2_875)))
(assert
 (= z_0_876 (=> z_1_876 z_2_876)))
(assert
 (= z_0_877 (=> z_1_877 z_2_877)))
(assert
 (= z_0_878 (=> z_1_878 z_2_878)))
(assert
 (= z_0_879 (=> z_1_879 z_2_879)))
(assert
 (= z_0_880 (=> z_1_880 z_2_880)))
(assert
 (= z_0_881 (=> z_1_881 z_2_881)))
(assert
 (= z_0_882 (=> z_1_882 z_2_882)))
(assert
 (= z_0_883 (=> z_1_883 z_2_883)))
(assert
 (= z_0_884 (=> z_1_884 z_2_884)))
(assert
 (= z_0_885 (=> z_1_885 z_2_885)))
(assert
 (= z_0_886 (=> z_1_886 z_2_886)))
(assert
 (= z_0_887 (=> z_1_887 z_2_887)))
(assert
 (= z_0_888 (=> z_1_888 z_2_888)))
(assert
 (= z_0_889 (=> z_1_889 z_2_889)))
(assert
 (= z_0_890 (=> z_1_890 z_2_890)))
(assert
 (= z_0_891 (=> z_1_891 z_2_891)))
(assert
 (= z_0_892 (=> z_1_892 z_2_892)))
(assert
 (= z_0_893 (=> z_1_893 z_2_893)))
(assert
 (= z_0_894 (=> z_1_894 z_2_894)))
(assert
 (= z_0_895 (=> z_1_895 z_2_895)))
(assert
 (= z_0_896 (=> z_1_896 z_2_896)))
(assert
 (= z_0_897 (=> z_1_897 z_2_897)))
(assert
 (= z_0_898 (=> z_1_898 z_2_898)))
(assert
 (= z_0_899 (=> z_1_899 z_2_899)))
(assert
 (= z_0_900 (=> z_1_900 z_2_900)))
(assert
 (= z_0_901 (=> z_1_901 z_2_901)))
(assert
 (= z_0_902 (=> z_1_902 z_2_902)))
(assert
 (= z_0_903 (=> z_1_903 z_2_903)))
(assert
 (= z_0_904 (=> z_1_904 z_2_904)))
(assert
 (= z_0_905 (=> z_1_905 z_2_905)))
(assert
 (= z_0_906 (=> z_1_906 z_2_906)))
(assert
 (= z_0_907 (=> z_1_907 z_2_907)))
(assert
 (= z_0_908 (=> z_1_908 z_2_908)))
(assert
 (= z_0_909 (=> z_1_909 z_2_909)))
(assert
 (= z_0_910 (=> z_1_910 z_2_910)))
(assert
 (= z_0_911 (=> z_1_911 z_2_911)))
(assert
 (= z_0_912 (=> z_1_912 z_2_912)))
(assert
 (= z_0_913 (=> z_1_913 z_2_913)))
(assert
 (= z_0_914 (=> z_1_914 z_2_914)))
(assert
 (= z_0_915 (=> z_1_915 z_2_915)))
(assert
 (= z_0_916 (=> z_1_916 z_2_916)))
(assert
 (= z_0_917 (=> z_1_917 z_2_917)))
(assert
 (= z_0_918 (=> z_1_918 z_2_918)))
(assert
 (= z_0_919 (=> z_1_919 z_2_919)))
(assert
 (= z_0_920 (=> z_1_920 z_2_920)))
(assert
 (= z_0_921 (=> z_1_921 z_2_921)))
(assert
 (= z_0_922 (=> z_1_922 z_2_922)))
(assert
 (= z_0_923 (=> z_1_923 z_2_923)))
(assert
 (= z_0_924 (=> z_1_924 z_2_924)))
(assert
 (= z_0_925 (=> z_1_925 z_2_925)))
(assert
 (= z_0_926 (=> z_1_926 z_2_926)))
(assert
 (= z_0_927 (=> z_1_927 z_2_927)))
(assert
 (= z_0_928 (=> z_1_928 z_2_928)))
(assert
 (= z_0_929 (=> z_1_929 z_2_929)))
(assert
 (= z_0_930 (=> z_1_930 z_2_930)))
(assert
 (= z_0_931 (=> z_1_931 z_2_931)))
(assert
 (= z_0_932 (=> z_1_932 z_2_932)))
(assert
 (= z_0_933 (=> z_1_933 z_2_933)))
(assert
 (= z_0_934 (=> z_1_934 z_2_934)))
(assert
 (= z_0_935 (=> z_1_935 z_2_935)))
(assert
 (= z_0_936 (=> z_1_936 z_2_936)))
(assert
 (= z_0_937 (=> z_1_937 z_2_937)))
(assert
 (= z_0_938 (=> z_1_938 z_2_938)))
(assert
 (= z_0_939 (=> z_1_939 z_2_939)))
(assert
 (= z_0_940 (=> z_1_940 z_2_940)))
(assert
 (= z_0_941 (=> z_1_941 z_2_941)))
(assert
 (= z_0_942 (=> z_1_942 z_2_942)))
(assert
 (= z_0_943 (=> z_1_943 z_2_943)))
(assert
 (= z_0_944 (=> z_1_944 z_2_944)))
(assert
 (= z_0_945 (=> z_1_945 z_2_945)))
(assert
 (= z_0_946 (=> z_1_946 z_2_946)))
(assert
 (= z_0_947 (=> z_1_947 z_2_947)))
(assert
 (= z_0_948 (=> z_1_948 z_2_948)))
(assert
 (= z_0_949 (=> z_1_949 z_2_949)))
(assert
 (= z_0_950 (=> z_1_950 z_2_950)))
(assert
 (= z_0_951 (=> z_1_951 z_2_951)))
(assert
 (= z_0_952 (=> z_1_952 z_2_952)))
(assert
 (= z_0_953 (=> z_1_953 z_2_953)))
(assert
 (= z_0_954 (=> z_1_954 z_2_954)))
(assert
 (= z_0_955 (=> z_1_955 z_2_955)))
(assert
 (= z_0_956 (=> z_1_956 z_2_956)))
(assert
 (= z_0_957 (=> z_1_957 z_2_957)))
(assert
 (= z_0_958 (=> z_1_958 z_2_958)))
(assert
 (= z_0_959 (=> z_1_959 z_2_959)))
(assert
 (= z_0_960 (=> z_1_960 z_2_960)))
(assert
 (= z_0_961 (=> z_1_961 z_2_961)))
(assert
 (= z_0_962 (=> z_1_962 z_2_962)))
(assert
 (= z_0_963 (=> z_1_963 z_2_963)))
(assert
 (= z_0_964 (=> z_1_964 z_2_964)))
(assert
 (= z_0_965 (=> z_1_965 z_2_965)))
(assert
 (= z_0_966 (=> z_1_966 z_2_966)))
(assert
 (= z_0_967 (=> z_1_967 z_2_967)))
(assert
 (= z_0_968 (=> z_1_968 z_2_968)))
(assert
 (= z_0_969 (=> z_1_969 z_2_969)))
(assert
 (= z_0_970 (=> z_1_970 z_2_970)))
(assert
 (= z_0_971 (=> z_1_971 z_2_971)))
(assert
 (= z_0_972 (=> z_1_972 z_2_972)))
(assert
 (= z_0_973 (=> z_1_973 z_2_973)))
(assert
 (= z_0_974 (=> z_1_974 z_2_974)))
(assert
 (= z_0_975 (=> z_1_975 z_2_975)))
(assert
 (= z_0_976 (=> z_1_976 z_2_976)))
(assert
 (= z_0_977 (=> z_1_977 z_2_977)))
(assert
 (= z_0_978 (=> z_1_978 z_2_978)))
(assert
 (= z_0_979 (=> z_1_979 z_2_979)))
(assert
 (= z_0_980 (=> z_1_980 z_2_980)))
(assert
 (= z_0_981 (=> z_1_981 z_2_981)))
(assert
 (= z_0_982 (=> z_1_982 z_2_982)))
(assert
 (= z_0_983 (=> z_1_983 z_2_983)))
(assert
 (= z_0_984 (=> z_1_984 z_2_984)))
(assert
 (= z_0_985 (=> z_1_985 z_2_985)))
(assert
 (= z_0_986 (=> z_1_986 z_2_986)))
(assert
 (= z_0_987 (=> z_1_987 z_2_987)))
(assert
 (= z_0_988 (=> z_1_988 z_2_988)))
(assert
 (= z_0_989 (=> z_1_989 z_2_989)))
(assert
 (= z_0_990 (=> z_1_990 z_2_990)))
(assert
 (= z_0_991 (=> z_1_991 z_2_991)))
(assert
 (= z_0_992 (=> z_1_992 z_2_992)))
(assert
 (= z_0_993 (=> z_1_993 z_2_993)))
(assert
 (= z_0_994 (=> z_1_994 z_2_994)))
(assert
 (= z_0_995 (=> z_1_995 z_2_995)))
(assert
 (= z_0_996 (=> z_1_996 z_2_996)))
(assert
 (= z_0_997 (=> z_1_997 z_2_997)))
(assert
 (= z_0_998 (=> z_1_998 z_2_998)))
(assert
 (= z_0_999 (=> z_1_999 z_2_999)))
(assert
 (= z_0_1000 (=> z_1_1000 z_2_1000)))
(assert
 (= z_0_1001 (=> z_1_1001 z_2_1001)))
(assert
 (= z_0_1002 (=> z_1_1002 z_2_1002)))
(assert
 (= z_0_1003 (=> z_1_1003 z_2_1003)))
(assert
 (= z_0_1004 (=> z_1_1004 z_2_1004)))
(assert
 (= z_0_1005 (=> z_1_1005 z_2_1005)))
(assert
 (= z_0_1006 (=> z_1_1006 z_2_1006)))
(assert
 (= z_0_1007 (=> z_1_1007 z_2_1007)))
(assert
 (= z_0_1008 (=> z_1_1008 z_2_1008)))
(assert
 (= z_0_1009 (=> z_1_1009 z_2_1009)))
(assert
 (= z_0_1010 (=> z_1_1010 z_2_1010)))
(assert
 (= z_0_1011 (=> z_1_1011 z_2_1011)))
(assert
 (= z_0_1012 (=> z_1_1012 z_2_1012)))
(assert
 (= z_0_1013 (=> z_1_1013 z_2_1013)))
(assert
 (= z_0_1014 (=> z_1_1014 z_2_1014)))
(assert
 (= z_0_1015 (=> z_1_1015 z_2_1015)))
(assert
 (= z_0_1016 (=> z_1_1016 z_2_1016)))
(assert
 (= z_0_1017 (=> z_1_1017 z_2_1017)))
(assert
 (= z_0_1018 (=> z_1_1018 z_2_1018)))
(assert
 (= z_0_1019 (=> z_1_1019 z_2_1019)))
(assert
 (= z_0_1020 (=> z_1_1020 z_2_1020)))
(assert
 (= z_0_1021 (=> z_1_1021 z_2_1021)))
(assert
 (= z_0_1022 (=> z_1_1022 z_2_1022)))
(assert
 (= z_0_1023 (=> z_1_1023 z_2_1023)))
(assert
 (= z_0_1024 (=> z_1_1024 z_2_1024)))
(assert
 (= z_0_1025 (=> z_1_1025 z_2_1025)))
(assert
 (= z_0_1026 (=> z_1_1026 z_2_1026)))
(assert
 (= z_0_1027 (=> z_1_1027 z_2_1027)))
(assert
 (= z_0_1028 (=> z_1_1028 z_2_1028)))
(assert
 (= z_0_1029 (=> z_1_1029 z_2_1029)))
(assert
 (= z_0_1030 (=> z_1_1030 z_2_1030)))
(assert
 (= z_0_1031 (=> z_1_1031 z_2_1031)))
(assert
 (= z_0_1032 (=> z_1_1032 z_2_1032)))
(assert
 (= z_0_1033 (=> z_1_1033 z_2_1033)))
(assert
 (= z_0_1034 (=> z_1_1034 z_2_1034)))
(assert
 (= z_0_1035 (=> z_1_1035 z_2_1035)))
(assert
 (= z_0_1036 (=> z_1_1036 z_2_1036)))
(assert
 (= z_0_1037 (=> z_1_1037 z_2_1037)))
(assert
 (= z_0_1038 (=> z_1_1038 z_2_1038)))
(assert
 (= z_0_1039 (=> z_1_1039 z_2_1039)))
(assert
 (= z_0_1040 (=> z_1_1040 z_2_1040)))
(assert
 (= z_0_1041 (=> z_1_1041 z_2_1041)))
(assert
 (= z_0_1042 (=> z_1_1042 z_2_1042)))
(assert
 (= z_0_1043 (=> z_1_1043 z_2_1043)))
(assert
 (= z_0_1044 (=> z_1_1044 z_2_1044)))
(assert
 (= z_0_1045 (=> z_1_1045 z_2_1045)))
(assert
 (= z_0_1046 (=> z_1_1046 z_2_1046)))
(assert
 (= z_0_1047 (=> z_1_1047 z_2_1047)))
(assert
 (= z_0_1048 (=> z_1_1048 z_2_1048)))
(assert
 (= z_0_1049 (=> z_1_1049 z_2_1049)))
(assert
 (= z_0_1050 (=> z_1_1050 z_2_1050)))
(assert
 (= z_0_1051 (=> z_1_1051 z_2_1051)))
(assert
 (= z_0_1052 (=> z_1_1052 z_2_1052)))
(assert
 (= z_0_1053 (=> z_1_1053 z_2_1053)))
(assert
 (= z_0_1054 (=> z_1_1054 z_2_1054)))
(assert
 (= z_0_1055 (=> z_1_1055 z_2_1055)))
(assert
 (= z_0_1056 (=> z_1_1056 z_2_1056)))
(assert
 (= z_0_1057 (=> z_1_1057 z_2_1057)))
(assert
 (= z_0_1058 (=> z_1_1058 z_2_1058)))
(assert
 (= z_0_1059 (=> z_1_1059 z_2_1059)))
(assert
 (= z_0_1060 (=> z_1_1060 z_2_1060)))
(assert
 (= z_0_1061 (=> z_1_1061 z_2_1061)))
(assert
 (= z_0_1062 (=> z_1_1062 z_2_1062)))
(assert
 (= z_0_1063 (=> z_1_1063 z_2_1063)))
(assert
 (= z_0_1064 (=> z_1_1064 z_2_1064)))
(assert
 (= z_0_1065 (=> z_1_1065 z_2_1065)))
(assert
 (= z_0_1066 (=> z_1_1066 z_2_1066)))
(assert
 (= z_0_1067 (=> z_1_1067 z_2_1067)))
(assert
 (= z_0_1068 (=> z_1_1068 z_2_1068)))
(assert
 (= z_0_1069 (=> z_1_1069 z_2_1069)))
(assert
 (= z_0_1070 (=> z_1_1070 z_2_1070)))
(assert
 (= z_0_1071 (=> z_1_1071 z_2_1071)))
(assert
 (= z_0_1072 (=> z_1_1072 z_2_1072)))
(assert
 (= z_0_1073 (=> z_1_1073 z_2_1073)))
(assert
 (= z_0_1074 (=> z_1_1074 z_2_1074)))
(assert
 (= z_0_1075 (=> z_1_1075 z_2_1075)))
(assert
 (= z_0_1076 (=> z_1_1076 z_2_1076)))
(assert
 (= z_0_1077 (=> z_1_1077 z_2_1077)))
(assert
 (= z_0_1078 (=> z_1_1078 z_2_1078)))
(assert
 (= z_0_1079 (=> z_1_1079 z_2_1079)))
(assert
 (= z_0_1080 (=> z_1_1080 z_2_1080)))
(assert
 (= z_0_1081 (=> z_1_1081 z_2_1081)))
(assert
 (= z_0_1082 (=> z_1_1082 z_2_1082)))
(assert
 (= z_0_1083 (=> z_1_1083 z_2_1083)))
(assert
 (= z_0_1084 (=> z_1_1084 z_2_1084)))
(assert
 (= z_0_1085 (=> z_1_1085 z_2_1085)))
(assert
 (= z_0_1086 (=> z_1_1086 z_2_1086)))
(assert
 (= z_0_1087 (=> z_1_1087 z_2_1087)))
(assert
 (= z_0_1088 (=> z_1_1088 z_2_1088)))
(assert
 (= z_0_1089 (=> z_1_1089 z_2_1089)))
(assert
 (= z_0_1090 (=> z_1_1090 z_2_1090)))
(assert
 (= z_0_1091 (=> z_1_1091 z_2_1091)))
(assert
 (= z_0_1092 (=> z_1_1092 z_2_1092)))
(assert
 (= z_0_1093 (=> z_1_1093 z_2_1093)))
(assert
 (= z_0_1094 (=> z_1_1094 z_2_1094)))
(assert
 (= z_0_1095 (=> z_1_1095 z_2_1095)))
(assert
 (= z_0_1096 (=> z_1_1096 z_2_1096)))
(assert
 (= z_0_1097 (=> z_1_1097 z_2_1097)))
(assert
 (= z_0_1098 (=> z_1_1098 z_2_1098)))
(assert
 (= z_0_1099 (=> z_1_1099 z_2_1099)))
(assert
 (= z_0_1100 (=> z_1_1100 z_2_1100)))
(assert
 (= z_0_1101 (=> z_1_1101 z_2_1101)))
(assert
 (= z_0_1102 (=> z_1_1102 z_2_1102)))
(assert
 (= z_0_1103 (=> z_1_1103 z_2_1103)))
(assert
 (= z_0_1104 (=> z_1_1104 z_2_1104)))
(assert
 (= z_0_1105 (=> z_1_1105 z_2_1105)))
(assert
 (= z_0_1106 (=> z_1_1106 z_2_1106)))
(assert
 (= z_0_1107 (=> z_1_1107 z_2_1107)))
(assert
 (= z_0_1108 (=> z_1_1108 z_2_1108)))
(assert
 (= z_0_1109 (=> z_1_1109 z_2_1109)))
(assert
 (= z_0_1110 (=> z_1_1110 z_2_1110)))
(assert
 (= z_0_1111 (=> z_1_1111 z_2_1111)))
(assert
 (= z_0_1112 (=> z_1_1112 z_2_1112)))
(assert
 (= z_0_1113 (=> z_1_1113 z_2_1113)))
(assert
 (= z_0_1114 (=> z_1_1114 z_2_1114)))
(assert
 (= z_0_1115 (=> z_1_1115 z_2_1115)))
(assert
 (= z_0_1116 (=> z_1_1116 z_2_1116)))
(assert
 (= z_0_1117 (=> z_1_1117 z_2_1117)))
(assert
 (= z_0_1118 (=> z_1_1118 z_2_1118)))
(assert
 (= z_0_1119 (=> z_1_1119 z_2_1119)))
(assert
 (= z_0_1120 (=> z_1_1120 z_2_1120)))
(assert
 (= z_0_1121 (=> z_1_1121 z_2_1121)))
(assert
 (= z_0_1122 (=> z_1_1122 z_2_1122)))
(assert
 (= z_0_1123 (=> z_1_1123 z_2_1123)))
(assert
 (= z_0_1124 (=> z_1_1124 z_2_1124)))
(assert
 (= z_0_1125 (=> z_1_1125 z_2_1125)))
(assert
 (= z_0_1126 (=> z_1_1126 z_2_1126)))
(assert
 (= z_0_1127 (=> z_1_1127 z_2_1127)))
(assert
 (= z_0_1128 (=> z_1_1128 z_2_1128)))
(assert
 (= z_0_1129 (=> z_1_1129 z_2_1129)))
(assert
 (= z_0_1130 (=> z_1_1130 z_2_1130)))
(assert
 (= z_0_1131 (=> z_1_1131 z_2_1131)))
(assert
 (= z_0_1132 (=> z_1_1132 z_2_1132)))
(assert
 (= z_0_1133 (=> z_1_1133 z_2_1133)))
(assert
 (= z_0_1134 (=> z_1_1134 z_2_1134)))
(assert
 (= z_0_1135 (=> z_1_1135 z_2_1135)))
(assert
 (= z_0_1136 (=> z_1_1136 z_2_1136)))
(assert
 (= z_0_1137 (=> z_1_1137 z_2_1137)))
(assert
 (= z_0_1138 (=> z_1_1138 z_2_1138)))
(assert
 (= z_0_1139 (=> z_1_1139 z_2_1139)))
(assert
 (= z_0_1140 (=> z_1_1140 z_2_1140)))
(assert
 (= z_0_1141 (=> z_1_1141 z_2_1141)))
(assert
 (= z_0_1142 (=> z_1_1142 z_2_1142)))
(assert
 (= z_0_1143 (=> z_1_1143 z_2_1143)))
(assert
 (= z_0_1144 (=> z_1_1144 z_2_1144)))
(assert
 (= z_0_1145 (=> z_1_1145 z_2_1145)))
(assert
 (= z_0_1146 (=> z_1_1146 z_2_1146)))
(assert
 (= z_0_1147 (=> z_1_1147 z_2_1147)))
(assert
 (= z_0_1148 (=> z_1_1148 z_2_1148)))
(assert
 (= z_0_1149 (=> z_1_1149 z_2_1149)))
(assert
 (= z_0_1150 (=> z_1_1150 z_2_1150)))
(assert
 (= z_0_1151 (=> z_1_1151 z_2_1151)))
(assert
 (= z_0_1152 (=> z_1_1152 z_2_1152)))
(assert
 (= z_0_1153 (=> z_1_1153 z_2_1153)))
(assert
 (= z_0_1154 (=> z_1_1154 z_2_1154)))
(assert
 (= z_0_1155 (=> z_1_1155 z_2_1155)))
(assert
 (= z_0_1156 (=> z_1_1156 z_2_1156)))
(assert
 (= z_0_1157 (=> z_1_1157 z_2_1157)))
(assert
 (= z_0_1158 (=> z_1_1158 z_2_1158)))
(assert
 (= z_0_1159 (=> z_1_1159 z_2_1159)))
(assert
 (= z_0_1160 (=> z_1_1160 z_2_1160)))
(assert
 (= z_0_1161 (=> z_1_1161 z_2_1161)))
(assert
 (= z_0_1162 (=> z_1_1162 z_2_1162)))
(assert
 (= z_0_1163 (=> z_1_1163 z_2_1163)))
(assert
 (= z_0_1164 (=> z_1_1164 z_2_1164)))
(assert
 (= z_0_1165 (=> z_1_1165 z_2_1165)))
(assert
 (= z_0_1166 (=> z_1_1166 z_2_1166)))
(assert
 (= z_0_1167 (=> z_1_1167 z_2_1167)))
(assert
 (= z_0_1168 (=> z_1_1168 z_2_1168)))
(assert
 (= z_0_1169 (=> z_1_1169 z_2_1169)))
(assert
 (= z_0_1170 (=> z_1_1170 z_2_1170)))
(assert
 (= z_0_1171 (=> z_1_1171 z_2_1171)))
(assert
 (= z_0_1172 (=> z_1_1172 z_2_1172)))
(assert
 (= z_0_1173 (=> z_1_1173 z_2_1173)))
(assert
 (= z_0_1174 (=> z_1_1174 z_2_1174)))
(assert
 (= z_0_1175 (=> z_1_1175 z_2_1175)))
(assert
 (= z_0_1176 (=> z_1_1176 z_2_1176)))
(assert
 (= z_0_1177 (=> z_1_1177 z_2_1177)))
(assert
 (= z_0_1178 (=> z_1_1178 z_2_1178)))
(assert
 (= z_0_1179 (=> z_1_1179 z_2_1179)))
(assert
 (= z_0_1180 (=> z_1_1180 z_2_1180)))
(assert
 (= z_0_1181 (=> z_1_1181 z_2_1181)))
(assert
 (= z_0_1182 (=> z_1_1182 z_2_1182)))
(assert
 (= z_0_1183 (=> z_1_1183 z_2_1183)))
(assert
...
(assert
 ...
 (= z_3_1002 $x21072)))
(assert
 (= z_3_1003 (not z_4_1003)))
(assert
 (= z_3_1004 (not z_4_1004)))
(assert
 (= z_3_1005 (not z_4_1005)))
(assert
 (= z_3_1006 (not z_4_1006)))
(assert
 (= z_3_1007 (not z_4_1007)))
(assert
 (= z_3_1008 (not z_4_1008)))
(assert
 (let (($x21107 (not z_4_1009)))
 (= z_3_1009 $x21107)))
(assert
 (= z_3_1010 (not z_4_1010)))
(assert
 (= z_3_1011 (not z_4_1011)))
(assert
 (= z_3_1012 (not z_4_1012)))
(assert
 (let (($x21127 (not z_4_1013)))
 (= z_3_1013 $x21127)))
(assert
 (= z_3_1014 (not z_4_1014)))
(assert
 (= z_3_1015 (not z_4_1015)))
(assert
...
(assert
 ...
 (= z_3_1018 $x21152)))
(assert
 (= z_3_1019 (not z_4_1019)))
(assert
 (= z_3_1020 (not z_4_1020)))
(assert
 (let (($x21167 (not z_4_1021)))
 (= z_3_1021 $x21167)))
(assert
 (= z_3_1022 (not z_4_1022)))
(assert
 (= z_3_1023 (not z_4_1023)))
(assert
 (= z_3_1024 (not z_4_1024)))
(assert
 (let (($x21187 (not z_4_1025)))
 (= z_3_1025 $x21187)))
(assert
 (= z_3_1026 (not z_4_1026)))
(assert
 (let (($x21197 (not z_4_1027)))
 (= z_3_1027 $x21197)))
(assert
 (= z_3_1028 (not z_4_1028)))
(assert
 (= z_3_1029 (not z_4_1029)))
(assert
...
(assert
 ...
 (= z_3_1036 $x21242)))
(assert
 (= z_3_1037 (not z_4_1037)))
(assert
 (= z_3_1038 (not z_4_1038)))
(assert
 (= z_3_1039 (not z_4_1039)))
(assert
...
(assert
 ...
 (= z_3_1041 $x21267)))
(assert
 (= z_3_1042 (not z_4_1042)))
(assert
 (= z_3_1043 (not z_4_1043)))
(assert
...
(assert
 ...
 (= z_3_1046 $x21292)))
(assert
 (= z_3_1047 (not z_4_1047)))
(assert
 (= z_3_1048 (not z_4_1048)))
(assert
 (= z_3_1049 (not z_4_1049)))
(assert
 (let (($x21312 (not z_4_1050)))
 (= z_3_1050 $x21312)))
(assert
 (= z_3_1051 (not z_4_1051)))
(assert
 (= z_3_1052 (not z_4_1052)))
(assert
 (= z_3_1053 (not z_4_1053)))
(assert
 (= z_3_1054 (not z_4_1054)))
(assert
 (= z_3_1055 (not z_4_1055)))
(assert
 (= z_3_1056 (not z_4_1056)))
(assert
...
(assert
 ...
 (= z_3_1062 $x21372)))
(assert
 (= z_3_1063 (not z_4_1063)))
(assert
 (= z_3_1064 (not z_4_1064)))
(assert
 (= z_3_1065 (not z_4_1065)))
(assert
 (let (($x21392 (not z_4_1066)))
 (= z_3_1066 $x21392)))
(assert
 (= z_3_1067 (not z_4_1067)))
(assert
 (let (($x21402 (not z_4_1068)))
 (= z_3_1068 $x21402)))
(assert
 (= z_3_1069 (not z_4_1069)))
(assert
 (= z_3_1070 (not z_4_1070)))
(assert
 (let (($x21417 (not z_4_1071)))
 (= z_3_1071 $x21417)))
(assert
 (= z_3_1072 (not z_4_1072)))
(assert
 (= z_3_1073 (not z_4_1073)))
(assert
...
(assert
 ...
 (= z_3_1078 $x21452)))
(assert
 (= z_3_1079 (not z_4_1079)))
(assert
 (= z_3_1080 (not z_4_1080)))
(assert
...
(assert
 ...
 (= z_3_1082 $x21472)))
(assert
 (= z_3_1083 (not z_4_1083)))
(assert
 (= z_3_1084 (not z_4_1084)))
(assert
 (= z_3_1085 (not z_4_1085)))
(assert
 (let (($x21492 (not z_4_1086)))
 (= z_3_1086 $x21492)))
(assert
 (= z_3_1087 (not z_4_1087)))
(assert
...
(assert
 ...
 (= z_3_1089 $x21507)))
(assert
 (= z_3_1090 (not z_4_1090)))
(assert
 (= z_3_1091 (not z_4_1091)))
(assert
...
(assert
 ...
 (= z_3_1093 $x21527)))
(assert
 (= z_3_1094 (not z_4_1094)))
(assert
 (let (($x21537 (not z_4_1095)))
 (= z_3_1095 $x21537)))
(assert
 (= z_3_1096 (not z_4_1096)))
(assert
...
(assert
 ...
 (= z_3_1098 $x21552)))
(assert
 (= z_3_1099 (not z_4_1099)))
(assert
 (let (($x21562 (not z_4_1100)))
 (= z_3_1100 $x21562)))
(assert
 (= z_3_1101 (not z_4_1101)))
(assert
 (= z_3_1102 (not z_4_1102)))
(assert
...
(assert
 ...
 (= z_3_1106 $x21592)))
(assert
 (= z_3_1107 (not z_4_1107)))
(assert
 (= z_3_1108 (not z_4_1108)))
(assert
...
(assert
 ...
 (= z_3_1110 $x21612)))
(assert
 (= z_3_1111 (not z_4_1111)))
(assert
 (= z_3_1112 (not z_4_1112)))
(assert
 (= z_3_1113 (not z_4_1113)))
(assert
 (= z_3_1114 (not z_4_1114)))
(assert
 (let (($x21637 (not z_4_1115)))
 (= z_3_1115 $x21637)))
(assert
 (= z_3_1116 (not z_4_1116)))
(assert
...
(assert
 ...
 (= z_3_1120 $x21662)))
(assert
 (= z_3_1121 (not z_4_1121)))
(assert
 (= z_3_1122 (not z_4_1122)))
(assert
 (= z_3_1123 (not z_4_1123)))
(assert
 (let (($x21682 (not z_4_1124)))
 (= z_3_1124 $x21682)))
(assert
 (= z_3_1125 (not z_4_1125)))
(assert
 (let (($x21692 (not z_4_1126)))
 (= z_3_1126 $x21692)))
(assert
 (= z_3_1127 (not z_4_1127)))
(assert
...
(assert
 ...
 (= z_3_1137 $x21747)))
(assert
 (= z_3_1138 (not z_4_1138)))
(assert
 (= z_3_1139 (not z_4_1139)))
(assert
 (let (($x21762 (not z_4_1140)))
 (= z_3_1140 $x21762)))
(assert
 (= z_3_1141 (not z_4_1141)))
(assert
 (= z_3_1142 (not z_4_1142)))
(assert
...
(assert
 ...
 (= z_3_1148 $x21802)))
(assert
 (= z_3_1149 (not z_4_1149)))
(assert
 (let (($x21812 (not z_4_1150)))
 (= z_3_1150 $x21812)))
(assert
 (= z_3_1151 (not z_4_1151)))
(assert
 (= z_3_1152 (not z_4_1152)))
(assert
 (let (($x21827 (not z_4_1153)))
 (= z_3_1153 $x21827)))
(assert
 (= z_3_1154 (not z_4_1154)))
(assert
...
(assert
 ...
 (= z_3_1156 $x21842)))
(assert
 (= z_3_1157 (not z_4_1157)))
(assert
 (= z_3_1158 (not z_4_1158)))
(assert
 (= z_3_1159 (not z_4_1159)))
(assert
...
(assert
 ...
 (= z_3_1163 $x21877)))
(assert
 (= z_3_1164 (not z_4_1164)))
(assert
 (= z_3_1165 (not z_4_1165)))
(assert
 (= z_3_1166 (not z_4_1166)))
(assert
 (= z_3_1167 (not z_4_1167)))
(assert
 (= z_3_1168 (not z_4_1168)))
(assert
 (let (($x21907 (not z_4_1169)))
 (= z_3_1169 $x21907)))
(assert
 (= z_3_1170 (not z_4_1170)))
(assert
 (= z_3_1171 (not z_4_1171)))
(assert
...
(assert
 ...
 (= z_3_1174 $x21932)))
(assert
 (= z_3_1175 (not z_4_1175)))
(assert
 (let (($x21942 (not z_4_1176)))
 (= z_3_1176 $x21942)))
(assert
 (= z_3_1177 (not z_4_1177)))
(assert
 (= z_3_1178 (not z_4_1178)))
(assert
 (let (($x21957 (not z_4_1179)))
 (= z_3_1179 $x21957)))
(assert
 (= z_3_1180 (not z_4_1180)))
(assert
