...
(assert
 (= z_1_17 (not z_3_17)))
(assert
 (let (($x12971 (not z_3_18)))
 (= z_1_18 $x12971)))
(assert
 (let (($x12976 (not z_3_19)))
 (= z_1_19 $x12976)))
(assert
 (let (($x12981 (not z_3_20)))
 (= z_1_20 $x12981)))
(assert
 (let (($x12986 (not z_3_21)))
 (= z_1_21 $x12986)))
(assert
 (= z_1_22 (not z_3_22)))
(assert
 (let (($x12996 (not z_3_23)))
 (= z_1_23 $x12996)))
(assert
 (let (($x13001 (not z_3_24)))
 (= z_1_24 $x13001)))
(assert
 (= z_1_25 (not z_3_25)))
(assert
 (= z_1_26 (not z_3_26)))
(assert
 (let (($x13016 (not z_3_27)))
 (= z_1_27 $x13016)))
(assert
 (= z_1_28 (not z_3_28)))
(assert
 (let (($x13026 (not z_3_29)))
 (= z_1_29 $x13026)))
(assert
 (let (($x13031 (not z_3_30)))
 (= z_1_30 $x13031)))
(assert
 (= z_1_31 (not z_3_31)))
(assert
 (let (($x13041 (not z_3_32)))
 (= z_1_32 $x13041)))
(assert
 (let (($x13046 (not z_3_33)))
 (= z_1_33 $x13046)))
(assert
 (= z_1_34 (not z_3_34)))
(assert
...
(assert
 (= z_1_40 (not z_3_40)))
(assert
 (let (($x13086 (not z_3_41)))
 (= z_1_41 $x13086)))
(assert
 (= z_1_42 (not z_3_42)))
(assert
 (let (($x13096 (not z_3_43)))
 (= z_1_43 $x13096)))
(assert
 (= z_1_44 (not z_3_44)))
(assert
 (let (($x13106 (not z_3_45)))
 (= z_1_45 $x13106)))
(assert
 (= z_1_46 (not z_3_46)))
(assert
...
(assert
 (= z_1_60 (not z_3_60)))
(assert
 (let (($x13186 (not z_3_61)))
 (= z_1_61 $x13186)))
(assert
 (let (($x13191 (not z_3_62)))
 (= z_1_62 $x13191)))
(assert
 (= z_1_63 (not z_3_63)))
(assert
 (let (($x13201 (not z_3_64)))
 (= z_1_64 $x13201)))
(assert
 (= z_1_65 (not z_3_65)))
(assert
...
(assert
 (= z_1_69 (not z_3_69)))
(assert
 (let (($x13231 (not z_3_70)))
 (= z_1_70 $x13231)))
(assert
 (let (($x13236 (not z_3_71)))
 (= z_1_71 $x13236)))
(assert
 (let (($x13241 (not z_3_72)))
 (= z_1_72 $x13241)))
(assert
 (= z_1_73 (not z_3_73)))
(assert
 (let (($x13251 (not z_3_74)))
 (= z_1_74 $x13251)))
(assert
 (= z_1_75 (not z_3_75)))
(assert
 (let (($x13261 (not z_3_76)))
 (= z_1_76 $x13261)))
(assert
 (= z_1_77 (not z_3_77)))
(assert
 (let (($x13271 (not z_3_78)))
 (= z_1_78 $x13271)))
(assert
 (let (($x13276 (not z_3_79)))
 (= z_1_79 $x13276)))
(assert
 (let (($x13281 (not z_3_80)))
 (= z_1_80 $x13281)))
(assert
 (= z_1_81 (not z_3_81)))
(assert
 (let (($x13291 (not z_3_82)))
 (= z_1_82 $x13291)))
(assert
 (= z_1_83 (not z_3_83)))
(assert
 (= z_1_84 (not z_3_84)))
(assert
 (let (($x13306 (not z_3_85)))
 (= z_1_85 $x13306)))
(assert
 (= z_1_86 (not z_3_86)))
(assert
 (let (($x13316 (not z_3_87)))
 (= z_1_87 $x13316)))
(assert
 (= z_1_88 (not z_3_88)))
(assert
 (let (($x13326 (not z_3_89)))
 (= z_1_89 $x13326)))
(assert
 (= z_1_90 (not z_3_90)))
(assert
 (let (($x13336 (not z_3_91)))
 (= z_1_91 $x13336)))
(assert
 (let (($x13341 (not z_3_92)))
 (= z_1_92 $x13341)))
(assert
 (= z_1_93 (not z_3_93)))
(assert
 (let (($x13351 (not z_3_94)))
 (= z_1_94 $x13351)))
(assert
 (let (($x13356 (not z_3_95)))
 (= z_1_95 $x13356)))
(assert
 (= z_1_96 (not z_3_96)))
(assert
 (let (($x13366 (not z_3_97)))
 (= z_1_97 $x13366)))
(assert
 (let (($x13371 (not z_3_98)))
 (= z_1_98 $x13371)))
(assert
 (= z_1_99 (not z_3_99)))
(assert
...
(assert
 (= z_1_101 (not z_3_101)))
(assert
 (let (($x13391 (not z_3_102)))
 (= z_1_102 $x13391)))
(assert
 (let (($x13396 (not z_3_103)))
 (= z_1_103 $x13396)))
(assert
 (let (($x13401 (not z_3_104)))
 (= z_1_104 $x13401)))
(assert
 (let (($x13406 (not z_3_105)))
 (= z_1_105 $x13406)))
(assert
 (= z_1_106 (not z_3_106)))
(assert
...
(assert
 (= z_1_109 (not z_3_109)))
(assert
 (let (($x13431 (not z_3_110)))
 (= z_1_110 $x13431)))
(assert
 (let (($x13436 (not z_3_111)))
 (= z_1_111 $x13436)))
(assert
 (= z_1_112 (not z_3_112)))
(assert
 (let (($x13446 (not z_3_113)))
 (= z_1_113 $x13446)))
(assert
 (let (($x13451 (not z_3_114)))
 (= z_1_114 $x13451)))
(assert
 (= z_1_115 (not z_3_115)))
(assert
 (let (($x13461 (not z_3_116)))
 (= z_1_116 $x13461)))
(assert
 (= z_1_117 (not z_3_117)))
(assert
 (= z_1_118 (not z_3_118)))
(assert
 (let (($x13476 (not z_3_119)))
 (= z_1_119 $x13476)))
(assert
 (= z_1_120 (not z_3_120)))
(assert
 (let (($x13486 (not z_3_121)))
 (= z_1_121 $x13486)))
(assert
 (let (($x13491 (not z_3_122)))
 (= z_1_122 $x13491)))
(assert
 (= z_1_123 (not z_3_123)))
(assert
 (let (($x13501 (not z_3_124)))
 (= z_1_124 $x13501)))
(assert
 (let (($x13506 (not z_3_125)))
 (= z_1_125 $x13506)))
(assert
 (= z_1_126 (not z_3_126)))
(assert
...
(assert
 (= z_1_130 (not z_3_130)))
(assert
 (let (($x13536 (not z_3_131)))
 (= z_1_131 $x13536)))
(assert
 (= z_1_132 (not z_3_132)))
(assert
 (let (($x13546 (not z_3_133)))
 (= z_1_133 $x13546)))
(assert
 (let (($x13551 (not z_3_134)))
 (= z_1_134 $x13551)))
(assert
 (let (($x13556 (not z_3_135)))
 (= z_1_135 $x13556)))
(assert
 (= z_1_136 (not z_3_136)))
(assert
 (let (($x13566 (not z_3_137)))
 (= z_1_137 $x13566)))
(assert
 (let (($x13571 (not z_3_138)))
 (= z_1_138 $x13571)))
(assert
 (let (($x13576 (not z_3_139)))
 (= z_1_139 $x13576)))
(assert
 (let (($x13581 (not z_3_140)))
 (= z_1_140 $x13581)))
(assert
 (= z_1_141 (not z_3_141)))
(assert
 (= z_1_142 (not z_3_142)))
(assert
 (let (($x13596 (not z_3_143)))
 (= z_1_143 $x13596)))
(assert
 (let (($x13601 (not z_3_144)))
 (= z_1_144 $x13601)))
(assert
 (let (($x13606 (not z_3_145)))
 (= z_1_145 $x13606)))
(assert
 (= z_1_146 (not z_3_146)))
(assert
 (= z_1_147 (not z_3_147)))
(assert
 (let (($x13621 (not z_3_148)))
 (= z_1_148 $x13621)))
(assert
 (let (($x13626 (not z_3_149)))
 (= z_1_149 $x13626)))
(assert
 (let (($x13631 (not z_3_150)))
 (= z_1_150 $x13631)))
(assert
 (= z_1_151 (not z_3_151)))
(assert
 (let (($x13641 (not z_3_152)))
 (= z_1_152 $x13641)))
(assert
 (= z_1_153 (not z_3_153)))
(assert
 (= z_1_154 (not z_3_154)))
(assert
 (let (($x13656 (not z_3_155)))
 (= z_1_155 $x13656)))
(assert
 (let (($x13661 (not z_3_156)))
 (= z_1_156 $x13661)))
(assert
 (let (($x13666 (not z_3_157)))
 (= z_1_157 $x13666)))
(assert
 (let (($x13671 (not z_3_158)))
 (= z_1_158 $x13671)))
(assert
 (= z_1_159 (not z_3_159)))
(assert
 (let (($x13681 (not z_3_160)))
 (= z_1_160 $x13681)))
(assert
 (let (($x13686 (not z_3_161)))
 (= z_1_161 $x13686)))
(assert
 (= z_1_162 (not z_3_162)))
(assert
...
(assert
 (let (($x13723 (not x_3_->)))
 (let (($x13721 (not x_3_U)))
 (let (($x13719 (not x_3_v)))
 (let (($x13717 (not x_3_&)))
 (let (($x13715 (not x_3_X)))
 (let (($x13713 (not x_3_!)))
 (let (($x13711 (not x_3_F)))
 (let (($x13709 (not x_3_G)))
 (and $x13709 $x13711 $x13713 $x13715 $x13717 $x13719 $x13721 $x13723))))))))))
(check-sat)
