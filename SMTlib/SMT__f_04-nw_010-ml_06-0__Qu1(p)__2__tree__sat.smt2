...
(assert
 (let (($x49 (not x_0_G)))
 (let (($x43 (not x_0_F)))
 (let (($x1179 (or $x43 $x49)))
 (let (($x37 (not x_0_X)))
 (let (($x1178 (or $x37 $x49)))
 (let (($x1177 (or $x37 $x43)))
 (let (($x31 (not x_0_!)))
 (let (($x1176 (or $x31 $x49)))
 (let (($x1175 (or $x31 $x43)))
 (let (($x1174 (or $x31 $x37)))
 (and $x1174 $x1175 $x1176 $x1177 $x1178 $x1179))))))))))))
(assert
 z_1_0_0)
(assert
 (not z_1_0_1))
