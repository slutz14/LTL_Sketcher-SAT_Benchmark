...
(assert
 (= z_1_12 (not z_2_12)))
(assert
 (let (($x1978 (not z_2_13)))
 (= z_1_13 $x1978)))
(assert
 (let (($x1983 (not z_2_14)))
 (= z_1_14 $x1983)))
(assert
 (let (($x1988 (not z_2_15)))
 (= z_1_15 $x1988)))
(assert
 (let (($x1993 (not z_2_16)))
 (= z_1_16 $x1993)))
(assert
 (= z_1_17 (not z_2_17)))
(assert
 (let (($x2003 (not z_2_18)))
 (= z_1_18 $x2003)))
(assert
 (let (($x2008 (not z_2_19)))
 (= z_1_19 $x2008)))
(assert
 (= z_1_20 (not z_2_20)))
(assert
 (= z_1_21 (not z_2_21)))
(assert
 (let (($x2023 (not z_2_22)))
 (= z_1_22 $x2023)))
(assert
 (let (($x2028 (not z_2_23)))
 (= z_1_23 $x2028)))
(assert
 (= z_1_24 (not z_2_24)))
(assert
 (let (($x2038 (not z_2_25)))
 (= z_1_25 $x2038)))
(assert
 (= z_1_26 (not z_2_26)))
(assert
...
(assert
 (= z_1_28 (not z_2_28)))
(assert
 (let (($x2058 (not z_2_29)))
 (= z_1_29 $x2058)))
(assert
 (= z_1_30 (not z_2_30)))
(assert
 (let (($x2068 (not z_2_31)))
 (= z_1_31 $x2068)))
(assert
 (let (($x2073 (not z_2_32)))
 (= z_1_32 $x2073)))
(assert
 (let (($x2078 (not z_2_33)))
 (= z_1_33 $x2078)))
(assert
 (= z_1_34 (not z_2_34)))
(assert
...
(assert
 (= z_1_36 (not z_2_36)))
(assert
 (let (($x2098 (not z_2_37)))
 (= z_1_37 $x2098)))
(assert
 (let (($x2103 (not z_2_38)))
 (= z_1_38 $x2103)))
(assert
 (= z_1_39 (not z_2_39)))
(assert
 (= z_1_40 (not z_2_40)))
(assert
 (let (($x2118 (not z_2_41)))
 (= z_1_41 $x2118)))
(assert
 (let (($x2123 (not z_2_42)))
 (= z_1_42 $x2123)))
(assert
 (let (($x2128 (not z_2_43)))
 (= z_1_43 $x2128)))
(assert
 (= z_1_44 (not z_2_44)))
(assert
 (= z_1_45 (not z_2_45)))
(assert
 (let (($x2143 (not z_2_46)))
 (= z_1_46 $x2143)))
(assert
 (let (($x2148 (not z_2_47)))
 (= z_1_47 $x2148)))
(assert
 (let (($x2153 (not z_2_48)))
 (= z_1_48 $x2153)))
(assert
 (let (($x2158 (not z_2_49)))
 (= z_1_49 $x2158)))
(assert
 (let (($x2163 (not z_2_50)))
 (= z_1_50 $x2163)))
(assert
 (= z_1_51 (not z_2_51)))
(assert
 (= z_1_52 (not z_2_52)))
(assert
 (let (($x2178 (not z_2_53)))
 (= z_1_53 $x2178)))
(assert
 (= z_1_54 (not z_2_54)))
(assert
 (let (($x2188 (not z_2_55)))
 (= z_1_55 $x2188)))
(assert
 (let (($x2193 (not z_2_56)))
 (= z_1_56 $x2193)))
(assert
 (= z_1_57 (not z_2_57)))
(assert
 (let (($x2203 (not z_2_58)))
 (= z_1_58 $x2203)))
(assert
 (let (($x2208 (not z_2_59)))
 (= z_1_59 $x2208)))
(assert
 (= z_1_60 (not z_2_60)))
(assert
...
(assert
 (= z_1_69 (not z_2_69)))
(assert
 (let (($x2263 (not z_2_70)))
 (= z_1_70 $x2263)))
(assert
 (= z_1_71 (not z_2_71)))
(assert
 (let (($x2273 (not z_2_72)))
 (= z_1_72 $x2273)))
(assert
 (= z_1_73 (not z_2_73)))
(assert
 (let (($x2283 (not z_2_74)))
 (= z_1_74 $x2283)))
(assert
 (= z_1_75 (not z_2_75)))
(assert
 (let (($x2293 (not z_2_76)))
 (= z_1_76 $x2293)))
(assert
 (= z_1_77 (not z_2_77)))
(assert
...
(assert
 (= z_1_79 (not z_2_79)))
(assert
 (let (($x2313 (not z_2_80)))
 (= z_1_80 $x2313)))
(assert
 (let (($x2318 (not z_2_81)))
 (= z_1_81 $x2318)))
(assert
 (= z_1_82 (not z_2_82)))
(assert
 (let (($x2328 (not z_2_83)))
 (= z_1_83 $x2328)))
(assert
 (= z_1_84 (not z_2_84)))
(assert
...
(assert
 (= z_1_86 (not z_2_86)))
(assert
 (let (($x2348 (not z_2_87)))
 (= z_1_87 $x2348)))
(assert
 (= z_1_88 (not z_2_88)))
(assert
 (let (($x2358 (not z_2_89)))
 (= z_1_89 $x2358)))
(assert
 (let (($x2363 (not z_2_90)))
 (= z_1_90 $x2363)))
(assert
 (let (($x2368 (not z_2_91)))
 (= z_1_91 $x2368)))
(assert
 (not z_2_0))
(assert
