...
(assert
 (= z_0_165 (or z_1_165 z_0_166)))
(assert
 (= z_0_166 (or z_1_166 z_0_167)))
(assert
 (= z_0_167 (or z_1_167 z_0_168)))
(assert
 (= z_0_168 (or z_1_168 z_0_169)))
(assert
 (= z_0_169 (or z_1_169 z_0_170)))
(assert
 (= z_0_170 (or z_1_170 z_0_171)))
(assert
 (= z_0_171 (or z_1_171 z_0_172)))
(assert
 (= z_0_172 (or z_1_172 z_0_173)))
(assert
 (= z_0_173 (or z_1_173 z_0_174)))
(assert
 (= z_0_174 (or z_1_174 z_0_175)))
(assert
 (= z_0_175 (or z_1_175 z_0_114)))
(assert
 (= z_0_176 (or z_1_176 z_0_177)))
(assert
 (= z_0_177 (or z_1_177 z_0_178)))
(assert
 (= z_0_178 (or z_1_178 z_0_179)))
(assert
 (= z_0_179 (or z_1_179 z_0_180)))
(assert
 (= z_0_180 (or z_1_180 z_0_125)))
(assert
 (= z_0_181 (or z_1_181 z_0_182)))
(assert
 (= z_0_182 (or z_1_182 z_0_183)))
(assert
 (= z_0_183 (or z_1_183 z_0_184)))
(assert
 (= z_0_184 (or z_1_184 z_0_185)))
(assert
 (= z_0_185 (or z_1_185 z_0_186)))
(assert
 (= z_0_186 (or z_1_186 z_0_187)))
(assert
 (= z_0_187 (or z_1_187 z_0_188)))
(assert
 (= z_0_188 (or z_1_188 z_0_67)))
(assert
 (= z_0_189 (or z_1_189 z_0_190)))
(assert
 (= z_0_190 (or z_1_190 z_0_191)))
(assert
 (= z_0_191 (or z_1_191 z_0_192)))
(assert
 (= z_0_192 (or z_1_192 z_0_92)))
(assert
 (= z_0_193 (or z_1_193 z_0_194)))
(assert
 (= z_0_194 (or z_1_194 z_0_195)))
(assert
 (= z_0_195 (or z_1_195 z_0_172)))
(assert
 (= z_0_196 (or z_1_196 z_0_197)))
(assert
 (= z_0_197 (or z_1_197 z_0_198)))
(assert
 (= z_0_198 (or z_1_198 z_0_199)))
(assert
 (= z_0_199 (or z_1_199 z_0_200)))
(assert
 (= z_0_200 (or z_1_200 z_0_201)))
(assert
 (= z_0_201 (or z_1_201 z_0_202)))
(assert
 (= z_0_202 (or z_1_202 z_0_203)))
(assert
 (= z_0_203 (or z_1_203 z_0_204)))
(assert
 (= z_0_204 (or z_1_204 z_0_205)))
(assert
 (= z_0_205 (or z_1_205 z_1_201 z_1_202 z_1_203 z_1_204)))
(assert
 (= z_0_206 (or z_1_206 z_0_207)))
(assert
 (= z_0_207 (or z_1_207 z_0_208)))
(assert
 (= z_0_208 (or z_1_208 z_0_209)))
(assert
 (= z_0_209 (or z_1_209 z_0_210)))
(assert
 (= z_0_210 (or z_1_210 z_0_88)))
(assert
 (= z_0_211 (or z_1_211 z_0_212)))
(assert
 (= z_0_212 (or z_1_212 z_0_213)))
(assert
 (= z_0_213 (or z_1_213 z_0_214)))
(assert
 (= z_0_214 (or z_1_214 z_0_215)))
(assert
 (= z_0_215 (or z_1_215 z_0_216)))
(assert
 (= z_0_216 (or z_1_216 z_0_217)))
(assert
 (= z_0_217 (or z_1_217 z_0_218)))
(assert
 (= z_0_218 (or z_1_218 z_0_219)))
(assert
 (= z_0_219 (or z_1_219 z_1_215 z_1_216 z_1_217 z_1_218)))
(assert
 (= z_0_220 (or z_1_220 z_0_221)))
(assert
 (= z_0_221 (or z_1_221 z_0_129)))
(assert
 (= z_0_222 (or z_1_222 z_0_223)))
(assert
 (= z_0_223 (or z_1_223 z_0_224)))
(assert
 (= z_0_224 (or z_1_224 z_0_136)))
(assert
 (= z_0_225 (or z_1_225 z_0_226)))
(assert
 (= z_0_226 (or z_1_226 z_0_227)))
(assert
 (= z_0_227 (or z_1_227 z_0_228)))
(assert
 (= z_0_228 (or z_1_228 z_0_229)))
(assert
 (= z_0_229 (or z_1_229 z_0_230)))
(assert
 (= z_0_230 (or z_1_230 z_0_91)))
(assert
 (= z_0_231 (or z_1_231 z_0_232)))
(assert
 (= z_0_232 (or z_1_232 z_0_233)))
(assert
 (= z_0_233 (or z_1_233 z_1_232)))
(assert
 (= z_0_234 (or z_1_234 z_0_235)))
(assert
 (= z_0_235 (or z_1_235 z_0_116)))
(assert
 (= z_0_236 (or z_1_236 z_0_237)))
(assert
 (= z_0_237 (or z_1_237 z_0_238)))
(assert
 (= z_0_238 (or z_1_238 z_0_239)))
(assert
 (= z_0_239 (or z_1_239 z_0_240)))
(assert
 (= z_0_240 (or z_1_240 z_0_115)))
(assert
 (= z_0_241 (or z_1_241 z_0_242)))
(assert
 (= z_0_242 (or z_1_242 z_0_210)))
(assert
 (= z_0_243 (or z_1_243 z_0_173)))
(assert
 (= z_0_244 (or z_1_244 z_0_245)))
(assert
 (= z_0_245 (or z_1_245 z_0_243)))
(assert
 (= z_0_246 (or z_1_246 z_0_247)))
(assert
 (= z_0_247 (or z_1_247 z_0_248)))
(assert
 (= z_0_248 (or z_1_248 z_0_249)))
(assert
 (= z_0_249 (or z_1_249 z_0_250)))
(assert
 (= z_0_250 (or z_1_250 z_0_251)))
(assert
 (= z_0_251 (or z_1_251 z_0_252)))
(assert
 (= z_0_252 (or z_1_252 z_1_250 z_1_251)))
(assert
 (= z_0_253 (or z_1_253 z_0_254)))
(assert
 (= z_0_254 (or z_1_254 z_0_255)))
(assert
 (= z_0_255 (or z_1_255 z_0_256)))
(assert
 (= z_0_256 (or z_1_256 z_0_26)))
(assert
 (= z_0_257 (or z_1_257 z_0_258)))
(assert
 (= z_0_258 (or z_1_258 z_0_213)))
(assert
 (= z_0_259 (or z_1_259 z_0_260)))
(assert
 (= z_0_260 (or z_1_260 z_0_261)))
(assert
 (= z_0_261 (or z_1_261 z_0_262)))
(assert
 (= z_0_262 (or z_1_262 z_0_40)))
(assert
 (= z_0_263 (or z_1_263 z_0_264)))
(assert
 (= z_0_264 (or z_1_264 z_0_265)))
(assert
 (= z_0_265 (or z_1_265 z_0_266)))
(assert
 (= z_0_266 (or z_1_266 z_0_267)))
(assert
 (= z_0_267 (or z_1_267 z_0_218)))
(assert
 z_0_0)
(assert
 z_0_11)
