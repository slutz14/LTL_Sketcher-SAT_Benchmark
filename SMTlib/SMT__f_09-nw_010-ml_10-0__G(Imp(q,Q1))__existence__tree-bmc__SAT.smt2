...
(assert
 (= z_0_19_0 false))
(assert
 (let (($x2154 (= z_3_0_4 z_3_7_10)))
 (and $x2154)))
(assert
 (let (($x2156 (= z_3_0_5 z_3_7_5)))
 (and $x2156)))
(assert
 (let (($x2158 (= z_3_0_6 z_3_7_6)))
 (and $x2158)))
(assert
 (let (($x2160 (= z_3_0_7 z_3_7_7)))
 (and $x2160)))
(assert
 (let (($x2162 (= z_3_0_8 z_3_7_8)))
 (and $x2162)))
(assert
 (let (($x2164 (= z_3_0_9 z_3_7_9)))
 (and $x2164)))
(assert
 (let (($x2166 (= z_3_2_3 z_3_6_7)))
 (and $x2166)))
(assert
 (let (($x2168 (= z_3_2_4 z_3_6_8)))
 (and $x2168)))
(assert
 (let (($x2170 (= z_3_2_5 z_3_6_5)))
 (and $x2170)))
(assert
 (let (($x2172 (= z_3_2_6 z_3_6_6)))
 (and $x2172)))
(assert
 (let (($x2174 (= z_3_4_4 z_3_9_4)))
 (and $x2174)))
(assert
 (let (($x2176 (= z_3_4_5 z_3_9_5)))
 (and $x2176)))
(assert
 (let (($x2178 (= z_3_4_6 z_3_9_6)))
 (and $x2178)))
(assert
 (let (($x2180 (= z_3_4_7 z_3_9_7)))
 (and $x2180)))
(assert
 (let (($x2182 (= z_3_4_8 z_3_9_8)))
 (and $x2182)))
(assert
 (let (($x2184 (= z_3_4_9 z_3_9_3)))
 (and $x2184)))
(check-sat)
