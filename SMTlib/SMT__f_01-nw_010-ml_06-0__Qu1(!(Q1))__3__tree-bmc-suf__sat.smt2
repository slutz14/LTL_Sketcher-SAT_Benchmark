...
(assert
 (= z_1_12 (not z_3_12)))
(assert
 (let (($x3023 (not z_3_13)))
 (= z_1_13 $x3023)))
(assert
 (let (($x3028 (not z_3_14)))
 (= z_1_14 $x3028)))
(assert
 (let (($x3033 (not z_3_15)))
 (= z_1_15 $x3033)))
(assert
 (let (($x3038 (not z_3_16)))
 (= z_1_16 $x3038)))
(assert
 (= z_1_17 (not z_3_17)))
(assert
 (let (($x3048 (not z_3_18)))
 (= z_1_18 $x3048)))
(assert
 (let (($x3053 (not z_3_19)))
 (= z_1_19 $x3053)))
(assert
 (= z_1_20 (not z_3_20)))
(assert
 (= z_1_21 (not z_3_21)))
(assert
 (let (($x3068 (not z_3_22)))
 (= z_1_22 $x3068)))
(assert
 (let (($x3073 (not z_3_23)))
 (= z_1_23 $x3073)))
(assert
 (= z_1_24 (not z_3_24)))
(assert
 (let (($x3083 (not z_3_25)))
 (= z_1_25 $x3083)))
(assert
 (= z_1_26 (not z_3_26)))
(assert
...
(assert
 (= z_1_28 (not z_3_28)))
(assert
 (let (($x3103 (not z_3_29)))
 (= z_1_29 $x3103)))
(assert
 (= z_1_30 (not z_3_30)))
(assert
 (let (($x3113 (not z_3_31)))
 (= z_1_31 $x3113)))
(assert
 (let (($x3118 (not z_3_32)))
 (= z_1_32 $x3118)))
(assert
 (let (($x3123 (not z_3_33)))
 (= z_1_33 $x3123)))
(assert
 (= z_1_34 (not z_3_34)))
(assert
...
(assert
 ...
 (let (($x3153 (not x_3_F)))
 (let (($x3151 (not x_3_G)))
 (and $x3151 $x3153 $x3155 $x3157 $x3159 $x3161 $x3163 $x3165))))))))))
(check-sat)
