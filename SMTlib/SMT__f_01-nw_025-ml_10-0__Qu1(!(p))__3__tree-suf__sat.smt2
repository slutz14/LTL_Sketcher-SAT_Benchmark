...
(assert
 ...
 (= z_1_9 $x3350)))
(assert
 (let (($x3355 (not z_2_10)))
 (= z_1_10 $x3355)))
(assert
 (let (($x3360 (not z_2_11)))
 (= z_1_11 $x3360)))
(assert
 (let (($x3365 (not z_2_12)))
 (= z_1_12 $x3365)))
(assert
 (let (($x3370 (not z_2_13)))
 (= z_1_13 $x3370)))
(assert
 (let (($x3375 (not z_2_14)))
 (= z_1_14 $x3375)))
(assert
 (let (($x3380 (not z_2_15)))
 (= z_1_15 $x3380)))
(assert
 (let (($x3385 (not z_2_16)))
 (= z_1_16 $x3385)))
(assert
 (let (($x3390 (not z_2_17)))
 (= z_1_17 $x3390)))
(assert
 (let (($x3395 (not z_2_18)))
 (= z_1_18 $x3395)))
(assert
 (let (($x3400 (not z_2_19)))
 (= z_1_19 $x3400)))
(assert
 (let (($x3405 (not z_2_20)))
 (= z_1_20 $x3405)))
(assert
 (let (($x3410 (not z_2_21)))
 (= z_1_21 $x3410)))
(assert
 (let (($x3415 (not z_2_22)))
 (= z_1_22 $x3415)))
(assert
 (let (($x3420 (not z_2_23)))
 (= z_1_23 $x3420)))
(assert
 (let (($x3425 (not z_2_24)))
 (= z_1_24 $x3425)))
(assert
 (let (($x3430 (not z_2_25)))
 (= z_1_25 $x3430)))
(assert
 (let (($x3435 (not z_2_26)))
 (= z_1_26 $x3435)))
(assert
 (let (($x3440 (not z_2_27)))
 (= z_1_27 $x3440)))
(assert
 (let (($x3445 (not z_2_28)))
 (= z_1_28 $x3445)))
(assert
 (let (($x3450 (not z_2_29)))
 (= z_1_29 $x3450)))
(assert
 (let (($x3455 (not z_2_30)))
 (= z_1_30 $x3455)))
(assert
 (let (($x3460 (not z_2_31)))
 (= z_1_31 $x3460)))
(assert
 (let (($x3465 (not z_2_32)))
 (= z_1_32 $x3465)))
(assert
 (let (($x3470 (not z_2_33)))
 (= z_1_33 $x3470)))
(assert
 (let (($x3475 (not z_2_34)))
 (= z_1_34 $x3475)))
(assert
 (let (($x3480 (not z_2_35)))
 (= z_1_35 $x3480)))
(assert
 (let (($x3485 (not z_2_36)))
 (= z_1_36 $x3485)))
(assert
 (let (($x3490 (not z_2_37)))
 (= z_1_37 $x3490)))
(assert
 (let (($x3495 (not z_2_38)))
 (= z_1_38 $x3495)))
(assert
 (let (($x3500 (not z_2_39)))
 (= z_1_39 $x3500)))
(assert
 (let (($x3505 (not z_2_40)))
 (= z_1_40 $x3505)))
(assert
 (let (($x3510 (not z_2_41)))
 (= z_1_41 $x3510)))
(assert
 (let (($x3515 (not z_2_42)))
 (= z_1_42 $x3515)))
(assert
 (let (($x3520 (not z_2_43)))
 (= z_1_43 $x3520)))
(assert
 (let (($x3525 (not z_2_44)))
 (= z_1_44 $x3525)))
(assert
 (let (($x3530 (not z_2_45)))
 (= z_1_45 $x3530)))
(assert
 (let (($x3535 (not z_2_46)))
 (= z_1_46 $x3535)))
(assert
 (let (($x3540 (not z_2_47)))
 (= z_1_47 $x3540)))
(assert
 (let (($x3545 (not z_2_48)))
 (= z_1_48 $x3545)))
(assert
 (let (($x3550 (not z_2_49)))
 (= z_1_49 $x3550)))
(assert
 (let (($x3555 (not z_2_50)))
 (= z_1_50 $x3555)))
(assert
 (let (($x3560 (not z_2_51)))
 (= z_1_51 $x3560)))
(assert
 (let (($x3565 (not z_2_52)))
 (= z_1_52 $x3565)))
(assert
 (let (($x3570 (not z_2_53)))
 (= z_1_53 $x3570)))
(assert
 (let (($x3575 (not z_2_54)))
 (= z_1_54 $x3575)))
(assert
 (let (($x3580 (not z_2_55)))
 (= z_1_55 $x3580)))
(assert
 (let (($x3585 (not z_2_56)))
 (= z_1_56 $x3585)))
(assert
 (let (($x3590 (not z_2_57)))
 (= z_1_57 $x3590)))
(assert
 (let (($x3595 (not z_2_58)))
 (= z_1_58 $x3595)))
(assert
 (let (($x3600 (not z_2_59)))
 (= z_1_59 $x3600)))
(assert
 (let (($x3605 (not z_2_60)))
 (= z_1_60 $x3605)))
(assert
 (let (($x3610 (not z_2_61)))
 (= z_1_61 $x3610)))
(assert
 (let (($x3615 (not z_2_62)))
 (= z_1_62 $x3615)))
(assert
 (let (($x3620 (not z_2_63)))
 (= z_1_63 $x3620)))
(assert
 (let (($x3625 (not z_2_64)))
 (= z_1_64 $x3625)))
(assert
 (let (($x3630 (not z_2_65)))
 (= z_1_65 $x3630)))
(assert
 (let (($x3635 (not z_2_66)))
 (= z_1_66 $x3635)))
(assert
 (let (($x3640 (not z_2_67)))
 (= z_1_67 $x3640)))
(assert
 (let (($x3645 (not z_2_68)))
 (= z_1_68 $x3645)))
(assert
 (let (($x3650 (not z_2_69)))
 (= z_1_69 $x3650)))
(assert
 (let (($x3655 (not z_2_70)))
 (= z_1_70 $x3655)))
(assert
 (let (($x3660 (not z_2_71)))
 (= z_1_71 $x3660)))
(assert
 (let (($x3665 (not z_2_72)))
 (= z_1_72 $x3665)))
(assert
 (let (($x3670 (not z_2_73)))
 (= z_1_73 $x3670)))
(assert
 (let (($x3675 (not z_2_74)))
 (= z_1_74 $x3675)))
(assert
 (let (($x3680 (not z_2_75)))
 (= z_1_75 $x3680)))
(assert
 (let (($x3685 (not z_2_76)))
 (= z_1_76 $x3685)))
(assert
 (let (($x3690 (not z_2_77)))
 (= z_1_77 $x3690)))
(assert
 (let (($x3695 (not z_2_78)))
 (= z_1_78 $x3695)))
(assert
 (let (($x3700 (not z_2_79)))
 (= z_1_79 $x3700)))
(assert
 (let (($x3705 (not z_2_80)))
 (= z_1_80 $x3705)))
(assert
 (let (($x3710 (not z_2_81)))
 (= z_1_81 $x3710)))
(assert
 (let (($x3715 (not z_2_82)))
 (= z_1_82 $x3715)))
(assert
 (let (($x3720 (not z_2_83)))
 (= z_1_83 $x3720)))
(assert
 (let (($x3725 (not z_2_84)))
 (= z_1_84 $x3725)))
(assert
 (let (($x3730 (not z_2_85)))
 (= z_1_85 $x3730)))
(assert
 (let (($x3735 (not z_2_86)))
 (= z_1_86 $x3735)))
(assert
 (let (($x3740 (not z_2_87)))
 (= z_1_87 $x3740)))
(assert
 (let (($x3745 (not z_2_88)))
 (= z_1_88 $x3745)))
(assert
 (let (($x3750 (not z_2_89)))
 (= z_1_89 $x3750)))
(assert
 (let (($x3755 (not z_2_90)))
 (= z_1_90 $x3755)))
(assert
 (let (($x3760 (not z_2_91)))
 (= z_1_91 $x3760)))
(assert
 (let (($x3765 (not z_2_92)))
 (= z_1_92 $x3765)))
(assert
 (let (($x3770 (not z_2_93)))
 (= z_1_93 $x3770)))
(assert
 (let (($x3775 (not z_2_94)))
 (= z_1_94 $x3775)))
(assert
 (let (($x3780 (not z_2_95)))
 (= z_1_95 $x3780)))
(assert
 (let (($x3785 (not z_2_96)))
 (= z_1_96 $x3785)))
(assert
 (let (($x3790 (not z_2_97)))
 (= z_1_97 $x3790)))
(assert
 (let (($x3795 (not z_2_98)))
 (= z_1_98 $x3795)))
(assert
 (let (($x3800 (not z_2_99)))
 (= z_1_99 $x3800)))
(assert
 (let (($x3805 (not z_2_100)))
 (= z_1_100 $x3805)))
(assert
 (let (($x3810 (not z_2_101)))
 (= z_1_101 $x3810)))
(assert
 (let (($x3815 (not z_2_102)))
 (= z_1_102 $x3815)))
(assert
 (let (($x3820 (not z_2_103)))
 (= z_1_103 $x3820)))
(assert
 (let (($x3825 (not z_2_104)))
 (= z_1_104 $x3825)))
(assert
 (let (($x3830 (not z_2_105)))
 (= z_1_105 $x3830)))
(assert
 (let (($x3835 (not z_2_106)))
 (= z_1_106 $x3835)))
(assert
 (let (($x3840 (not z_2_107)))
 (= z_1_107 $x3840)))
(assert
 (let (($x3845 (not z_2_108)))
 (= z_1_108 $x3845)))
(assert
 (let (($x3850 (not z_2_109)))
 (= z_1_109 $x3850)))
(assert
 (let (($x3855 (not z_2_110)))
 (= z_1_110 $x3855)))
(assert
 (let (($x3860 (not z_2_111)))
 (= z_1_111 $x3860)))
(assert
 (let (($x3865 (not z_2_112)))
 (= z_1_112 $x3865)))
(assert
 (let (($x3870 (not z_2_113)))
 (= z_1_113 $x3870)))
(assert
 (let (($x3875 (not z_2_114)))
 (= z_1_114 $x3875)))
(assert
 (let (($x3880 (not z_2_115)))
 (= z_1_115 $x3880)))
(assert
 (let (($x3885 (not z_2_116)))
 (= z_1_116 $x3885)))
(assert
 (let (($x3890 (not z_2_117)))
 (= z_1_117 $x3890)))
(assert
 (let (($x3895 (not z_2_118)))
 (= z_1_118 $x3895)))
(assert
 (let (($x3900 (not z_2_119)))
 (= z_1_119 $x3900)))
(assert
 (let (($x3905 (not z_2_120)))
 (= z_1_120 $x3905)))
(assert
 (let (($x3910 (not z_2_121)))
 (= z_1_121 $x3910)))
(assert
 (let (($x3915 (not z_2_122)))
 (= z_1_122 $x3915)))
(assert
 (let (($x3920 (not z_2_123)))
 (= z_1_123 $x3920)))
(assert
 (let (($x3925 (not z_2_124)))
 (= z_1_124 $x3925)))
(assert
 (let (($x3930 (not z_2_125)))
 (= z_1_125 $x3930)))
(assert
 (let (($x3935 (not z_2_126)))
 (= z_1_126 $x3935)))
(assert
 (let (($x3940 (not z_2_127)))
 (= z_1_127 $x3940)))
(assert
 (let (($x3945 (not z_2_128)))
 (= z_1_128 $x3945)))
(assert
 (let (($x3950 (not z_2_129)))
 (= z_1_129 $x3950)))
(assert
 (let (($x3955 (not z_2_130)))
 (= z_1_130 $x3955)))
(assert
 (let (($x3960 (not z_2_131)))
 (= z_1_131 $x3960)))
(assert
 (let (($x3965 (not z_2_132)))
 (= z_1_132 $x3965)))
(assert
 (let (($x3970 (not z_2_133)))
 (= z_1_133 $x3970)))
(assert
 (let (($x3975 (not z_2_134)))
 (= z_1_134 $x3975)))
(assert
 (let (($x3980 (not z_2_135)))
 (= z_1_135 $x3980)))
(assert
 (let (($x3985 (not z_2_136)))
 (= z_1_136 $x3985)))
(assert
 (let (($x3990 (not z_2_137)))
 (= z_1_137 $x3990)))
(assert
 (let (($x3995 (not z_2_138)))
 (= z_1_138 $x3995)))
(assert
 (let (($x4000 (not z_2_139)))
 (= z_1_139 $x4000)))
(assert
 (let (($x4005 (not z_2_140)))
 (= z_1_140 $x4005)))
(assert
 (let (($x4010 (not z_2_141)))
 (= z_1_141 $x4010)))
(assert
 (let (($x4015 (not z_2_142)))
 (= z_1_142 $x4015)))
(assert
 (let (($x4020 (not z_2_143)))
 (= z_1_143 $x4020)))
(assert
 (let (($x4025 (not z_2_144)))
 (= z_1_144 $x4025)))
(assert
 (let (($x4030 (not z_2_145)))
 (= z_1_145 $x4030)))
(assert
 (let (($x4035 (not z_2_146)))
 (= z_1_146 $x4035)))
(assert
 (let (($x4040 (not z_2_147)))
 (= z_1_147 $x4040)))
(assert
 (let (($x4045 (not z_2_148)))
 (= z_1_148 $x4045)))
(assert
 (let (($x4050 (not z_2_149)))
 (= z_1_149 $x4050)))
(assert
 (let (($x4055 (not z_2_150)))
 (= z_1_150 $x4055)))
(assert
 (let (($x4060 (not z_2_151)))
 (= z_1_151 $x4060)))
(assert
 (let (($x4065 (not z_2_152)))
 (= z_1_152 $x4065)))
(assert
 (let (($x4070 (not z_2_153)))
 (= z_1_153 $x4070)))
(assert
 (let (($x4075 (not z_2_154)))
 (= z_1_154 $x4075)))
(assert
 (let (($x4080 (not z_2_155)))
 (= z_1_155 $x4080)))
(assert
 (let (($x4085 (not z_2_156)))
 (= z_1_156 $x4085)))
(assert
 (let (($x4090 (not z_2_157)))
 (= z_1_157 $x4090)))
(assert
 (let (($x4095 (not z_2_158)))
 (= z_1_158 $x4095)))
(assert
 (let (($x4100 (not z_2_159)))
 (= z_1_159 $x4100)))
(assert
 (let (($x4105 (not z_2_160)))
 (= z_1_160 $x4105)))
(assert
 (let (($x4110 (not z_2_161)))
 (= z_1_161 $x4110)))
(assert
 (let (($x4115 (not z_2_162)))
 (= z_1_162 $x4115)))
(assert
 (let (($x4120 (not z_2_163)))
 (= z_1_163 $x4120)))
(assert
 (let (($x4125 (not z_2_164)))
 (= z_1_164 $x4125)))
(assert
 (not z_2_0))
(assert
