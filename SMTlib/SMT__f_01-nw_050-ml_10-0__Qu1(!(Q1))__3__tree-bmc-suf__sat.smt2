...
(assert
 ...
 (= z_1_4 $x6937)))
(assert
 (let (($x22185 (not z_3_5)))
 (= z_1_5 $x22185)))
(assert
 (= z_1_6 (not z_3_6)))
(assert
 (let (($x22195 (not z_3_7)))
 (= z_1_7 $x22195)))
(assert
 (let (($x22200 (not z_3_8)))
 (= z_1_8 $x22200)))
(assert
 (let (($x22205 (not z_3_9)))
 (= z_1_9 $x22205)))
(assert
 (= z_1_10 (not z_3_10)))
(assert
...
(assert
 (= z_1_17 (not z_3_17)))
(assert
 (let (($x22250 (not z_3_18)))
 (= z_1_18 $x22250)))
(assert
 (let (($x22255 (not z_3_19)))
 (= z_1_19 $x22255)))
(assert
 (let (($x22260 (not z_3_20)))
 (= z_1_20 $x22260)))
(assert
 (let (($x22265 (not z_3_21)))
 (= z_1_21 $x22265)))
(assert
 (= z_1_22 (not z_3_22)))
(assert
 (let (($x22275 (not z_3_23)))
 (= z_1_23 $x22275)))
(assert
 (let (($x22280 (not z_3_24)))
 (= z_1_24 $x22280)))
(assert
 (= z_1_25 (not z_3_25)))
(assert
 (= z_1_26 (not z_3_26)))
(assert
 (let (($x22295 (not z_3_27)))
 (= z_1_27 $x22295)))
(assert
 (= z_1_28 (not z_3_28)))
(assert
 (let (($x22305 (not z_3_29)))
 (= z_1_29 $x22305)))
(assert
 (let (($x22310 (not z_3_30)))
 (= z_1_30 $x22310)))
(assert
 (= z_1_31 (not z_3_31)))
(assert
 (let (($x22320 (not z_3_32)))
 (= z_1_32 $x22320)))
(assert
 (let (($x22325 (not z_3_33)))
 (= z_1_33 $x22325)))
(assert
 (= z_1_34 (not z_3_34)))
(assert
...
(assert
 (= z_1_40 (not z_3_40)))
(assert
 (let (($x22365 (not z_3_41)))
 (= z_1_41 $x22365)))
(assert
 (= z_1_42 (not z_3_42)))
(assert
 (let (($x22375 (not z_3_43)))
 (= z_1_43 $x22375)))
(assert
 (= z_1_44 (not z_3_44)))
(assert
 (let (($x22385 (not z_3_45)))
 (= z_1_45 $x22385)))
(assert
 (= z_1_46 (not z_3_46)))
(assert
...
(assert
 (= z_1_60 (not z_3_60)))
(assert
 (let (($x22465 (not z_3_61)))
 (= z_1_61 $x22465)))
(assert
 (let (($x22470 (not z_3_62)))
 (= z_1_62 $x22470)))
(assert
 (= z_1_63 (not z_3_63)))
(assert
 (let (($x22480 (not z_3_64)))
 (= z_1_64 $x22480)))
(assert
 (= z_1_65 (not z_3_65)))
(assert
...
(assert
 (= z_1_69 (not z_3_69)))
(assert
 (let (($x22510 (not z_3_70)))
 (= z_1_70 $x22510)))
(assert
 (let (($x22515 (not z_3_71)))
 (= z_1_71 $x22515)))
(assert
 (let (($x22520 (not z_3_72)))
 (= z_1_72 $x22520)))
(assert
 (= z_1_73 (not z_3_73)))
(assert
 (let (($x22530 (not z_3_74)))
 (= z_1_74 $x22530)))
(assert
 (= z_1_75 (not z_3_75)))
(assert
 (let (($x22540 (not z_3_76)))
 (= z_1_76 $x22540)))
(assert
 (= z_1_77 (not z_3_77)))
(assert
 (let (($x22550 (not z_3_78)))
 (= z_1_78 $x22550)))
(assert
 (let (($x22555 (not z_3_79)))
 (= z_1_79 $x22555)))
(assert
 (let (($x22560 (not z_3_80)))
 (= z_1_80 $x22560)))
(assert
 (= z_1_81 (not z_3_81)))
(assert
 (let (($x22570 (not z_3_82)))
 (= z_1_82 $x22570)))
(assert
 (= z_1_83 (not z_3_83)))
(assert
 (= z_1_84 (not z_3_84)))
(assert
 (let (($x22585 (not z_3_85)))
 (= z_1_85 $x22585)))
(assert
 (= z_1_86 (not z_3_86)))
(assert
 (let (($x22595 (not z_3_87)))
 (= z_1_87 $x22595)))
(assert
 (= z_1_88 (not z_3_88)))
(assert
 (let (($x22605 (not z_3_89)))
 (= z_1_89 $x22605)))
(assert
 (= z_1_90 (not z_3_90)))
(assert
 (let (($x22615 (not z_3_91)))
 (= z_1_91 $x22615)))
(assert
 (let (($x22620 (not z_3_92)))
 (= z_1_92 $x22620)))
(assert
 (= z_1_93 (not z_3_93)))
(assert
 (let (($x22630 (not z_3_94)))
 (= z_1_94 $x22630)))
(assert
 (let (($x22635 (not z_3_95)))
 (= z_1_95 $x22635)))
(assert
 (= z_1_96 (not z_3_96)))
(assert
 (let (($x22645 (not z_3_97)))
 (= z_1_97 $x22645)))
(assert
 (let (($x22650 (not z_3_98)))
 (= z_1_98 $x22650)))
(assert
 (= z_1_99 (not z_3_99)))
(assert
...
(assert
 (= z_1_101 (not z_3_101)))
(assert
 (let (($x22670 (not z_3_102)))
 (= z_1_102 $x22670)))
(assert
 (let (($x22675 (not z_3_103)))
 (= z_1_103 $x22675)))
(assert
 (let (($x22680 (not z_3_104)))
 (= z_1_104 $x22680)))
(assert
 (let (($x22685 (not z_3_105)))
 (= z_1_105 $x22685)))
(assert
 (= z_1_106 (not z_3_106)))
(assert
...
(assert
 (= z_1_109 (not z_3_109)))
(assert
 (let (($x22710 (not z_3_110)))
 (= z_1_110 $x22710)))
(assert
 (let (($x22715 (not z_3_111)))
 (= z_1_111 $x22715)))
(assert
 (= z_1_112 (not z_3_112)))
(assert
 (let (($x22725 (not z_3_113)))
 (= z_1_113 $x22725)))
(assert
 (let (($x22730 (not z_3_114)))
 (= z_1_114 $x22730)))
(assert
 (= z_1_115 (not z_3_115)))
(assert
 (let (($x22740 (not z_3_116)))
 (= z_1_116 $x22740)))
(assert
 (= z_1_117 (not z_3_117)))
(assert
 (= z_1_118 (not z_3_118)))
(assert
 (let (($x22755 (not z_3_119)))
 (= z_1_119 $x22755)))
(assert
 (= z_1_120 (not z_3_120)))
(assert
 (let (($x22765 (not z_3_121)))
 (= z_1_121 $x22765)))
(assert
 (let (($x22770 (not z_3_122)))
 (= z_1_122 $x22770)))
(assert
 (= z_1_123 (not z_3_123)))
(assert
 (let (($x22780 (not z_3_124)))
 (= z_1_124 $x22780)))
(assert
 (let (($x22785 (not z_3_125)))
 (= z_1_125 $x22785)))
(assert
 (= z_1_126 (not z_3_126)))
(assert
...
(assert
 (= z_1_130 (not z_3_130)))
(assert
 (let (($x22815 (not z_3_131)))
 (= z_1_131 $x22815)))
(assert
 (= z_1_132 (not z_3_132)))
(assert
 (let (($x22825 (not z_3_133)))
 (= z_1_133 $x22825)))
(assert
 (let (($x22830 (not z_3_134)))
 (= z_1_134 $x22830)))
(assert
 (let (($x22835 (not z_3_135)))
 (= z_1_135 $x22835)))
(assert
 (= z_1_136 (not z_3_136)))
(assert
 (let (($x22845 (not z_3_137)))
 (= z_1_137 $x22845)))
(assert
 (let (($x22850 (not z_3_138)))
 (= z_1_138 $x22850)))
(assert
 (let (($x22855 (not z_3_139)))
 (= z_1_139 $x22855)))
(assert
 (let (($x22860 (not z_3_140)))
 (= z_1_140 $x22860)))
(assert
 (= z_1_141 (not z_3_141)))
(assert
 (= z_1_142 (not z_3_142)))
(assert
 (let (($x22875 (not z_3_143)))
 (= z_1_143 $x22875)))
(assert
 (let (($x22880 (not z_3_144)))
 (= z_1_144 $x22880)))
(assert
 (let (($x22885 (not z_3_145)))
 (= z_1_145 $x22885)))
(assert
 (= z_1_146 (not z_3_146)))
(assert
 (= z_1_147 (not z_3_147)))
(assert
 (let (($x22900 (not z_3_148)))
 (= z_1_148 $x22900)))
(assert
 (let (($x22905 (not z_3_149)))
 (= z_1_149 $x22905)))
(assert
 (let (($x22910 (not z_3_150)))
 (= z_1_150 $x22910)))
(assert
 (= z_1_151 (not z_3_151)))
(assert
 (let (($x22920 (not z_3_152)))
 (= z_1_152 $x22920)))
(assert
 (= z_1_153 (not z_3_153)))
(assert
 (= z_1_154 (not z_3_154)))
(assert
 (let (($x22935 (not z_3_155)))
 (= z_1_155 $x22935)))
(assert
 (let (($x22940 (not z_3_156)))
 (= z_1_156 $x22940)))
(assert
 (let (($x22945 (not z_3_157)))
 (= z_1_157 $x22945)))
(assert
 (let (($x22950 (not z_3_158)))
 (= z_1_158 $x22950)))
(assert
 (= z_1_159 (not z_3_159)))
(assert
 (let (($x22960 (not z_3_160)))
 (= z_1_160 $x22960)))
(assert
 (let (($x22965 (not z_3_161)))
 (= z_1_161 $x22965)))
(assert
 (= z_1_162 (not z_3_162)))
(assert
 (= z_1_163 (not z_3_163)))
(assert
 (let (($x22980 (not z_3_164)))
 (= z_1_164 $x22980)))
(assert
 (let (($x22985 (not z_3_165)))
 (= z_1_165 $x22985)))
(assert
 (= z_1_166 (not z_3_166)))
(assert
 (= z_1_167 (not z_3_167)))
(assert
 (let (($x23000 (not z_3_168)))
 (= z_1_168 $x23000)))
(assert
 (let (($x23005 (not z_3_169)))
 (= z_1_169 $x23005)))
(assert
 (= z_1_170 (not z_3_170)))
(assert
 (= z_1_171 (not z_3_171)))
(assert
 (let (($x23020 (not z_3_172)))
 (= z_1_172 $x23020)))
(assert
 (let (($x23025 (not z_3_173)))
 (= z_1_173 $x23025)))
(assert
 (= z_1_174 (not z_3_174)))
(assert
 (let (($x23035 (not z_3_175)))
 (= z_1_175 $x23035)))
(assert
 (let (($x23040 (not z_3_176)))
 (= z_1_176 $x23040)))
(assert
 (let (($x23045 (not z_3_177)))
 (= z_1_177 $x23045)))
(assert
 (let (($x23050 (not z_3_178)))
 (= z_1_178 $x23050)))
(assert
 (= z_1_179 (not z_3_179)))
(assert
 (let (($x23060 (not z_3_180)))
 (= z_1_180 $x23060)))
(assert
 (= z_1_181 (not z_3_181)))
(assert
 (= z_1_182 (not z_3_182)))
(assert
 (let (($x23075 (not z_3_183)))
 (= z_1_183 $x23075)))
(assert
 (let (($x23080 (not z_3_184)))
 (= z_1_184 $x23080)))
(assert
 (= z_1_185 (not z_3_185)))
(assert
 (let (($x23090 (not z_3_186)))
 (= z_1_186 $x23090)))
(assert
 (= z_1_187 (not z_3_187)))
(assert
 (let (($x23100 (not z_3_188)))
 (= z_1_188 $x23100)))
(assert
 (let (($x23105 (not z_3_189)))
 (= z_1_189 $x23105)))
(assert
 (let (($x23110 (not z_3_190)))
 (= z_1_190 $x23110)))
(assert
 (= z_1_191 (not z_3_191)))
(assert
 (let (($x23120 (not z_3_192)))
 (= z_1_192 $x23120)))
(assert
 (let (($x23125 (not z_3_193)))
 (= z_1_193 $x23125)))
(assert
 (let (($x23130 (not z_3_194)))
 (= z_1_194 $x23130)))
(assert
 (= z_1_195 (not z_3_195)))
(assert
 (let (($x23140 (not z_3_196)))
 (= z_1_196 $x23140)))
(assert
 (let (($x23145 (not z_3_197)))
 (= z_1_197 $x23145)))
(assert
 (= z_1_198 (not z_3_198)))
(assert
...
(assert
 (= z_1_206 (not z_3_206)))
(assert
 (let (($x23195 (not z_3_207)))
 (= z_1_207 $x23195)))
(assert
 (let (($x23200 (not z_3_208)))
 (= z_1_208 $x23200)))
(assert
 (= z_1_209 (not z_3_209)))
(assert
 (= z_1_210 (not z_3_210)))
(assert
 (let (($x23215 (not z_3_211)))
 (= z_1_211 $x23215)))
(assert
 (let (($x23220 (not z_3_212)))
 (= z_1_212 $x23220)))
(assert
 (= z_1_213 (not z_3_213)))
(assert
 (let (($x23230 (not z_3_214)))
 (= z_1_214 $x23230)))
(assert
 (= z_1_215 (not z_3_215)))
(assert
...
(assert
 (= z_1_217 (not z_3_217)))
(assert
 (let (($x23250 (not z_3_218)))
 (= z_1_218 $x23250)))
(assert
 (let (($x23255 (not z_3_219)))
 (= z_1_219 $x23255)))
(assert
 (= z_1_220 (not z_3_220)))
(assert
 (let (($x23265 (not z_3_221)))
 (= z_1_221 $x23265)))
(assert
 (= z_1_222 (not z_3_222)))
(assert
...
(assert
 (= z_1_225 (not z_3_225)))
(assert
 (let (($x23290 (not z_3_226)))
 (= z_1_226 $x23290)))
(assert
 (= z_1_227 (not z_3_227)))
(assert
 (let (($x23300 (not z_3_228)))
 (= z_1_228 $x23300)))
(assert
 (let (($x23305 (not z_3_229)))
 (= z_1_229 $x23305)))
(assert
 (= z_1_230 (not z_3_230)))
(assert
 (= z_1_231 (not z_3_231)))
(assert
 (let (($x23320 (not z_3_232)))
 (= z_1_232 $x23320)))
(assert
 (let (($x23325 (not z_3_233)))
 (= z_1_233 $x23325)))
(assert
 (let (($x23330 (not z_3_234)))
 (= z_1_234 $x23330)))
(assert
 (= z_1_235 (not z_3_235)))
(assert
...
(assert
 (= z_1_238 (not z_3_238)))
(assert
 (let (($x23355 (not z_3_239)))
 (= z_1_239 $x23355)))
(assert
 (= z_1_240 (not z_3_240)))
(assert
 (let (($x23365 (not z_3_241)))
 (= z_1_241 $x23365)))
(assert
 (= z_1_242 (not z_3_242)))
(assert
 (= z_1_243 (not z_3_243)))
(assert
 (let (($x23380 (not z_3_244)))
 (= z_1_244 $x23380)))
(assert
 (let (($x23385 (not z_3_245)))
 (= z_1_245 $x23385)))
(assert
 (let (($x23390 (not z_3_246)))
 (= z_1_246 $x23390)))
(assert
 (let (($x23395 (not z_3_247)))
 (= z_1_247 $x23395)))
(assert
 (= z_1_248 (not z_3_248)))
(assert
 (let (($x23405 (not z_3_249)))
 (= z_1_249 $x23405)))
(assert
 (= z_1_250 (not z_3_250)))
(assert
...
(assert
 (= z_1_252 (not z_3_252)))
(assert
 (let (($x23425 (not z_3_253)))
 (= z_1_253 $x23425)))
(assert
 (let (($x23430 (not z_3_254)))
 (= z_1_254 $x23430)))
(assert
 (= z_1_255 (not z_3_255)))
(assert
...
(assert
 (= z_1_260 (not z_3_260)))
(assert
 (let (($x23465 (not z_3_261)))
 (= z_1_261 $x23465)))
(assert
 (= z_1_262 (not z_3_262)))
(assert
 (let (($x23475 (not z_3_263)))
 (= z_1_263 $x23475)))
(assert
 (= z_1_264 (not z_3_264)))
(assert
 (let (($x23485 (not z_3_265)))
 (= z_1_265 $x23485)))
(assert
 (let (($x23490 (not z_3_266)))
 (= z_1_266 $x23490)))
(assert
 (= z_1_267 (not z_3_267)))
(assert
 (let (($x23500 (not z_3_268)))
 (= z_1_268 $x23500)))
(assert
 (let (($x23505 (not z_3_269)))
 (= z_1_269 $x23505)))
(assert
 (= z_1_270 (not z_3_270)))
(assert
 (= z_1_271 (not z_3_271)))
(assert
 (let (($x23520 (not z_3_272)))
 (= z_1_272 $x23520)))
(assert
 (let (($x23525 (not z_3_273)))
 (= z_1_273 $x23525)))
(assert
 (and true true))
(assert
...
(assert
 (let (($x23547 (not x_3_->)))
 (let (($x23545 (not x_3_U)))
 (let (($x23543 (not x_3_v)))
 (let (($x23541 (not x_3_&)))
 (let (($x23539 (not x_3_X)))
 (let (($x23537 (not x_3_!)))
 (let (($x23535 (not x_3_F)))
 (let (($x23533 (not x_3_G)))
 (and $x23533 $x23535 $x23537 $x23539 $x23541 $x23543 $x23545 $x23547))))))))))
(check-sat)
