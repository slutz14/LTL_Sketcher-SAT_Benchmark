...
(assert
 ...
 (= z_1_9 $x1428)))
(assert
 (let (($x1433 (not z_2_10)))
 (= z_1_10 $x1433)))
(assert
 (let (($x1438 (not z_2_11)))
 (= z_1_11 $x1438)))
(assert
 (let (($x1443 (not z_2_12)))
 (= z_1_12 $x1443)))
(assert
 (let (($x1448 (not z_2_13)))
 (= z_1_13 $x1448)))
(assert
 (let (($x1453 (not z_2_14)))
 (= z_1_14 $x1453)))
(assert
 (let (($x1458 (not z_2_15)))
 (= z_1_15 $x1458)))
(assert
 (let (($x1463 (not z_2_16)))
 (= z_1_16 $x1463)))
(assert
 (let (($x1468 (not z_2_17)))
 (= z_1_17 $x1468)))
(assert
 (let (($x1473 (not z_2_18)))
 (= z_1_18 $x1473)))
(assert
 (let (($x1478 (not z_2_19)))
 (= z_1_19 $x1478)))
(assert
 (let (($x1483 (not z_2_20)))
 (= z_1_20 $x1483)))
(assert
 (let (($x1488 (not z_2_21)))
 (= z_1_21 $x1488)))
(assert
 (let (($x1493 (not z_2_22)))
 (= z_1_22 $x1493)))
(assert
 (let (($x1498 (not z_2_23)))
 (= z_1_23 $x1498)))
(assert
 (let (($x1503 (not z_2_24)))
 (= z_1_24 $x1503)))
(assert
 (let (($x1508 (not z_2_25)))
 (= z_1_25 $x1508)))
(assert
 (let (($x1513 (not z_2_26)))
 (= z_1_26 $x1513)))
(assert
 (let (($x1518 (not z_2_27)))
 (= z_1_27 $x1518)))
(assert
 (let (($x1523 (not z_2_28)))
 (= z_1_28 $x1523)))
(assert
 (let (($x1528 (not z_2_29)))
 (= z_1_29 $x1528)))
(assert
 (let (($x1533 (not z_2_30)))
 (= z_1_30 $x1533)))
(assert
 (let (($x1538 (not z_2_31)))
 (= z_1_31 $x1538)))
(assert
 (let (($x1543 (not z_2_32)))
 (= z_1_32 $x1543)))
(assert
 (let (($x1548 (not z_2_33)))
 (= z_1_33 $x1548)))
(assert
 (let (($x1553 (not z_2_34)))
 (= z_1_34 $x1553)))
(assert
 (let (($x1558 (not z_2_35)))
 (= z_1_35 $x1558)))
(assert
 (let (($x1563 (not z_2_36)))
 (= z_1_36 $x1563)))
(assert
 (let (($x1568 (not z_2_37)))
 (= z_1_37 $x1568)))
(assert
 (let (($x1573 (not z_2_38)))
 (= z_1_38 $x1573)))
(assert
 (let (($x1578 (not z_2_39)))
 (= z_1_39 $x1578)))
(assert
 (let (($x1583 (not z_2_40)))
 (= z_1_40 $x1583)))
(assert
 (let (($x1588 (not z_2_41)))
 (= z_1_41 $x1588)))
(assert
 (let (($x1593 (not z_2_42)))
 (= z_1_42 $x1593)))
(assert
 (let (($x1598 (not z_2_43)))
 (= z_1_43 $x1598)))
(assert
 (let (($x1603 (not z_2_44)))
 (= z_1_44 $x1603)))
(assert
 (let (($x1608 (not z_2_45)))
 (= z_1_45 $x1608)))
(assert
 (let (($x1613 (not z_2_46)))
 (= z_1_46 $x1613)))
(assert
 (let (($x1618 (not z_2_47)))
 (= z_1_47 $x1618)))
(assert
 (let (($x1623 (not z_2_48)))
 (= z_1_48 $x1623)))
(assert
 (let (($x1628 (not z_2_49)))
 (= z_1_49 $x1628)))
(assert
 (let (($x1633 (not z_2_50)))
 (= z_1_50 $x1633)))
(assert
 (let (($x1638 (not z_2_51)))
 (= z_1_51 $x1638)))
(assert
 (let (($x1643 (not z_2_52)))
 (= z_1_52 $x1643)))
(assert
 (let (($x1648 (not z_2_53)))
 (= z_1_53 $x1648)))
(assert
 (let (($x1653 (not z_2_54)))
 (= z_1_54 $x1653)))
(assert
 (let (($x1658 (not z_2_55)))
 (= z_1_55 $x1658)))
(assert
 (let (($x1663 (not z_2_56)))
 (= z_1_56 $x1663)))
(assert
 (let (($x1668 (not z_2_57)))
 (= z_1_57 $x1668)))
(assert
 (let (($x1673 (not z_2_58)))
 (= z_1_58 $x1673)))
(assert
 (let (($x1678 (not z_2_59)))
 (= z_1_59 $x1678)))
(assert
 (let (($x1683 (not z_2_60)))
 (= z_1_60 $x1683)))
(assert
 (let (($x1688 (not z_2_61)))
 (= z_1_61 $x1688)))
(assert
 (let (($x1693 (not z_2_62)))
 (= z_1_62 $x1693)))
(assert
 (let (($x1698 (not z_2_63)))
 (= z_1_63 $x1698)))
(assert
 (let (($x1703 (not z_2_64)))
 (= z_1_64 $x1703)))
(assert
 (let (($x1708 (not z_2_65)))
 (= z_1_65 $x1708)))
(assert
 (let (($x1713 (not z_2_66)))
 (= z_1_66 $x1713)))
(assert
 (let (($x1718 (not z_2_67)))
 (= z_1_67 $x1718)))
(assert
 (not z_2_0))
(assert
