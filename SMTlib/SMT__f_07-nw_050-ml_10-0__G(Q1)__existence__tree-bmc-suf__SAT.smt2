...
(assert
 (= z_0_9 (and z_1_9 z_1_5 z_1_6 z_1_7 z_1_8)))
(assert
...
(assert
 (= z_0_38 (and z_1_38 z_1_34 z_1_35 z_1_36 z_1_37)))
(assert
...
(assert
 (= z_0_50 (and z_1_50 z_1_45 z_1_46 z_1_47 z_1_48 z_1_49)))
(assert
...
(assert
 (= z_0_69 (and z_1_69 z_1_64 z_1_65 z_1_66 z_1_67 z_1_68)))
(assert
...
(assert
 (= z_0_87 (and z_1_87 z_1_83 z_1_84 z_1_85 z_1_86)))
(assert
...
(assert
 (= z_0_99 (and z_1_99 z_1_94 z_1_95 z_1_96 z_1_97 z_1_98)))
(assert
...
(assert
 (= z_0_109 (and z_1_109 z_1_106 z_1_107 z_1_108)))
(assert
...
(assert
 (= z_0_132 (and z_1_132 z_1_128 z_1_129 z_1_130 z_1_131)))
(assert
 (= z_0_133 (and z_1_133 z_0_67)))
(assert
...
(assert
 (= z_0_157 (and z_1_157 z_0_108)))
(assert
 (= z_0_158 (and z_1_158 z_0_159)))
(assert
 (= z_0_159 (and z_1_159 z_0_160)))
(assert
 (= z_0_160 (and z_1_160 z_0_144)))
(assert
 (= z_0_161 (and z_1_161 z_0_114)))
(assert
 (= z_0_162 (and z_1_162 z_0_13)))
(assert
...
(assert
 (= z_0_183 (and z_1_183 z_0_87)))
(assert
 (= z_0_184 (and z_1_184 z_0_185)))
(assert
 (= z_0_185 (and z_1_185 z_0_104)))
(assert
...
(assert
 (= z_0_210 (and z_1_210 z_0_194)))
(assert
 (= z_0_211 (and z_1_211 z_0_165)))
(assert
 (= z_0_212 (and z_1_212 z_0_143)))
(assert
...
(assert
 (= z_0_222 (and z_1_222 z_0_8)))
(assert
 (= z_0_223 (and z_1_223 z_0_224)))
(assert
 (= z_0_224 (and z_1_224 z_0_151)))
(assert
 (= z_0_225 (and z_1_225 z_0_226)))
(assert
 (= z_0_226 (and z_1_226 z_0_70)))
(assert
 (= z_0_227 (and z_1_227 z_0_177)))
(assert
 (= z_0_228 (and z_1_228 z_0_38)))
(assert
 z_0_0)
(assert
 (not z_0_1))
