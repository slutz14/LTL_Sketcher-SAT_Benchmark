...
(assert
 ...
 (=> x_0_X $x1270)))
(assert
 (let (($x1275 (or z_1_61 z_1_62 z_1_63 z_1_64)))
 (let (($x1276 (= z_0_61 $x1275)))
 (=> x_0_F $x1276))))
(assert
 (let (($x1280 (= z_0_61 (and z_1_61 z_1_62 z_1_63 z_1_64))))
 (=> x_0_G $x1280)))
(assert
 (=> x_0_! (= z_0_62 (not z_1_62))))
(assert
 (let (($x1290 (= z_0_62 z_1_63)))
 (=> x_0_X $x1290)))
(assert
 (=> x_0_F (= z_0_62 (or z_1_62 z_1_63 z_1_64 z_1_61))))
(assert
 (let (($x1299 (= z_0_62 (and z_1_62 z_1_63 z_1_64 z_1_61))))
 (=> x_0_G $x1299)))
(assert
 (=> x_0_! (= z_0_63 (not z_1_63))))
(assert
 (let (($x1309 (= z_0_63 z_1_64)))
 (=> x_0_X $x1309)))
(assert
 (=> x_0_F (= z_0_63 (or z_1_63 z_1_64 z_1_61 z_1_62))))
(assert
 (let (($x1318 (= z_0_63 (and z_1_63 z_1_64 z_1_61 z_1_62))))
 (=> x_0_G $x1318)))
(assert
 (=> x_0_! (= z_0_64 (not z_1_64))))
(assert
 (let (($x1328 (= z_0_64 z_1_61)))
 (=> x_0_X $x1328)))
(assert
 (=> x_0_F (= z_0_64 (or z_1_64 z_0_61))))
(assert
 (let (($x1338 (= z_0_64 (and z_1_64 z_0_61))))
 (=> x_0_G $x1338)))
(assert
 (let (($x1342 (not z_2_0)))
 (= z_1_0 $x1342)))
...
(assert
 (= z_1_12 (not z_2_12)))
(assert
 (let (($x1407 (not z_2_13)))
 (= z_1_13 $x1407)))
(assert
 (let (($x1412 (not z_2_14)))
 (= z_1_14 $x1412)))
(assert
 (let (($x1417 (not z_2_15)))
 (= z_1_15 $x1417)))
(assert
 (let (($x1422 (not z_2_16)))
 (= z_1_16 $x1422)))
(assert
 (= z_1_17 (not z_2_17)))
(assert
 (let (($x1432 (not z_2_18)))
 (= z_1_18 $x1432)))
(assert
 (let (($x1437 (not z_2_19)))
 (= z_1_19 $x1437)))
(assert
 (= z_1_20 (not z_2_20)))
(assert
 (= z_1_21 (not z_2_21)))
(assert
 (let (($x1452 (not z_2_22)))
 (= z_1_22 $x1452)))
(assert
 (let (($x1457 (not z_2_23)))
 (= z_1_23 $x1457)))
(assert
 (= z_1_24 (not z_2_24)))
(assert
 (let (($x1467 (not z_2_25)))
 (= z_1_25 $x1467)))
(assert
 (= z_1_26 (not z_2_26)))
(assert
...
(assert
 (= z_1_28 (not z_2_28)))
(assert
 (let (($x1487 (not z_2_29)))
 (= z_1_29 $x1487)))
(assert
 (= z_1_30 (not z_2_30)))
(assert
 (let (($x1497 (not z_2_31)))
 (= z_1_31 $x1497)))
(assert
 (let (($x1502 (not z_2_32)))
 (= z_1_32 $x1502)))
(assert
 (let (($x1507 (not z_2_33)))
 (= z_1_33 $x1507)))
(assert
 (= z_1_34 (not z_2_34)))
(assert
...
(assert
 (= z_1_36 (not z_2_36)))
(assert
 (let (($x1527 (not z_2_37)))
 (= z_1_37 $x1527)))
(assert
 (let (($x1532 (not z_2_38)))
 (= z_1_38 $x1532)))
(assert
 (= z_1_39 (not z_2_39)))
(assert
 (= z_1_40 (not z_2_40)))
(assert
 (let (($x1547 (not z_2_41)))
 (= z_1_41 $x1547)))
(assert
 (let (($x1552 (not z_2_42)))
 (= z_1_42 $x1552)))
(assert
 (let (($x1557 (not z_2_43)))
 (= z_1_43 $x1557)))
(assert
 (= z_1_44 (not z_2_44)))
(assert
 (= z_1_45 (not z_2_45)))
(assert
 (let (($x1572 (not z_2_46)))
 (= z_1_46 $x1572)))
(assert
 (let (($x1577 (not z_2_47)))
 (= z_1_47 $x1577)))
(assert
 (let (($x1582 (not z_2_48)))
 (= z_1_48 $x1582)))
(assert
 (let (($x1587 (not z_2_49)))
 (= z_1_49 $x1587)))
(assert
 (let (($x1592 (not z_2_50)))
 (= z_1_50 $x1592)))
(assert
 (= z_1_51 (not z_2_51)))
(assert
 (= z_1_52 (not z_2_52)))
(assert
 (let (($x1607 (not z_2_53)))
 (= z_1_53 $x1607)))
(assert
 (= z_1_54 (not z_2_54)))
(assert
 (let (($x1617 (not z_2_55)))
 (= z_1_55 $x1617)))
(assert
 (let (($x1622 (not z_2_56)))
 (= z_1_56 $x1622)))
(assert
 (= z_1_57 (not z_2_57)))
(assert
 (let (($x1632 (not z_2_58)))
 (= z_1_58 $x1632)))
(assert
 (let (($x1637 (not z_2_59)))
 (= z_1_59 $x1637)))
(assert
 (= z_1_60 (not z_2_60)))
(assert
