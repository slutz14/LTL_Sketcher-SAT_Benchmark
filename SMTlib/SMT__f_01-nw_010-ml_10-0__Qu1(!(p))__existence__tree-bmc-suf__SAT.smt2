...
(assert
 (= z_1_17 (not z_2_17)))
(assert
 (let (($x1469 (not z_2_18)))
 (= z_1_18 $x1469)))
(assert
 (let (($x1474 (not z_2_19)))
 (= z_1_19 $x1474)))
(assert
 (let (($x1479 (not z_2_20)))
 (= z_1_20 $x1479)))
(assert
 (let (($x1484 (not z_2_21)))
 (= z_1_21 $x1484)))
(assert
 (= z_1_22 (not z_2_22)))
(assert
 (let (($x1494 (not z_2_23)))
 (= z_1_23 $x1494)))
(assert
 (let (($x1499 (not z_2_24)))
 (= z_1_24 $x1499)))
(assert
 (= z_1_25 (not z_2_25)))
(assert
 (= z_1_26 (not z_2_26)))
(assert
 (let (($x1514 (not z_2_27)))
 (= z_1_27 $x1514)))
(assert
 (= z_1_28 (not z_2_28)))
(assert
 (let (($x1524 (not z_2_29)))
 (= z_1_29 $x1524)))
(assert
 (let (($x1529 (not z_2_30)))
 (= z_1_30 $x1529)))
(assert
 (= z_1_31 (not z_2_31)))
(assert
 (let (($x1539 (not z_2_32)))
 (= z_1_32 $x1539)))
(assert
 (let (($x1544 (not z_2_33)))
 (= z_1_33 $x1544)))
(assert
 (= z_1_34 (not z_2_34)))
(assert
...
(assert
 (= z_1_40 (not z_2_40)))
(assert
 (let (($x1584 (not z_2_41)))
 (= z_1_41 $x1584)))
(assert
 (= z_1_42 (not z_2_42)))
(assert
 (let (($x1594 (not z_2_43)))
 (= z_1_43 $x1594)))
(assert
 (= z_1_44 (not z_2_44)))
(assert
 (let (($x1604 (not z_2_45)))
 (= z_1_45 $x1604)))
(assert
 (= z_1_46 (not z_2_46)))
(assert
...
(assert
 (= z_1_60 (not z_2_60)))
(assert
 (let (($x1684 (not z_2_61)))
 (= z_1_61 $x1684)))
(assert
 (let (($x1689 (not z_2_62)))
 (= z_1_62 $x1689)))
(assert
 (= z_1_63 (not z_2_63)))
(assert
 (let (($x1699 (not z_2_64)))
 (= z_1_64 $x1699)))
(assert
 (= z_1_65 (not z_2_65)))
(assert
