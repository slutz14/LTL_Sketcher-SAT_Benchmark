...
(assert
 (= z_2_624 (or z_3_624 z_2_431)))
(assert
 (= z_2_625 (or z_3_625 z_2_626)))
(assert
 (= z_2_626 (or z_3_626 z_2_627)))
(assert
 (= z_2_627 (or z_3_627 z_2_628)))
(assert
...
(assert
 (= z_2_645 (or z_3_645 z_2_425)))
(assert
 (= z_2_646 (or z_3_646 z_2_647)))
(assert
 (= z_2_647 (or z_3_647 z_2_539)))
(assert
 (= z_2_648 (or z_3_648 z_2_649)))
(assert
 (= z_2_649 (or z_3_649 z_2_650)))
(assert
 (= z_2_650 (or z_3_650 z_2_517)))
(assert
 (= z_2_651 (or z_3_651 z_2_652)))
(assert
 (= z_2_652 (or z_3_652 z_2_438)))
(assert
...
(assert
 (= z_2_670 (or z_3_670 z_2_641)))
(assert
 (= z_2_671 (or z_3_671 z_2_498)))
(assert
 (= z_2_672 (or z_3_672 z_2_673)))
(assert
 (= z_2_673 (or z_3_673 z_2_652)))
(assert
...
(assert
 (= z_2_688 (or z_3_688)))
(assert
 (= z_2_689 (or z_3_689 z_2_690)))
(assert
 (= z_2_690 (or z_3_690 z_2_691)))
(assert
 (= z_2_691 (or z_3_691 z_2_692)))
(assert
 (= z_2_692 (or z_3_692 z_2_488)))
(assert
 (= z_2_693 (or z_3_693 z_2_694)))
(assert
 (= z_2_694 (or z_3_694 z_2_695)))
(assert
 (= z_2_695 (or z_3_695 z_2_443)))
(assert
...
(assert
 (= z_5_624 (or z_6_624 z_5_431)))
(assert
 (= z_5_625 (or z_6_625 z_5_626)))
(assert
 (= z_5_626 (or z_6_626 z_5_627)))
(assert
 (= z_5_627 (or z_6_627 z_5_628)))
(assert
...
(assert
 (= z_5_645 (or z_6_645 z_5_425)))
(assert
 (= z_5_646 (or z_6_646 z_5_647)))
(assert
 (= z_5_647 (or z_6_647 z_5_539)))
(assert
 (= z_5_648 (or z_6_648 z_5_649)))
(assert
 (= z_5_649 (or z_6_649 z_5_650)))
(assert
 (= z_5_650 (or z_6_650 z_5_517)))
(assert
 (= z_5_651 (or z_6_651 z_5_652)))
(assert
 (= z_5_652 (or z_6_652 z_5_438)))
(assert
...
(assert
 (= z_5_670 (or z_6_670 z_5_641)))
(assert
 (= z_5_671 (or z_6_671 z_5_498)))
(assert
 (= z_5_672 (or z_6_672 z_5_673)))
(assert
 (= z_5_673 (or z_6_673 z_5_652)))
(assert
...
(assert
 (= z_5_688 (or z_6_688)))
(assert
 (= z_5_689 (or z_6_689 z_5_690)))
(assert
 (= z_5_690 (or z_6_690 z_5_691)))
(assert
 (= z_5_691 (or z_6_691 z_5_692)))
(assert
 (= z_5_692 (or z_6_692 z_5_488)))
(assert
 (= z_5_693 (or z_6_693 z_5_694)))
(assert
 (= z_5_694 (or z_6_694 z_5_695)))
(assert
 (= z_5_695 (or z_6_695 z_5_443)))
(assert
 (not z_6_0))
(assert
 z_6_1)
