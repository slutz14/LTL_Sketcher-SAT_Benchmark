...
(assert
 ...
 (= z_1_10 $x1395)))
(assert
 (let (($x1400 (not z_2_11)))
 (= z_1_11 $x1400)))
(assert
 (let (($x1405 (not z_2_12)))
 (= z_1_12 $x1405)))
(assert
...
(assert
 ...
 (= z_1_19 $x1440)))
(assert
 (let (($x1445 (not z_2_20)))
 (= z_1_20 $x1445)))
(assert
 (let (($x1450 (not z_2_21)))
 (= z_1_21 $x1450)))
(assert
...
(assert
 ...
 (= z_1_23 $x1460)))
(assert
 (let (($x1465 (not z_2_24)))
 (= z_1_24 $x1465)))
(assert
 (let (($x1470 (not z_2_25)))
 (= z_1_25 $x1470)))
(assert
 (let (($x1475 (not z_2_26)))
 (= z_1_26 $x1475)))
(assert
 (let (($x1480 (not z_2_27)))
 (= z_1_27 $x1480)))
(assert
 (let (($x1485 (not z_2_28)))
 (= z_1_28 $x1485)))
(assert
 (let (($x1490 (not z_2_29)))
 (= z_1_29 $x1490)))
(assert
 (let (($x1495 (not z_2_30)))
 (= z_1_30 $x1495)))
(assert
...
(assert
 ...
 (= z_1_33 $x1510)))
(assert
 (let (($x1515 (not z_2_34)))
 (= z_1_34 $x1515)))
(assert
 (let (($x1520 (not z_2_35)))
 (= z_1_35 $x1520)))
(assert
 (let (($x1525 (not z_2_36)))
 (= z_1_36 $x1525)))
(assert
...
(assert
 ...
 (= z_1_38 $x1535)))
(assert
 (let (($x1540 (not z_2_39)))
 (= z_1_39 $x1540)))
(assert
 (let (($x1545 (not z_2_40)))
 (= z_1_40 $x1545)))
(assert
...
(assert
 ...
 (= z_1_43 $x1560)))
(assert
 (let (($x1565 (not z_2_44)))
 (= z_1_44 $x1565)))
(assert
 (let (($x1570 (not z_2_45)))
 (= z_1_45 $x1570)))
(assert
...
(assert
 ...
 (= z_1_50 $x1595)))
(assert
 (let (($x1600 (not z_2_51)))
 (= z_1_51 $x1600)))
(assert
 (let (($x1605 (not z_2_52)))
 (= z_1_52 $x1605)))
(assert
 (let (($x1610 (not z_2_53)))
 (= z_1_53 $x1610)))
(assert
 (let (($x1615 (not z_2_54)))
 (= z_1_54 $x1615)))
(assert
...
(assert
 ...
 (= z_1_59 $x1640)))
(assert
 (let (($x1645 (not z_2_60)))
 (= z_1_60 $x1645)))
(assert
 (let (($x1650 (not z_2_61)))
 (= z_1_61 $x1650)))
(assert
 (let (($x1655 (not z_2_62)))
 (= z_1_62 $x1655)))
(assert
 (let (($x1660 (not z_2_63)))
 (= z_1_63 $x1660)))
(assert
