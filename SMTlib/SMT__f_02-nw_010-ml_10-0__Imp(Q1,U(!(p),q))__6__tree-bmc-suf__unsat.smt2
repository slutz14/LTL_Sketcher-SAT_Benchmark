...
(assert
 (let (($x1313 (and z_5_8 z_3_9 z_3_6 z_3_7)))
 (let (($x1312 (and z_5_7 z_3_9 z_3_6)))
 (let (($x1311 (and z_5_6 z_3_9)))
 (= z_2_9 (or (and z_5_9) $x1311 $x1312 $x1313))))))
(assert
...
(assert
 (let (($x1389 (and z_5_22 z_3_23 z_3_19 z_3_20 z_3_21)))
 (let (($x1388 (and z_5_21 z_3_23 z_3_19 z_3_20)))
 (let (($x1387 (and z_5_20 z_3_23 z_3_19)))
 (let (($x1386 (and z_5_19 z_3_23)))
 (= z_2_23 (or (and z_5_23) $x1386 $x1387 $x1388 $x1389)))))))
(assert
...
(assert
 (let (($x1440 (and z_5_31 z_3_32 z_3_28 z_3_29 z_3_30)))
 (let (($x1439 (and z_5_30 z_3_32 z_3_28 z_3_29)))
 (let (($x1438 (and z_5_29 z_3_32 z_3_28)))
 (let (($x1437 (and z_5_28 z_3_32)))
 (= z_2_32 (or (and z_5_32) $x1437 $x1438 $x1439 $x1440)))))))
(assert
...
(assert
 (let (($x1491 (and z_5_40 z_3_41 z_3_37 z_3_38 z_3_39)))
 (let (($x1490 (and z_5_39 z_3_41 z_3_37 z_3_38)))
 (let (($x1489 (and z_5_38 z_3_41 z_3_37)))
 (let (($x1488 (and z_5_37 z_3_41)))
 (= z_2_41 (or (and z_5_41) $x1488 $x1489 $x1490 $x1491)))))))
(assert
...
(assert
 (let (($x1567 (and z_5_54 z_3_55 z_3_51 z_3_52 z_3_53)))
 (let (($x1566 (and z_5_53 z_3_55 z_3_51 z_3_52)))
 (let (($x1565 (and z_5_52 z_3_55 z_3_51)))
 (let (($x1564 (and z_5_51 z_3_55)))
 (= z_2_55 (or (and z_5_55) $x1564 $x1565 $x1566 $x1567)))))))
(assert
...
(assert
 (let (($x1632 (and z_5_66 z_3_67 z_3_64 z_3_65)))
 (let (($x1631 (and z_5_65 z_3_67 z_3_64)))
 (let (($x1630 (and z_5_64 z_3_67)))
 (= z_2_67 (or (and z_5_67) $x1630 $x1631 $x1632))))))
(assert
...
(assert
 (let (($x1699 (and z_5_78 z_3_79 z_3_74 z_3_75 z_3_76 z_3_77)))
 (let (($x1698 (and z_5_77 z_3_79 z_3_74 z_3_75 z_3_76)))
 (let (($x1697 (and z_5_76 z_3_79 z_3_74 z_3_75)))
 (let (($x1696 (and z_5_75 z_3_79 z_3_74)))
 (let (($x1695 (and z_5_74 z_3_79)))
 (= z_2_79 (or (and z_5_79) $x1695 $x1696 $x1697 $x1698 $x1699))))))))
(assert
...
(assert
 (let (($x1760 (and z_5_89 z_3_90 z_3_86 z_3_87 z_3_88)))
 (let (($x1759 (and z_5_88 z_3_90 z_3_86 z_3_87)))
 (let (($x1758 (and z_5_87 z_3_90 z_3_86)))
 (let (($x1757 (and z_5_86 z_3_90)))
 (= z_2_90 (or (and z_5_90) $x1757 $x1758 $x1759 $x1760)))))))
(assert
...
(assert
 (let (($x1822 (and z_5_100 z_3_101 z_3_96 z_3_97 z_3_98 z_3_99)))
 (let (($x1821 (and z_5_99 z_3_101 z_3_96 z_3_97 z_3_98)))
 (let (($x1820 (and z_5_98 z_3_101 z_3_96 z_3_97)))
 (let (($x1819 (and z_5_97 z_3_101 z_3_96)))
 (let (($x1818 (and z_5_96 z_3_101)))
 (= z_2_101 (or (and z_5_101) $x1818 $x1819 $x1820 $x1821 $x1822))))))))
(assert
...
(assert
 (let (($x1862 (and z_5_107 z_3_108 z_3_105 z_3_106)))
 (let (($x1861 (and z_5_106 z_3_108 z_3_105)))
 (let (($x1860 (and z_5_105 z_3_108)))
 (= z_2_108 (or (and z_5_108) $x1860 $x1861 $x1862))))))
(assert
...
(assert
 (let (($x1907 (and z_5_115 z_3_116 z_3_113 z_3_114)))
 (let (($x1906 (and z_5_114 z_3_116 z_3_113)))
 (let (($x1905 (and z_5_113 z_3_116)))
 (= z_2_116 (or (and z_5_116) $x1905 $x1906 $x1907))))))
(assert
...
(assert
 (= z_2_121 (or z_5_121 (and z_3_121 z_2_122))))
(assert
...
(assert
 (let (($x1962 (and z_5_125 z_3_126 z_3_123 z_3_124)))
 (let (($x1961 (and z_5_124 z_3_126 z_3_123)))
 (let (($x1960 (and z_5_123 z_3_126)))
 (= z_2_126 (or (and z_5_126) $x1960 $x1961 $x1962))))))
(assert
...
(assert
 (let (($x2014 (and z_5_134 z_3_135 z_3_130 z_3_131 z_3_132 z_3_133)))
 (let (($x2013 (and z_5_133 z_3_135 z_3_130 z_3_131 z_3_132)))
 (let (($x2012 (and z_5_132 z_3_135 z_3_130 z_3_131)))
 (let (($x2011 (and z_5_131 z_3_135 z_3_130)))
 (let (($x2010 (and z_5_130 z_3_135)))
 (= z_2_135 (or (and z_5_135) $x2010 $x2011 $x2012 $x2013 $x2014))))))))
(assert
...
(assert
 (let (($x2065 (and z_5_143 z_3_144 z_3_140 z_3_141 z_3_142)))
 (let (($x2064 (and z_5_142 z_3_144 z_3_140 z_3_141)))
 (let (($x2063 (and z_5_141 z_3_144 z_3_140)))
 (let (($x2062 (and z_5_140 z_3_144)))
 (= z_2_144 (or (and z_5_144) $x2062 $x2063 $x2064 $x2065)))))))
(assert
...
(assert
 (let (($x2120 (and z_5_153 z_3_154 z_3_151 z_3_152)))
 (let (($x2119 (and z_5_152 z_3_154 z_3_151)))
 (let (($x2118 (and z_5_151 z_3_154)))
 (= z_2_154 (or (and z_5_154) $x2118 $x2119 $x2120))))))
(assert
 (let (($x2126 (not z_4_0)))
 (= z_3_0 $x2126)))
(assert
...
(assert
 ...
 (= z_3_9 $x2171)))
(assert
 (let (($x2176 (not z_4_10)))
 (= z_3_10 $x2176)))
(assert
 (let (($x2181 (not z_4_11)))
 (= z_3_11 $x2181)))
(assert
 (let (($x2186 (not z_4_12)))
 (= z_3_12 $x2186)))
(assert
 (let (($x2191 (not z_4_13)))
 (= z_3_13 $x2191)))
(assert
 (let (($x2196 (not z_4_14)))
 (= z_3_14 $x2196)))
(assert
 (let (($x2201 (not z_4_15)))
 (= z_3_15 $x2201)))
(assert
 (let (($x2206 (not z_4_16)))
 (= z_3_16 $x2206)))
(assert
 (let (($x2211 (not z_4_17)))
 (= z_3_17 $x2211)))
(assert
 (let (($x2216 (not z_4_18)))
 (= z_3_18 $x2216)))
(assert
 (let (($x2221 (not z_4_19)))
 (= z_3_19 $x2221)))
(assert
 (let (($x2226 (not z_4_20)))
 (= z_3_20 $x2226)))
(assert
 (let (($x2231 (not z_4_21)))
 (= z_3_21 $x2231)))
(assert
 (let (($x2236 (not z_4_22)))
 (= z_3_22 $x2236)))
(assert
 (let (($x2241 (not z_4_23)))
 (= z_3_23 $x2241)))
(assert
 (let (($x2246 (not z_4_24)))
 (= z_3_24 $x2246)))
(assert
 (let (($x2251 (not z_4_25)))
 (= z_3_25 $x2251)))
(assert
 (let (($x2256 (not z_4_26)))
 (= z_3_26 $x2256)))
(assert
 (let (($x2261 (not z_4_27)))
 (= z_3_27 $x2261)))
(assert
 (let (($x2266 (not z_4_28)))
 (= z_3_28 $x2266)))
(assert
 (let (($x2271 (not z_4_29)))
 (= z_3_29 $x2271)))
(assert
 (let (($x2276 (not z_4_30)))
 (= z_3_30 $x2276)))
(assert
 (let (($x2281 (not z_4_31)))
 (= z_3_31 $x2281)))
(assert
 (let (($x2286 (not z_4_32)))
 (= z_3_32 $x2286)))
(assert
 (let (($x2291 (not z_4_33)))
 (= z_3_33 $x2291)))
(assert
 (let (($x2296 (not z_4_34)))
 (= z_3_34 $x2296)))
(assert
 (let (($x2301 (not z_4_35)))
 (= z_3_35 $x2301)))
(assert
 (let (($x2306 (not z_4_36)))
 (= z_3_36 $x2306)))
(assert
 (let (($x2311 (not z_4_37)))
 (= z_3_37 $x2311)))
(assert
 (let (($x2316 (not z_4_38)))
 (= z_3_38 $x2316)))
(assert
 (let (($x2321 (not z_4_39)))
 (= z_3_39 $x2321)))
(assert
 (let (($x2326 (not z_4_40)))
 (= z_3_40 $x2326)))
(assert
 (let (($x2331 (not z_4_41)))
 (= z_3_41 $x2331)))
(assert
 (let (($x2336 (not z_4_42)))
 (= z_3_42 $x2336)))
(assert
 (let (($x2341 (not z_4_43)))
 (= z_3_43 $x2341)))
(assert
 (let (($x2346 (not z_4_44)))
 (= z_3_44 $x2346)))
(assert
 (let (($x2351 (not z_4_45)))
 (= z_3_45 $x2351)))
(assert
 (let (($x2356 (not z_4_46)))
 (= z_3_46 $x2356)))
(assert
 (let (($x2361 (not z_4_47)))
 (= z_3_47 $x2361)))
(assert
 (let (($x2366 (not z_4_48)))
 (= z_3_48 $x2366)))
(assert
 (let (($x2371 (not z_4_49)))
 (= z_3_49 $x2371)))
(assert
 (let (($x2376 (not z_4_50)))
 (= z_3_50 $x2376)))
(assert
 (let (($x2381 (not z_4_51)))
 (= z_3_51 $x2381)))
(assert
 (let (($x2386 (not z_4_52)))
 (= z_3_52 $x2386)))
(assert
 (let (($x2391 (not z_4_53)))
 (= z_3_53 $x2391)))
(assert
 (let (($x2396 (not z_4_54)))
 (= z_3_54 $x2396)))
(assert
 (let (($x2401 (not z_4_55)))
 (= z_3_55 $x2401)))
(assert
 (let (($x2406 (not z_4_56)))
 (= z_3_56 $x2406)))
(assert
 (let (($x2411 (not z_4_57)))
 (= z_3_57 $x2411)))
(assert
 (let (($x2416 (not z_4_58)))
 (= z_3_58 $x2416)))
(assert
 (let (($x2421 (not z_4_59)))
 (= z_3_59 $x2421)))
(assert
 (let (($x2426 (not z_4_60)))
 (= z_3_60 $x2426)))
(assert
 (let (($x2431 (not z_4_61)))
 (= z_3_61 $x2431)))
(assert
 (let (($x2436 (not z_4_62)))
 (= z_3_62 $x2436)))
(assert
 (let (($x2441 (not z_4_63)))
 (= z_3_63 $x2441)))
(assert
 (let (($x2446 (not z_4_64)))
 (= z_3_64 $x2446)))
(assert
 (let (($x2451 (not z_4_65)))
 (= z_3_65 $x2451)))
(assert
 (let (($x2456 (not z_4_66)))
 (= z_3_66 $x2456)))
(assert
 (let (($x2461 (not z_4_67)))
 (= z_3_67 $x2461)))
(assert
 (let (($x2466 (not z_4_68)))
 (= z_3_68 $x2466)))
(assert
 (let (($x2471 (not z_4_69)))
 (= z_3_69 $x2471)))
(assert
 (let (($x2476 (not z_4_70)))
 (= z_3_70 $x2476)))
(assert
 (let (($x2481 (not z_4_71)))
 (= z_3_71 $x2481)))
(assert
 (let (($x2486 (not z_4_72)))
 (= z_3_72 $x2486)))
(assert
 (let (($x2491 (not z_4_73)))
 (= z_3_73 $x2491)))
(assert
 (let (($x2496 (not z_4_74)))
 (= z_3_74 $x2496)))
(assert
 (let (($x2501 (not z_4_75)))
 (= z_3_75 $x2501)))
(assert
 (let (($x2506 (not z_4_76)))
 (= z_3_76 $x2506)))
(assert
 (let (($x2511 (not z_4_77)))
 (= z_3_77 $x2511)))
(assert
 (let (($x2516 (not z_4_78)))
 (= z_3_78 $x2516)))
(assert
 (let (($x2521 (not z_4_79)))
 (= z_3_79 $x2521)))
(assert
 (let (($x2526 (not z_4_80)))
 (= z_3_80 $x2526)))
(assert
 (let (($x2531 (not z_4_81)))
 (= z_3_81 $x2531)))
(assert
 (let (($x2536 (not z_4_82)))
 (= z_3_82 $x2536)))
(assert
 (let (($x2541 (not z_4_83)))
 (= z_3_83 $x2541)))
(assert
 (let (($x2546 (not z_4_84)))
 (= z_3_84 $x2546)))
(assert
 (let (($x2551 (not z_4_85)))
 (= z_3_85 $x2551)))
(assert
 (let (($x2556 (not z_4_86)))
 (= z_3_86 $x2556)))
(assert
 (let (($x2561 (not z_4_87)))
 (= z_3_87 $x2561)))
(assert
 (let (($x2566 (not z_4_88)))
 (= z_3_88 $x2566)))
(assert
 (let (($x2571 (not z_4_89)))
 (= z_3_89 $x2571)))
(assert
 (let (($x2576 (not z_4_90)))
 (= z_3_90 $x2576)))
(assert
 (let (($x2581 (not z_4_91)))
 (= z_3_91 $x2581)))
(assert
 (let (($x2586 (not z_4_92)))
 (= z_3_92 $x2586)))
(assert
 (let (($x2591 (not z_4_93)))
 (= z_3_93 $x2591)))
(assert
 (let (($x2596 (not z_4_94)))
 (= z_3_94 $x2596)))
(assert
 (let (($x2601 (not z_4_95)))
 (= z_3_95 $x2601)))
(assert
 (let (($x2606 (not z_4_96)))
 (= z_3_96 $x2606)))
(assert
 (let (($x2611 (not z_4_97)))
 (= z_3_97 $x2611)))
(assert
 (let (($x2616 (not z_4_98)))
 (= z_3_98 $x2616)))
(assert
 (let (($x2621 (not z_4_99)))
 (= z_3_99 $x2621)))
(assert
 (let (($x2626 (not z_4_100)))
 (= z_3_100 $x2626)))
(assert
 (let (($x2631 (not z_4_101)))
 (= z_3_101 $x2631)))
(assert
 (let (($x2636 (not z_4_102)))
 (= z_3_102 $x2636)))
(assert
 (let (($x2641 (not z_4_103)))
 (= z_3_103 $x2641)))
(assert
 (let (($x2646 (not z_4_104)))
 (= z_3_104 $x2646)))
(assert
 (let (($x2651 (not z_4_105)))
 (= z_3_105 $x2651)))
(assert
 (let (($x2656 (not z_4_106)))
 (= z_3_106 $x2656)))
(assert
 (let (($x2661 (not z_4_107)))
 (= z_3_107 $x2661)))
(assert
 (let (($x2666 (not z_4_108)))
 (= z_3_108 $x2666)))
(assert
 (let (($x2671 (not z_4_109)))
 (= z_3_109 $x2671)))
(assert
 (let (($x2676 (not z_4_110)))
 (= z_3_110 $x2676)))
(assert
 (let (($x2681 (not z_4_111)))
 (= z_3_111 $x2681)))
(assert
 (let (($x2686 (not z_4_112)))
 (= z_3_112 $x2686)))
(assert
 (let (($x2691 (not z_4_113)))
 (= z_3_113 $x2691)))
(assert
 (let (($x2696 (not z_4_114)))
 (= z_3_114 $x2696)))
(assert
 (let (($x2701 (not z_4_115)))
 (= z_3_115 $x2701)))
(assert
 (let (($x2706 (not z_4_116)))
 (= z_3_116 $x2706)))
(assert
 (let (($x2711 (not z_4_117)))
 (= z_3_117 $x2711)))
(assert
 (let (($x2716 (not z_4_118)))
 (= z_3_118 $x2716)))
(assert
 (let (($x2721 (not z_4_119)))
 (= z_3_119 $x2721)))
(assert
 (let (($x2726 (not z_4_120)))
 (= z_3_120 $x2726)))
(assert
 (let (($x2731 (not z_4_121)))
 (= z_3_121 $x2731)))
(assert
 (let (($x2736 (not z_4_122)))
 (= z_3_122 $x2736)))
(assert
 (let (($x2741 (not z_4_123)))
 (= z_3_123 $x2741)))
(assert
 (let (($x2746 (not z_4_124)))
 (= z_3_124 $x2746)))
(assert
 (let (($x2751 (not z_4_125)))
 (= z_3_125 $x2751)))
(assert
 (let (($x2756 (not z_4_126)))
 (= z_3_126 $x2756)))
(assert
 (let (($x2761 (not z_4_127)))
 (= z_3_127 $x2761)))
(assert
 (let (($x2766 (not z_4_128)))
 (= z_3_128 $x2766)))
(assert
 (let (($x2771 (not z_4_129)))
 (= z_3_129 $x2771)))
(assert
 (let (($x2776 (not z_4_130)))
 (= z_3_130 $x2776)))
(assert
 (let (($x2781 (not z_4_131)))
 (= z_3_131 $x2781)))
(assert
 (let (($x2786 (not z_4_132)))
 (= z_3_132 $x2786)))
(assert
 (let (($x2791 (not z_4_133)))
 (= z_3_133 $x2791)))
(assert
 (let (($x2796 (not z_4_134)))
 (= z_3_134 $x2796)))
(assert
 (let (($x2801 (not z_4_135)))
 (= z_3_135 $x2801)))
(assert
 (let (($x2806 (not z_4_136)))
 (= z_3_136 $x2806)))
(assert
 (let (($x2811 (not z_4_137)))
 (= z_3_137 $x2811)))
(assert
 (let (($x2816 (not z_4_138)))
 (= z_3_138 $x2816)))
(assert
 (let (($x2821 (not z_4_139)))
 (= z_3_139 $x2821)))
(assert
 (let (($x2826 (not z_4_140)))
 (= z_3_140 $x2826)))
(assert
 (let (($x2831 (not z_4_141)))
 (= z_3_141 $x2831)))
(assert
 (let (($x2836 (not z_4_142)))
 (= z_3_142 $x2836)))
(assert
 (let (($x2841 (not z_4_143)))
 (= z_3_143 $x2841)))
(assert
 (let (($x2846 (not z_4_144)))
 (= z_3_144 $x2846)))
(assert
 (let (($x2851 (not z_4_145)))
 (= z_3_145 $x2851)))
(assert
 (let (($x2856 (not z_4_146)))
 (= z_3_146 $x2856)))
(assert
 (let (($x2861 (not z_4_147)))
 (= z_3_147 $x2861)))
(assert
 (let (($x2866 (not z_4_148)))
 (= z_3_148 $x2866)))
(assert
 (let (($x2871 (not z_4_149)))
 (= z_3_149 $x2871)))
(assert
 (let (($x2876 (not z_4_150)))
 (= z_3_150 $x2876)))
(assert
 (let (($x2881 (not z_4_151)))
 (= z_3_151 $x2881)))
(assert
 (let (($x2886 (not z_4_152)))
 (= z_3_152 $x2886)))
(assert
 (let (($x2891 (not z_4_153)))
 (= z_3_153 $x2891)))
(assert
 (let (($x2896 (not z_4_154)))
 (= z_3_154 $x2896)))
(assert
 z_4_0)
(assert
...
(assert
 (=> x_6_p z_6_10))
(assert
 (let (($x3789 (not z_6_11)))
 (=> x_6_p $x3789)))
(assert
 (let (($x3736 (not z_6_12)))
 (=> x_6_p $x3736)))
(assert
 (=> x_6_p z_6_13))
(assert
 (let (($x3629 (not z_6_14)))
 (=> x_6_p $x3629)))
(assert
 (let (($x3576 (not z_6_15)))
 (=> x_6_p $x3576)))
(assert
 (let (($x3522 (not z_6_16)))
 (=> x_6_p $x3522)))
(assert
 (=> x_6_p z_6_17))
(assert
 (let (($x3414 (not z_6_18)))
 (=> x_6_p $x3414)))
(assert
 (let (($x3360 (not z_6_19)))
 (=> x_6_p $x3360)))
(assert
 (let (($x3306 (not z_6_20)))
 (=> x_6_p $x3306)))
(assert
 (=> x_6_p z_6_21))
(assert
 (let (($x3198 (not z_6_22)))
 (=> x_6_p $x3198)))
(assert
 (=> x_6_p z_6_23))
(assert
 (let (($x3090 (not z_6_24)))
 (=> x_6_p $x3090)))
(assert
 (=> x_6_p z_6_25))
(assert
 (=> x_6_p z_6_26))
(assert
 (let (($x4398 (not z_6_27)))
 (=> x_6_p $x4398)))
(assert
 (let (($x4389 (not z_6_28)))
 (=> x_6_p $x4389)))
(assert
 (=> x_6_p z_6_29))
(assert
 (let (($x4371 (not z_6_30)))
 (=> x_6_p $x4371)))
(assert
 (=> x_6_p z_6_31))
(assert
 (=> x_6_p z_6_32))
(assert
 (let (($x4344 (not z_6_33)))
 (=> x_6_p $x4344)))
(assert
 (=> x_6_p z_6_34))
(assert
 (let (($x4327 (not z_6_35)))
 (=> x_6_p $x4327)))
(assert
 (let (($x4318 (not z_6_36)))
 (=> x_6_p $x4318)))
(assert
 (let (($x4309 (not z_6_37)))
 (=> x_6_p $x4309)))
(assert
 (let (($x4300 (not z_6_38)))
 (=> x_6_p $x4300)))
(assert
 (let (($x4291 (not z_6_39)))
 (=> x_6_p $x4291)))
(assert
 (let (($x4282 (not z_6_40)))
 (=> x_6_p $x4282)))
(assert
 (=> x_6_p z_6_41))
(assert
 (=> x_6_p z_6_42))
(assert
 (let (($x4255 (not z_6_43)))
 (=> x_6_p $x4255)))
(assert
 (let (($x4247 (not z_6_44)))
 (=> x_6_p $x4247)))
(assert
 (=> x_6_p z_6_45))
(assert
 (let (($x4229 (not z_6_46)))
 (=> x_6_p $x4229)))
(assert
 (let (($x4220 (not z_6_47)))
 (=> x_6_p $x4220)))
(assert
 (let (($x4211 (not z_6_48)))
 (=> x_6_p $x4211)))
(assert
 (let (($x4202 (not z_6_49)))
 (=> x_6_p $x4202)))
(assert
 (let (($x4193 (not z_6_50)))
 (=> x_6_p $x4193)))
(assert
 (=> x_6_p z_6_51))
(assert
 (let (($x4175 (not z_6_52)))
 (=> x_6_p $x4175)))
(assert
 (let (($x4167 (not z_6_53)))
 (=> x_6_p $x4167)))
(assert
 (let (($x4158 (not z_6_54)))
 (=> x_6_p $x4158)))
(assert
 (=> x_6_p z_6_55))
(assert
...
(assert
 (=> x_6_p z_6_58))
(assert
 (let (($x4113 (not z_6_59)))
 (=> x_6_p $x4113)))
(assert
 (let (($x4104 (not z_6_60)))
 (=> x_6_p $x4104)))
(assert
 (=> x_6_p z_6_61))
(assert
 (let (($x4086 (not z_6_62)))
 (=> x_6_p $x4086)))
(assert
 (=> x_6_p z_6_63))
(assert
 (=> x_6_p z_6_64))
(assert
 (let (($x4060 (not z_6_65)))
 (=> x_6_p $x4060)))
(assert
 (let (($x4051 (not z_6_66)))
 (=> x_6_p $x4051)))
(assert
 (let (($x4042 (not z_6_67)))
 (=> x_6_p $x4042)))
(assert
 (=> x_6_p z_6_68))
(assert
 (let (($x4024 (not z_6_69)))
 (=> x_6_p $x4024)))
(assert
 (let (($x4015 (not z_6_70)))
 (=> x_6_p $x4015)))
(assert
 (let (($x4007 (not z_6_71)))
 (=> x_6_p $x4007)))
(assert
 (=> x_6_p z_6_72))
(assert
 (let (($x3989 (not z_6_73)))
 (=> x_6_p $x3989)))
(assert
 (let (($x3980 (not z_6_74)))
 (=> x_6_p $x3980)))
(assert
 (let (($x3971 (not z_6_75)))
 (=> x_6_p $x3971)))
(assert
 (=> x_6_p z_6_76))
(assert
...
(assert
 (=> x_6_p z_6_83))
(assert
 (let (($x3891 (not z_6_84)))
 (=> x_6_p $x3891)))
(assert
 (let (($x3882 (not z_6_85)))
 (=> x_6_p $x3882)))
(assert
 (=> x_6_p z_6_86))
(assert
 (let (($x3864 (not z_6_87)))
 (=> x_6_p $x3864)))
(assert
 (=> x_6_p z_6_88))
(assert
...
(assert
 (=> x_6_p z_6_93))
(assert
 (let (($x3802 (not z_6_94)))
 (=> x_6_p $x3802)))
(assert
 (let (($x3793 (not z_6_95)))
 (=> x_6_p $x3793)))
(assert
 (let (($x3784 (not z_6_96)))
 (=> x_6_p $x3784)))
(assert
 (=> x_6_p z_6_97))
(assert
 (=> x_6_p z_6_98))
(assert
 (let (($x3757 (not z_6_99)))
 (=> x_6_p $x3757)))
(assert
 (let (($x3749 (not z_6_100)))
 (=> x_6_p $x3749)))
(assert
 (=> x_6_p z_6_101))
(assert
 (let (($x3731 (not z_6_102)))
 (=> x_6_p $x3731)))
(assert
 (=> x_6_p z_6_103))
(assert
 (let (($x3713 (not z_6_104)))
 (=> x_6_p $x3713)))
(assert
 (=> x_6_p z_6_105))
(assert
 (=> x_6_p z_6_106))
(assert
 (let (($x3686 (not z_6_107)))
 (=> x_6_p $x3686)))
(assert
 (let (($x3677 (not z_6_108)))
 (=> x_6_p $x3677)))
(assert
 (=> x_6_p z_6_109))
(assert
...
(assert
 (=> x_6_p z_6_112))
(assert
 (let (($x3633 (not z_6_113)))
 (=> x_6_p $x3633)))
(assert
 (let (($x3624 (not z_6_114)))
 (=> x_6_p $x3624)))
(assert
 (let (($x3615 (not z_6_115)))
 (=> x_6_p $x3615)))
(assert
 (=> x_6_p z_6_116))
(assert
 (let (($x3597 (not z_6_117)))
 (=> x_6_p $x3597)))
(assert
 (let (($x3589 (not z_6_118)))
 (=> x_6_p $x3589)))
(assert
 (let (($x3580 (not z_6_119)))
 (=> x_6_p $x3580)))
(assert
 (=> x_6_p z_6_120))
(assert
 (let (($x3562 (not z_6_121)))
 (=> x_6_p $x3562)))
(assert
 (let (($x3553 (not z_6_122)))
 (=> x_6_p $x3553)))
(assert
 (let (($x3544 (not z_6_123)))
 (=> x_6_p $x3544)))
(assert
 (let (($x3535 (not z_6_124)))
 (=> x_6_p $x3535)))
(assert
 (=> x_6_p z_6_125))
(assert
 (let (($x3517 (not z_6_126)))
 (=> x_6_p $x3517)))
(assert
 (let (($x3508 (not z_6_127)))
 (=> x_6_p $x3508)))
(assert
 (let (($x3499 (not z_6_128)))
 (=> x_6_p $x3499)))
(assert
 (=> x_6_p z_6_129))
(assert
 (let (($x3481 (not z_6_130)))
 (=> x_6_p $x3481)))
(assert
 (=> x_6_p z_6_131))
(assert
 (let (($x3463 (not z_6_132)))
 (=> x_6_p $x3463)))
(assert
 (=> x_6_p z_6_133))
(assert
 (let (($x3445 (not z_6_134)))
 (=> x_6_p $x3445)))
(assert
 (let (($x3436 (not z_6_135)))
 (=> x_6_p $x3436)))
(assert
 (let (($x3427 (not z_6_136)))
 (=> x_6_p $x3427)))
(assert
 (let (($x3418 (not z_6_137)))
 (=> x_6_p $x3418)))
(assert
 (=> x_6_p z_6_138))
(assert
 (=> x_6_p z_6_139))
(assert
 (let (($x3391 (not z_6_140)))
 (=> x_6_p $x3391)))
(assert
 (let (($x3382 (not z_6_141)))
 (=> x_6_p $x3382)))
(assert
 (=> x_6_p z_6_142))
(assert
 (let (($x3364 (not z_6_143)))
 (=> x_6_p $x3364)))
(assert
 (let (($x3355 (not z_6_144)))
 (=> x_6_p $x3355)))
(assert
 (let (($x3346 (not z_6_145)))
 (=> x_6_p $x3346)))
(assert
 (let (($x3337 (not z_6_146)))
 (=> x_6_p $x3337)))
(assert
 (let (($x3328 (not z_6_147)))
 (=> x_6_p $x3328)))
(assert
 (=> x_6_p z_6_148))
(assert
 (let (($x3310 (not z_6_149)))
 (=> x_6_p $x3310)))
(assert
 (let (($x3301 (not z_6_150)))
 (=> x_6_p $x3301)))
(assert
 (let (($x3292 (not z_6_151)))
 (=> x_6_p $x3292)))
(assert
 (=> x_6_p z_6_152))
(assert
 (let (($x3274 (not z_6_153)))
 (=> x_6_p $x3274)))
(assert
 (=> x_6_p z_6_154))
(assert
...
(assert
 ...
 (=> x_6_q $x3306)))
(assert
 (let (($x3252 (not z_6_21)))
 (=> x_6_q $x3252)))
(assert
 (let (($x3198 (not z_6_22)))
 (=> x_6_q $x3198)))
(assert
 (let (($x3144 (not z_6_23)))
 (=> x_6_q $x3144)))
(assert
 (let (($x3090 (not z_6_24)))
 (=> x_6_q $x3090)))
(assert
 (let (($x3036 (not z_6_25)))
 (=> x_6_q $x3036)))
(assert
 (let (($x4407 (not z_6_26)))
 (=> x_6_q $x4407)))
(assert
 (let (($x4398 (not z_6_27)))
 (=> x_6_q $x4398)))
(assert
 ...
 (=> x_6_q $x4389)))
(assert
 (let (($x4380 (not z_6_29)))
 (=> x_6_q $x4380)))
(assert
 (let (($x4371 (not z_6_30)))
 (=> x_6_q $x4371)))
(assert
 (let (($x4362 (not z_6_31)))
 (=> x_6_q $x4362)))
(assert
 (let (($x4353 (not z_6_32)))
 (=> x_6_q $x4353)))
(assert
 (let (($x4344 (not z_6_33)))
 (=> x_6_q $x4344)))
(assert
 (let (($x4335 (not z_6_34)))
 (=> x_6_q $x4335)))
(assert
 (let (($x4327 (not z_6_35)))
 (=> x_6_q $x4327)))
...
(assert
 ...
 (=> x_6_q $x4282)))
(assert
 (let (($x4273 (not z_6_41)))
 (=> x_6_q $x4273)))
(assert
 (let (($x4264 (not z_6_42)))
 (=> x_6_q $x4264)))
(assert
 (let (($x4255 (not z_6_43)))
 (=> x_6_q $x4255)))
...
(assert
 ...
 (=> x_6_q $x4158)))
(assert
 (let (($x4149 (not z_6_55)))
 (=> x_6_q $x4149)))
(assert
 (let (($x4140 (not z_6_56)))
 (=> x_6_q $x4140)))
(assert
 (let (($x4131 (not z_6_57)))
 (=> x_6_q $x4131)))
(assert
 (let (($x4122 (not z_6_58)))
 (=> x_6_q $x4122)))
(assert
 (let (($x4113 (not z_6_59)))
 (=> x_6_q $x4113)))
(assert
 ...
 (=> x_6_q $x4104)))
(assert
 (let (($x4095 (not z_6_61)))
 (=> x_6_q $x4095)))
(assert
 (let (($x4086 (not z_6_62)))
 (=> x_6_q $x4086)))
(assert
 (let (($x4078 (not z_6_63)))
 (=> x_6_q $x4078)))
(assert
 (=> x_6_q z_6_64))
(assert
...
(assert
 (=> x_6_q z_6_76))
(assert
 (let (($x3953 (not z_6_77)))
 (=> x_6_q $x3953)))
(assert
 (=> x_6_q z_6_78))
(assert
 (let (($x3936 (not z_6_79)))
 (=> x_6_q $x3936)))
(assert
 (let (($x3927 (not z_6_80)))
 (=> x_6_q $x3927)))
(assert
 (=> x_6_q z_6_81))
(assert
...
(assert
 (=> x_6_q z_6_96))
(assert
 (let (($x3775 (not z_6_97)))
 (=> x_6_q $x3775)))
(assert
 (let (($x3766 (not z_6_98)))
 (=> x_6_q $x3766)))
(assert
 (let (($x3757 (not z_6_99)))
 (=> x_6_q $x3757)))
(assert
 ...
 (=> x_6_q $x3749)))
(assert
 (let (($x3740 (not z_6_101)))
 (=> x_6_q $x3740)))
(assert
 (let (($x3731 (not z_6_102)))
 (=> x_6_q $x3731)))
(assert
 (let (($x3722 (not z_6_103)))
 (=> x_6_q $x3722)))
(assert
 (let (($x3713 (not z_6_104)))
 (=> x_6_q $x3713)))
...
(assert
 (=> x_6_q z_6_108))
(assert
 (let (($x3668 (not z_6_109)))
 (=> x_6_q $x3668)))
(assert
 (let (($x3659 (not z_6_110)))
 (=> x_6_q $x3659)))
(assert
 (=> x_6_q z_6_111))
(assert
 (let (($x3642 (not z_6_112)))
 (=> x_6_q $x3642)))
(assert
 (let (($x3633 (not z_6_113)))
 (=> x_6_q $x3633)))
...
(assert
 ...
 (=> x_6_q $x3499)))
(assert
 (let (($x3490 (not z_6_129)))
 (=> x_6_q $x3490)))
(assert
 (=> x_6_q z_6_130))
(assert
 (let (($x3472 (not z_6_131)))
 (=> x_6_q $x3472)))
(assert
 (let (($x3463 (not z_6_132)))
 (=> x_6_q $x3463)))
...
(assert
 ...
 (let (($x3242 (not x_6_F)))
 (let (($x3247 (not x_6_G)))
 (and $x3247 $x3242 $x3241 $x3238 $x3233 $x3232 $x3229 $x3224))))))))))
(check-sat)
